 ...
 * @generated
 */
public class ForwardingServiceRouteForwardedByServiceViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ForwardingServiceRouteForwardedByServiceEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel156EditPart.VISUAL_ID),

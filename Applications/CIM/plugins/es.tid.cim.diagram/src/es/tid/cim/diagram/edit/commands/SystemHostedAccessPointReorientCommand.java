 ...
 * @generated
 */
public class SystemHostedAccessPointReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SystemHostedAccessPointReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ServiceAccessPoint && newEnd instanceof System)) {
			return false;
		}
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSystemHostedAccessPoint_4020(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSystemHostedAccessPoint_4020(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getHostedAccessPoint().remove(getOldTarget());
		getNewSource().getHostedAccessPoint().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getHostedAccessPoint().remove(getOldTarget());
		getOldSource().getHostedAccessPoint().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

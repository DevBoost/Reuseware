...
import es.tid.cim.diagram.part.CIMLevelZeroDiagramEditor;
 ...
 * @generated
 */
public class CIMLevelZeroValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = CIMLevelZeroDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof CIMLevelZeroDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& CIM_ModelEditPart.MODEL_ID
						.equals(CIMLevelZeroVisualIDRegistry.getModelID(view));
	}

 ...
 * @generated
 */
public class SoftwareElementSoftwareElementChecksViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(SoftwareElementSoftwareElementChecksEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel98EditPart.VISUAL_ID),

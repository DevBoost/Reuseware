 ...
 * @generated
 */
public class FragmentInstanceCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return CompositionprogramPackage.eINSTANCE
				.getFragmentInstance_PortInstances();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<CompositionprogramNodeDescriptor> childDescriptors = CompositionprogramDiagramUpdater
				.getFragmentInstance_2001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return PortInstanceEditPart.VISUAL_ID == CompositionprogramVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<CompositionprogramNodeDescriptor> childDescriptors = CompositionprogramDiagramUpdater
				.getFragmentInstance_2001SemanticChildren((View) getHost()
						.getModel());

 ...
 * @generated
 */
public class BGPClusterRoutersInBGPClusterCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public BGPClusterRoutersInBGPClusterCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateBGPClusterRoutersInBGPCluster_4064(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getRoutersInBGPCluster().add(getTarget());
		}

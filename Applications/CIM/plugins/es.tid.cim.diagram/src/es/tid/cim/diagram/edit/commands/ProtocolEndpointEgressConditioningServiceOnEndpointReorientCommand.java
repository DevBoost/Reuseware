 ...
 * @generated
 */
public class ProtocolEndpointEgressConditioningServiceOnEndpointReorientCommand
	 ...
	 * @generated
	 */
	public ProtocolEndpointEgressConditioningServiceOnEndpointReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistProtocolEndpointEgressConditioningServiceOnEndpoint_4047(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getEgressConditioningServiceOnEndpoint().remove(
				getOldTarget());
		getNewSource().getEgressConditioningServiceOnEndpoint().add(
				getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getEgressConditioningServiceOnEndpoint().remove(
				getOldTarget());
		getOldSource().getEgressConditioningServiceOnEndpoint().add(
				getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

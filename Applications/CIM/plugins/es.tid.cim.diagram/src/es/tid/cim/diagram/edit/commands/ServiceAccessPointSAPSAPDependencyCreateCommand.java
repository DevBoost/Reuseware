 ...
 * @generated
 */
public class ServiceAccessPointSAPSAPDependencyCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceAccessPointSAPSAPDependencyCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateServiceAccessPointSAPSAPDependency_4029(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSAPSAPDependency().add(getTarget());
		}

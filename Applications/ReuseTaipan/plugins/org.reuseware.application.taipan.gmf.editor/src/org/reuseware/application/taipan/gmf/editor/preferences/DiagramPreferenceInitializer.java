...
public class DiagramPreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		PreferenceConverter.setDefault(store,
				IPreferenceConstants.PREF_DEFAULT_FONT, new FontData(
						"monospaced", 12, SWT.NORMAL));
		...
		PreferenceConverter.setDefault(store,
				...
				new org.eclipse.swt.graphics.RGB(64, 64, 64));
		...
		store.setDefault(IPreferenceConstants.PREF_SHOW_GRID,

 ...
 * @generated
 */
public class NATServiceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public NATServiceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		NATService newElement = CimFactory.eINSTANCE.createNATService();

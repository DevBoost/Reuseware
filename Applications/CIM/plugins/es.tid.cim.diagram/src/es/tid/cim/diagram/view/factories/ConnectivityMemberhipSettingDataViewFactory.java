 ...
 * @generated
 */
public class ConnectivityMemberhipSettingDataViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ConnectivityMemberhipSettingDataEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel57EditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}

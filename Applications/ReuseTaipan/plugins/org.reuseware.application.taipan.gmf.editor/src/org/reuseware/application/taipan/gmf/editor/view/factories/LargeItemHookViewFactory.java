...
import org.reuseware.application.taipan.gmf.editor.edit.parts.LargeItemHookEditPart;
 ...
 * @generated
 */
public class LargeItemHookViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TaiPanVisualIDRegistry
					.getType(LargeItemHookEditPart.VISUAL_ID);
		...
		if (!AquatoryEditPart.MODEL_ID.equals(TaiPanVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", AquatoryEditPart.MODEL_ID); //$NON-NLS-1$
		...
		getViewService().createNode(eObjectAdapter, view,
				TaiPanVisualIDRegistry.getType(PortPortNameEditPart.VISUAL_ID),

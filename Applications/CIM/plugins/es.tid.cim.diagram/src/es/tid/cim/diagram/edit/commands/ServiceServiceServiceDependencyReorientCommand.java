 ...
 * @generated
 */
public class ServiceServiceServiceDependencyReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceServiceServiceDependencyReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistServiceServiceServiceDependency_4032(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistServiceServiceServiceDependency_4032(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getServiceServiceDependency().remove(getOldTarget());
		getNewSource().getServiceServiceDependency().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getServiceServiceDependency().remove(getOldTarget());
		getOldSource().getServiceServiceDependency().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

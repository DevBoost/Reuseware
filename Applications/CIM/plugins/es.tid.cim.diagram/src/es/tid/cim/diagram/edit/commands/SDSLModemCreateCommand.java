 ...
 * @generated
 */
public class SDSLModemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public SDSLModemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		SDSLModem newElement = CimFactory.eINSTANCE.createSDSLModem();

 ...
 * @generated
 */
public class IPProtocolEndpointViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(IPProtocolEndpointEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel78EditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}

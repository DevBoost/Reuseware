 ...
 * @generated
 */
public class SystemSystemComponentsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SystemSystemComponentsCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSystemSystemComponents_4036(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSystemComponents().add(getTarget());
		}

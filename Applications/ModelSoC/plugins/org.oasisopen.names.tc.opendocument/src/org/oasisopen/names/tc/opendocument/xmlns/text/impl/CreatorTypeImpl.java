...
import org.oasisopen.names.tc.opendocument.xmlns.text.CreatorType;
import org.oasisopen.names.tc.opendocument.xmlns.text.TextPackage;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Creator Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.CreatorTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.CreatorTypeImpl#getFixed <em>Fixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CreatorTypeImpl extends EObjectImpl implements CreatorType {
	/**
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getCreatorType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TextPackage.CREATOR_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setFixed(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newFixed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.CREATOR_TYPE__FIXED, oldFixed, fixed, !oldFixedESet));
	}
	...
	public void unsetFixed() {
		...
		fixedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.CREATOR_TYPE__FIXED, oldFixed, FIXED_EDEFAULT, oldFixedESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.CREATOR_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.CREATOR_TYPE__FIXED:
				return getFixed();
		}

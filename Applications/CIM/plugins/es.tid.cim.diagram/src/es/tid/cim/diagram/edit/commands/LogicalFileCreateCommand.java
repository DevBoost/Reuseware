 ...
 * @generated
 */
public class LogicalFileCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public LogicalFileCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		LogicalFile newElement = CimFactory.eINSTANCE.createLogicalFile();

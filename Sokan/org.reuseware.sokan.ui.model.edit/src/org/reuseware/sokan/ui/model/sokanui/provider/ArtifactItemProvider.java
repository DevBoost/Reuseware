...
/**
 * This is the item provider adapter for a {@link org.reuseware.sokan.ui.model.sokanui.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SokanuiPackage.Literals.ARTIFACT__CONTENTS);
		}
	...
	public Object getImage(Object object) {
	      ...
	      images.add(PlatformUI.getWorkbench().getEditorRegistry().getImageDescriptor(
	    		  getText(object)));
	...
	public String getText(Object object) {
		...
		return artifact.getId().get(artifact.getId().size()-1);
	}
	...
	protected boolean hasChildren(Object object, boolean optimized) {
		// we assume that an artifact will have children
		Artifact artifact = (Artifact) object;

 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getBind <em>Bind</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getControlImplementation <em>Control Implementation</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getCurrentValue <em>Current Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getPrintable <em>Printable</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getReadonly <em>Readonly</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getTabIndex <em>Tab Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getTabStop <em>Tab Stop</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FileTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FileTypeImpl extends CommonFormControlContentImpl implements FileType {
	/**
	...
	protected EClass eStaticClass() {
		return FormPackage.eINSTANCE.getFileType();
	}
	...
	public void setBind(String newBind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__BIND, oldBind, bind));
	}
	...
	public void setControlImplementation(String newControlImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__CONTROL_IMPLEMENTATION, oldControlImplementation, controlImplementation));
	}
	...
	public void setCurrentValue(String newCurrentValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__CURRENT_VALUE, oldCurrentValue, currentValue));
	}
	...
	public void setDisabled(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newDisabled) {
		...
		disabledESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__DISABLED, oldDisabled, disabled, !oldDisabledESet));
	}
	...
	public void unsetDisabled() {
		...
		disabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FILE_TYPE__DISABLED, oldDisabled, DISABLED_EDEFAULT, oldDisabledESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__ID, oldId, id));
	}
	...
	public void setMaxLength(BigInteger newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__NAME, oldName, name));
	}
	...
	public void setPrintable(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newPrintable) {
		...
		printableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__PRINTABLE, oldPrintable, printable, !oldPrintableESet));
	}
	...
	public void unsetPrintable() {
		...
		printableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FILE_TYPE__PRINTABLE, oldPrintable, PRINTABLE_EDEFAULT, oldPrintableESet));
	}
	...
	public void setReadonly(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newReadonly) {
		...
		readonlyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__READONLY, oldReadonly, readonly, !oldReadonlyESet));
	}
	...
	public void unsetReadonly() {
		...
		readonlyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FILE_TYPE__READONLY, oldReadonly, READONLY_EDEFAULT, oldReadonlyESet));
	}
	...
	public void setTabIndex(BigInteger newTabIndex) {
		...
		tabIndexESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__TAB_INDEX, oldTabIndex, tabIndex, !oldTabIndexESet));
	}
	...
	public void unsetTabIndex() {
		...
		tabIndexESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FILE_TYPE__TAB_INDEX, oldTabIndex, TAB_INDEX_EDEFAULT, oldTabIndexESet));
	}
	...
	public void setTabStop(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTabStop) {
		...
		tabStopESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__TAB_STOP, oldTabStop, tabStop, !oldTabStopESet));
	}
	...
	public void unsetTabStop() {
		...
		tabStopESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FILE_TYPE__TAB_STOP, oldTabStop, TAB_STOP_EDEFAULT, oldTabStopESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FILE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.FILE_TYPE__BIND:
				return getBind();
			case FormPackage.FILE_TYPE__CONTROL_IMPLEMENTATION:
				return getControlImplementation();
			case FormPackage.FILE_TYPE__CURRENT_VALUE:
				return getCurrentValue();
			case FormPackage.FILE_TYPE__DISABLED:
				return getDisabled();
			case FormPackage.FILE_TYPE__ID:
				return getId();
			case FormPackage.FILE_TYPE__MAX_LENGTH:
				return getMaxLength();
			case FormPackage.FILE_TYPE__NAME:
				return getName();
			case FormPackage.FILE_TYPE__PRINTABLE:
				return getPrintable();
			case FormPackage.FILE_TYPE__READONLY:
				return getReadonly();
			case FormPackage.FILE_TYPE__TAB_INDEX:
				return getTabIndex();
			case FormPackage.FILE_TYPE__TAB_STOP:
				return getTabStop();
			case FormPackage.FILE_TYPE__TITLE:
				return getTitle();
			case FormPackage.FILE_TYPE__VALUE:
				return getValue();
		}

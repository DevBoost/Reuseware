...
import es.tid.cim.diagram.edit.commands.DirectorySpecificationDirectorySpecificationFilesCreateCommand;
import es.tid.cim.diagram.edit.commands.DirectorySpecificationDirectorySpecificationFilesReorientCommand;
 ...
 * @generated
 */
public class FileSpecificationItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.DirectorySpecificationDirectorySpecificationFiles_4001 == req
				.getElementType()) {
			return null;
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.DirectorySpecificationDirectorySpecificationFiles_4001 == req
				.getElementType()) {
			return getGEFWrapper(new DirectorySpecificationDirectorySpecificationFilesCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.SoftwareElementSoftwareElementChecks_4004 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case DirectorySpecificationDirectorySpecificationFilesEditPart.VISUAL_ID:
			return getGEFWrapper(new DirectorySpecificationDirectorySpecificationFilesReorientCommand(
					req));

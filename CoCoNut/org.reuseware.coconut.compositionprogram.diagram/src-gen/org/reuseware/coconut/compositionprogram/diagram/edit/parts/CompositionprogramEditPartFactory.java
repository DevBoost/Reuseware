 ...
 * @generated
 */
public class CompositionprogramEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case CompositionProgramEditPart.VISUAL_ID:
				return new CompositionProgramEditPart(view);

			case FragmentInstanceEditPart.VISUAL_ID:
				return new FragmentInstanceEditPart(view);

			case FragmentInstanceNameEditPart.VISUAL_ID:
				return new FragmentInstanceNameEditPart(view);

			case PortInstanceEditPart.VISUAL_ID:
				return new PortInstanceEditPart(view);

			case PortInstancePortNameEditPart.VISUAL_ID:
				return new PortInstancePortNameEditPart(view);

			case CompositionLinkEditPart.VISUAL_ID:
				return new CompositionLinkEditPart(view);

 ...
 * @generated
 */
public class LogicalDeviceDeviceSAPImplementationReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public LogicalDeviceDeviceSAPImplementationReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ServiceAccessPoint && newEnd instanceof LogicalDevice)) {
			return false;
		}
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLogicalDeviceDeviceSAPImplementation_4016(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getDeviceSAPImplementation().remove(getOldTarget());
		getNewSource().getDeviceSAPImplementation().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getDeviceSAPImplementation().remove(getOldTarget());
		getOldSource().getDeviceSAPImplementation().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

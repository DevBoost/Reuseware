 ...
 * @generated
 */
public class BIOSFeatureCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public BIOSFeatureCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		BIOSFeature newElement = CimFactory.eINSTANCE.createBIOSFeature();

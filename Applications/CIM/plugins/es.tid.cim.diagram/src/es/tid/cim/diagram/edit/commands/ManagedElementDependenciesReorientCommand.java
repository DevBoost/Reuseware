 ...
 * @generated
 */
public class ManagedElementDependenciesReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ManagedElementDependenciesReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistManagedElementDependencies_4013(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistManagedElementDependencies_4013(getOldSource(),
						getNewTarget());
	}

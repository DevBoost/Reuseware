 ...
 * @generated
 */
public class ForwardingServiceForwardsAmongCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ForwardingServiceForwardsAmongCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateForwardingServiceForwardsAmong_4050(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getForwardsAmong().add(getTarget());
		}

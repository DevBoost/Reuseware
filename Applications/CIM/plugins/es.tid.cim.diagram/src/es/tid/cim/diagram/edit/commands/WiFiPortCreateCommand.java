 ...
 * @generated
 */
public class WiFiPortCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public WiFiPortCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		WiFiPort newElement = CimFactory.eINSTANCE.createWiFiPort();

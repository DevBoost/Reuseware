...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IP Subnet</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.tid.cim.impl.IPSubnetImpl#getSubnetNumber <em>Subnet Number</em>}</li>
 *   <li>{@link es.tid.cim.impl.IPSubnetImpl#getSubnetMask <em>Subnet Mask</em>}</li>
 *   <li>{@link es.tid.cim.impl.IPSubnetImpl#getPrefixLength <em>Prefix Length</em>}</li>
 *   <li>{@link es.tid.cim.impl.IPSubnetImpl#getAddressType <em>Address Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IPSubnetImpl extends LogicalNetworkImpl implements IPSubnet {
	...
	public void setSubnetNumber(String newSubnetNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CimPackage.IP_SUBNET__SUBNET_NUMBER, oldSubnetNumber, subnetNumber));
	}
	...
	public void setSubnetMask(String newSubnetMask) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CimPackage.IP_SUBNET__SUBNET_MASK, oldSubnetMask, subnetMask));
	}
	...
	public void setPrefixLength(int newPrefixLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CimPackage.IP_SUBNET__PREFIX_LENGTH, oldPrefixLength, prefixLength));
	}
	...
	public void setAddressType(String newAddressType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CimPackage.IP_SUBNET__ADDRESS_TYPE, oldAddressType, addressType));
	}

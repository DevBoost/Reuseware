 ...
 * @generated
 */
public class DirectorySpecificationDirectorySpecificationFilesViewFactory
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(DirectorySpecificationDirectorySpecificationFilesEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel95EditPart.VISUAL_ID),

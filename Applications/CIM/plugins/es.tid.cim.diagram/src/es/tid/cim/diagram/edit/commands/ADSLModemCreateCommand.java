 ...
 * @generated
 */
public class ADSLModemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public ADSLModemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		ADSLModem newElement = CimFactory.eINSTANCE.createADSLModem();

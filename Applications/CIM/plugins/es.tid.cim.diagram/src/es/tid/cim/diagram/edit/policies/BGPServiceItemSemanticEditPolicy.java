...
import es.tid.cim.diagram.edit.commands.BGPClusterReflectorClientServiceCreateCommand;
import es.tid.cim.diagram.edit.commands.BGPClusterReflectorClientServiceReorientCommand;
import es.tid.cim.diagram.edit.commands.BGPClusterReflectorNonClientServiceCreateCommand;
import es.tid.cim.diagram.edit.commands.BGPClusterReflectorNonClientServiceReorientCommand;
import es.tid.cim.diagram.edit.commands.BGPClusterReflectorServiceCreateCommand;
import es.tid.cim.diagram.edit.commands.BGPClusterReflectorServiceReorientCommand;
import es.tid.cim.diagram.edit.commands.BGPServiceBGPAdminDistanceCreateCommand;
import es.tid.cim.diagram.edit.commands.BGPServiceBGPAdminDistanceReorientCommand;
import es.tid.cim.diagram.edit.commands.BGPServiceBGPPeerGroupServicesCreateCommand;
import es.tid.cim.diagram.edit.commands.BGPServiceBGPPeerGroupServicesReorientCommand;
 ...
 * @generated
 */
public class BGPServiceItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.BGPServiceBGPPeerGroupServices_4006 == req
				.getElementType()) {
			return getGEFWrapper(new BGPServiceBGPPeerGroupServicesCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.BGPClusterReflectorClientService_4007 == req
				.getElementType()) {
			return null;
		}
		if (CIMLevelZeroElementTypes.BGPClusterReflectorNonClientService_4008 == req
				.getElementType()) {
			return null;
		}
		if (CIMLevelZeroElementTypes.BGPClusterReflectorService_4009 == req
				.getElementType()) {
			return null;
		}
		...
		if (CIMLevelZeroElementTypes.BGPServiceBGPAdminDistance_4044 == req
				.getElementType()) {
			return getGEFWrapper(new BGPServiceBGPAdminDistanceCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.BGPClusterReflectorClientService_4007 == req
				.getElementType()) {
			return getGEFWrapper(new BGPClusterReflectorClientServiceCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.BGPClusterReflectorNonClientService_4008 == req
				.getElementType()) {
			return getGEFWrapper(new BGPClusterReflectorNonClientServiceCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.BGPClusterReflectorService_4009 == req
				.getElementType()) {
			return getGEFWrapper(new BGPClusterReflectorServiceCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.ManagedElementComponents_4011 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case BGPServiceBGPPeerGroupServicesEditPart.VISUAL_ID:
			return getGEFWrapper(new BGPServiceBGPPeerGroupServicesReorientCommand(
					req));
		case BGPClusterReflectorClientServiceEditPart.VISUAL_ID:
			return getGEFWrapper(new BGPClusterReflectorClientServiceReorientCommand(
					req));
		case BGPClusterReflectorNonClientServiceEditPart.VISUAL_ID:
			return getGEFWrapper(new BGPClusterReflectorNonClientServiceReorientCommand(
					req));
		case BGPClusterReflectorServiceEditPart.VISUAL_ID:
			return getGEFWrapper(new BGPClusterReflectorServiceReorientCommand(
					req));
		...
		case BGPServiceBGPAdminDistanceEditPart.VISUAL_ID:
			return getGEFWrapper(new BGPServiceBGPAdminDistanceReorientCommand(
					req));

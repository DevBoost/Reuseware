 ...
 * @generated
 */
public class VolatileStorageCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public VolatileStorageCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		VolatileStorage newElement = CimFactory.eINSTANCE

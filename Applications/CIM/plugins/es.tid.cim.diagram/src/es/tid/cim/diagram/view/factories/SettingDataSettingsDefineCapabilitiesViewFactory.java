 ...
 * @generated
 */
public class SettingDataSettingsDefineCapabilitiesViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(SettingDataSettingsDefineCapabilitiesEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel128EditPart.VISUAL_ID),

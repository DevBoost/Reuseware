 ...
 * @generated
 */
public class ServiceAccessPointBindsToReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceAccessPointBindsToReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ProtocolEndpoint && newEnd instanceof ServiceAccessPoint)) {
			return false;
		}
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistServiceAccessPointBindsTo_4010(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistServiceAccessPointBindsTo_4010(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getBindsTo().remove(getOldTarget());
		getNewSource().getBindsTo().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getBindsTo().remove(getOldTarget());
		getOldSource().getBindsTo().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

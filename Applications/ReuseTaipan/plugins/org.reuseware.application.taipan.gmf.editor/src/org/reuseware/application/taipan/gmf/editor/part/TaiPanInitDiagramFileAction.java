	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog
					.openError(
							getShell(),
							Messages.TaiPanInitDiagramFileAction_InitDiagramFileResourceErrorDialogTitle,
							Messages.TaiPanInitDiagramFileAction_InitDiagramFileResourceErrorDialogMessage);
			return;
		}
		Wizard wizard = new TaiPanNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard
				.setWindowTitle(NLS
						.bind(
								Messages.TaiPanInitDiagramFileAction_InitDiagramFileWizardTitle,

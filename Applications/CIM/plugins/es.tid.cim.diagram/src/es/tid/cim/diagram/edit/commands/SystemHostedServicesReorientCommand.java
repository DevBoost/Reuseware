 ...
 * @generated
 */
public class SystemHostedServicesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SystemHostedServicesReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Service && newEnd instanceof System)) {
			return false;
		}
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSystemHostedServices_4023(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSystemHostedServices_4023(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getHostedServices().remove(getOldTarget());
		getNewSource().getHostedServices().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getHostedServices().remove(getOldTarget());
		getOldSource().getHostedServices().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

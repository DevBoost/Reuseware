...
public class XLinkPackageImpl extends EPackageImpl implements XLinkPackage {
	 ...
	 * @generated
	 */
	private EEnum actuateType1EEnum = null;
	 ...
	 * @generated
	 */
	private EEnum showType1EEnum = null;
	 ...
	 * @generated
	 */
	private EEnum showType2EEnum = null;
	 ...
	 * @generated
	 */
	private EDataType actuateTypeObject1EDataType = null;
	 ...
	 * @generated
	 */
	private EDataType showTypeObject1EDataType = null;
	 ...
	 * @generated
	 */
	private EDataType showTypeObject2EDataType = null;
	 ...
	 * @generated
	 */
	public EEnum getActuateType1() {
		return actuateType1EEnum;
	}
	 ...
	 * @generated
	 */
	public EEnum getShowType1() {
		return showType1EEnum;
	}
	 ...
	 * @generated
	 */
	public EEnum getShowType2() {
		return showType2EEnum;
	}
	 ...
	 * @generated
	 */
	public EDataType getActuateTypeObject1() {
		return actuateTypeObject1EDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getShowTypeObject1() {
		return showTypeObject1EDataType;
	}
	 ...
	 * @generated
	 */
	public EDataType getShowTypeObject2() {
		return showTypeObject2EDataType;
	}
	...
	public void createPackageContents() {
		...
		actuateType1EEnum = createEEnum(ACTUATE_TYPE1);
		showTypeEEnum = createEEnum(SHOW_TYPE);
		showType1EEnum = createEEnum(SHOW_TYPE1);
		showType2EEnum = createEEnum(SHOW_TYPE2);
		typeTypeEEnum = createEEnum(TYPE_TYPE);

		// Create data types
		actuateTypeObjectEDataType = createEDataType(ACTUATE_TYPE_OBJECT);
		actuateTypeObject1EDataType = createEDataType(ACTUATE_TYPE_OBJECT1);
		showTypeObjectEDataType = createEDataType(SHOW_TYPE_OBJECT);
		showTypeObject1EDataType = createEDataType(SHOW_TYPE_OBJECT1);
		showTypeObject2EDataType = createEDataType(SHOW_TYPE_OBJECT2);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDocumentRoot_Href(), theTextPackage.getAnyURI(), "href", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEEnum(actuateType1EEnum, ActuateType1.class, "ActuateType1");
		addEEnumLiteral(actuateType1EEnum, ActuateType1.ON_REQUEST);

		initEEnum(showTypeEEnum, ShowType.class, "ShowType");
		addEEnumLiteral(showTypeEEnum, ShowType.REPLACE);

		initEEnum(showType1EEnum, ShowType1.class, "ShowType1");
		addEEnumLiteral(showType1EEnum, ShowType1.EMBED);

		initEEnum(showType2EEnum, ShowType2.class, "ShowType2");
		addEEnumLiteral(showType2EEnum, ShowType2.NEW);
		addEEnumLiteral(showType2EEnum, ShowType2.REPLACE);
		...
		initEDataType(actuateTypeObject1EDataType, ActuateType1.class, "ActuateTypeObject1", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
		initEDataType(showTypeObjectEDataType, ShowType1.class, "ShowTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
		initEDataType(showTypeObject1EDataType, ShowType.class, "ShowTypeObject1", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
		initEDataType(showTypeObject2EDataType, ShowType2.class, "ShowTypeObject2", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (actuateTypeObject1EDataType, 
		   source, 
		   new String[] {
			 "name", "actuate_._1_._type:Object",
			 "baseType", "actuate_._1_._type"
		   });		
		addAnnotation
		  (showTypeEEnum, 
		   source, 
		...
		addAnnotation
		  (showType1EEnum, 
		   source, 
		   new String[] {
			 "name", "show_._1_._type"
		   });		
		addAnnotation
		  (showType2EEnum, 
		   source, 
		   new String[] {
			 "name", "show_._2_._type"
		   });		
		addAnnotation
		  (showTypeObjectEDataType, 
		   source, 
		   new String[] {
			 "name", "show_._1_._type:Object",
			 "baseType", "show_._1_._type"
		   });		
		addAnnotation
		...
		addAnnotation
		  (showTypeObject2EDataType, 
		   source, 
		   new String[] {
			 "name", "show_._2_._type:Object",
			 "baseType", "show_._2_._type"
		   });		
		addAnnotation
		  (typeTypeEEnum, 
		   source, 

...
import org.oasisopen.names.tc.opendocument.xmlns.text.AlphabeticalIndexMarkType;
import org.oasisopen.names.tc.opendocument.xmlns.text.TextPackage;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Alphabetical Index Mark Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.AlphabeticalIndexMarkTypeImpl#getKey1 <em>Key1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.AlphabeticalIndexMarkTypeImpl#getKey1Phonetic <em>Key1 Phonetic</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.AlphabeticalIndexMarkTypeImpl#getKey2 <em>Key2</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.AlphabeticalIndexMarkTypeImpl#getKey2Phonetic <em>Key2 Phonetic</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.AlphabeticalIndexMarkTypeImpl#getMainEntry <em>Main Entry</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.AlphabeticalIndexMarkTypeImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.AlphabeticalIndexMarkTypeImpl#getStringValuePhonetic <em>String Value Phonetic</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AlphabeticalIndexMarkTypeImpl extends EObjectImpl implements AlphabeticalIndexMarkType {
	/**
	 ...
	 * @generated
	 */
	protected AlphabeticalIndexMarkTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getAlphabeticalIndexMarkType();
	}
	...
	public void setKey1(String newKey1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY1, oldKey1, key1));
	}
	...
	public void setKey1Phonetic(String newKey1Phonetic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY1_PHONETIC, oldKey1Phonetic, key1Phonetic));
	}
	...
	public void setKey2(String newKey2) {
		...
		key2 = newKey2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY2, oldKey2, key2));
	}
	...
	public void setKey2Phonetic(String newKey2Phonetic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY2_PHONETIC, oldKey2Phonetic, key2Phonetic));
	}
	...
	public void setMainEntry(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newMainEntry) {
		...
		mainEntryESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__MAIN_ENTRY, oldMainEntry, mainEntry, !oldMainEntryESet));
	}
	...
	public void unsetMainEntry() {
		...
		mainEntryESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__MAIN_ENTRY, oldMainEntry, MAIN_ENTRY_EDEFAULT, oldMainEntryESet));
	}
	...
	public void setStringValue(String newStringValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__STRING_VALUE, oldStringValue, stringValue));
	}
	...
	public void setStringValuePhonetic(String newStringValuePhonetic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__STRING_VALUE_PHONETIC, oldStringValuePhonetic, stringValuePhonetic));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY1:
				return getKey1();
			case TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY1_PHONETIC:
				return getKey1Phonetic();
			case TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY2:
				return getKey2();
			case TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__KEY2_PHONETIC:
				return getKey2Phonetic();
			case TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__MAIN_ENTRY:
				return getMainEntry();
			case TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__STRING_VALUE:
				return getStringValue();
			case TextPackage.ALPHABETICAL_INDEX_MARK_TYPE__STRING_VALUE_PHONETIC:

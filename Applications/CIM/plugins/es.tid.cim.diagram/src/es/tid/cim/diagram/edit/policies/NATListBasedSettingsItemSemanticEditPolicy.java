...
import es.tid.cim.diagram.edit.commands.NATListBasedSettingsAddressesToBeTranslatedCreateCommand;
import es.tid.cim.diagram.edit.commands.NATListBasedSettingsAddressesToBeTranslatedReorientCommand;
import es.tid.cim.diagram.edit.commands.NATListBasedSettingsTranslationPoolForNATCreateCommand;
import es.tid.cim.diagram.edit.commands.NATListBasedSettingsTranslationPoolForNATReorientCommand;
 ...
 * @generated
 */
public class NATListBasedSettingsItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.NATListBasedSettingsAddressesToBeTranslated_4043 == req
				.getElementType()) {
			return getGEFWrapper(new NATListBasedSettingsAddressesToBeTranslatedCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		...
		if (CIMLevelZeroElementTypes.NATListBasedSettingsTranslationPoolForNAT_4069 == req
				.getElementType()) {
			return getGEFWrapper(new NATListBasedSettingsTranslationPoolForNATCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case NATListBasedSettingsAddressesToBeTranslatedEditPart.VISUAL_ID:
			return getGEFWrapper(new NATListBasedSettingsAddressesToBeTranslatedReorientCommand(
					req));
		...
		case NATListBasedSettingsTranslationPoolForNATEditPart.VISUAL_ID:
			return getGEFWrapper(new NATListBasedSettingsTranslationPoolForNATReorientCommand(
					req));
		}

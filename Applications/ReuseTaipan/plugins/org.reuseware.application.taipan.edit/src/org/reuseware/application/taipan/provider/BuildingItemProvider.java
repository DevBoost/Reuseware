...
/**
 * This is the item provider adapter for a {@link org.reuseware.application.taipan.Building} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BuildingItemProvider extends ItemProviderAdapter implements
	...
	protected void addInfoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_Building_info_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Building_info_feature", "_UI_Building_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						TaiPanPackage.Literals.BUILDING__INFO, true, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_Building_street_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Building_street_feature", "_UI_Building_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						TaiPanPackage.Literals.BUILDING__STREET, true, false,
						false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}

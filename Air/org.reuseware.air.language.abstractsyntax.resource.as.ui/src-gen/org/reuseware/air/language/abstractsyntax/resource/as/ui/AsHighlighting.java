 ...
 */
public class AsHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionHelper positionHelper = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.reuseware.air.language.abstractsyntax.resource.as.ui.AsTokenScanner scanner;
	...
	private org.reuseware.air.language.abstractsyntax.resource.as.ui.AsOccurrence occurrence;
	private org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.reuseware.air.language.abstractsyntax.resource.as.IAsBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public AsHighlighting(org.reuseware.air.language.abstractsyntax.resource.as.IAsTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsColorManager colorManager, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsUIPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsTokenScanner(colorManager);
		occurrence = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.PROXY.toString());
		}
	}
	
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.DEFINTION.toString()) || category.equals(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.PROXY.toString()));
		if (category.equals(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.reuseware.air.language.abstractsyntax.resource.as.IAsTextResource) {

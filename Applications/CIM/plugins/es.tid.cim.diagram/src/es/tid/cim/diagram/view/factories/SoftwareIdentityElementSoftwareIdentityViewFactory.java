 ...
 * @generated
 */
public class SoftwareIdentityElementSoftwareIdentityViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(SoftwareIdentityElementSoftwareIdentityEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel113EditPart.VISUAL_ID),

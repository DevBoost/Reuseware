 ...
 * @generated
 */
public class CableModemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public CableModemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		CableModem newElement = CimFactory.eINSTANCE.createCableModem();

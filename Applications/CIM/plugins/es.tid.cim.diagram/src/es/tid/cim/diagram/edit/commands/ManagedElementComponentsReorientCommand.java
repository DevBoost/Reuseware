 ...
 * @generated
 */
public class ManagedElementComponentsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ManagedElementComponentsReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistManagedElementComponents_4011(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistManagedElementComponents_4011(getOldSource(),
						getNewTarget());
	}

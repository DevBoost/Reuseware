...
public class AsBracketSet {
	...
	private java.util.ArrayList<org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair {
	 ...
	 */
	private class ClosingListener implements org.reuseware.air.language.abstractsyntax.resource.as.ui.IAsBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public AsBracketSet(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.reuseware.air.language.abstractsyntax.resource.as.mopp.AsMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair>();
	 ...
	 */
	public org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair getBracketPair(String opening, String closing) {
		for (org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair bracketPair : bracketPairs) {
	...
	public org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair remove(String opening, String closing) {
		for (org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.reuseware.air.language.abstractsyntax.resource.as.IAsBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

 ...
 * @generated
 */
public class VDSLModemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public VDSLModemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		VDSLModem newElement = CimFactory.eINSTANCE.createVDSLModem();

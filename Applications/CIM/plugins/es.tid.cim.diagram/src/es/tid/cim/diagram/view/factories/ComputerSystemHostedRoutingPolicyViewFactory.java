 ...
 * @generated
 */
public class ComputerSystemHostedRoutingPolicyViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ComputerSystemHostedRoutingPolicyEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel148EditPart.VISUAL_ID),

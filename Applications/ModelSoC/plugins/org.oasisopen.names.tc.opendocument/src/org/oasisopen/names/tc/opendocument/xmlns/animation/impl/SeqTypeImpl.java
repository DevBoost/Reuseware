 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getAnimationElementGroup <em>Animation Element Group</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getAnimationElement <em>Animation Element</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getAccelerate <em>Accelerate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getAutoReverse <em>Auto Reverse</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getDecelerate <em>Decelerate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getDur <em>Dur</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getEndsync <em>Endsync</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getFillDefault <em>Fill Default</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getGroupId <em>Group Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getMasterElement <em>Master Element</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getNodeType <em>Node Type</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getPresetClass <em>Preset Class</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getPresetId <em>Preset Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getPresetSubType <em>Preset Sub Type</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getRepeatCount <em>Repeat Count</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getRepeatDur <em>Repeat Dur</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getRestart <em>Restart</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.SeqTypeImpl#getRestartDefault <em>Restart Default</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SeqTypeImpl extends EObjectImpl implements SeqType {
	...
	protected EClass eStaticClass() {
		return AnimationPackage.Literals.SEQ_TYPE;
	}
	...
	public FeatureMap getAnimationElementGroup() {
		if (animationElementGroup == null) {
			animationElementGroup = new BasicFeatureMap(this, AnimationPackage.SEQ_TYPE__ANIMATION_ELEMENT_GROUP);
		}
	...
	public EList<EObject> getAnimationElement() {
		return getAnimationElementGroup().list(AnimationPackage.Literals.SEQ_TYPE__ANIMATION_ELEMENT);
	}
	...
	public void setAccelerate(double newAccelerate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__ACCELERATE, oldAccelerate, accelerate, !oldAccelerateESet));
	}
	...
	public void unsetAccelerate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__ACCELERATE, oldAccelerate, ACCELERATE_EDEFAULT, oldAccelerateESet));
	}
	...
	public void setAutoReverse(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newAutoReverse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__AUTO_REVERSE, oldAutoReverse, autoReverse, !oldAutoReverseESet));
	}
	...
	public void unsetAutoReverse() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__AUTO_REVERSE, oldAutoReverse, AUTO_REVERSE_EDEFAULT, oldAutoReverseESet));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setDecelerate(double newDecelerate) {
		...
		decelerateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__DECELERATE, oldDecelerate, decelerate, !oldDecelerateESet));
	}
	...
	public void unsetDecelerate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__DECELERATE, oldDecelerate, DECELERATE_EDEFAULT, oldDecelerateESet));
	}
	...
	public void setDur(String newDur) {
		...
		dur = newDur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__DUR, oldDur, dur));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__END, oldEnd, end));
	}
	...
	public void setEndsync(EndsyncType newEndsync) {
		...
		endsyncESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__ENDSYNC, oldEndsync, endsync, !oldEndsyncESet));
	}
	...
	public void unsetEndsync() {
		...
		endsyncESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__ENDSYNC, oldEndsync, ENDSYNC_EDEFAULT, oldEndsyncESet));
	}
	...
	public void setFill(FillType newFill) {
		...
		fillESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__FILL, oldFill, fill, !oldFillESet));
	}
	...
	public void unsetFill() {
		...
		fillESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__FILL, oldFill, FILL_EDEFAULT, oldFillESet));
	}
	...
	public void setFillDefault(FillDefaultType newFillDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__FILL_DEFAULT, oldFillDefault, fillDefault, !oldFillDefaultESet));
	}
	...
	public void unsetFillDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__FILL_DEFAULT, oldFillDefault, FILL_DEFAULT_EDEFAULT, oldFillDefaultESet));
	}
	...
	public void setGroupId(String newGroupId) {
		...
		groupId = newGroupId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__GROUP_ID, oldGroupId, groupId));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__ID, oldId, id));
	}
	...
	public void setMasterElement(String newMasterElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__MASTER_ELEMENT, oldMasterElement, masterElement));
	}
	...
	public void setNodeType(NodeTypeType newNodeType) {
		...
		nodeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__NODE_TYPE, oldNodeType, nodeType, !oldNodeTypeESet));
	}
	...
	public void unsetNodeType() {
		...
		nodeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__NODE_TYPE, oldNodeType, NODE_TYPE_EDEFAULT, oldNodeTypeESet));
	}
	...
	public void setPresetClass(PresetClassType newPresetClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__PRESET_CLASS, oldPresetClass, presetClass, !oldPresetClassESet));
	}
	...
	public void unsetPresetClass() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__PRESET_CLASS, oldPresetClass, PRESET_CLASS_EDEFAULT, oldPresetClassESet));
	}
	...
	public void setPresetId(String newPresetId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__PRESET_ID, oldPresetId, presetId));
	}
	...
	public void setPresetSubType(String newPresetSubType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__PRESET_SUB_TYPE, oldPresetSubType, presetSubType));
	}
	...
	public void setRepeatCount(Object newRepeatCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__REPEAT_COUNT, oldRepeatCount, repeatCount));
	}
	...
	public void setRepeatDur(String newRepeatDur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__REPEAT_DUR, oldRepeatDur, repeatDur));
	}
	...
	public void setRestart(RestartType newRestart) {
		...
		restartESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__RESTART, oldRestart, restart, !oldRestartESet));
	}
	...
	public void unsetRestart() {
		...
		restartESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__RESTART, oldRestart, RESTART_EDEFAULT, oldRestartESet));
	}
	...
	public void setRestartDefault(RestartDefaultType newRestartDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.SEQ_TYPE__RESTART_DEFAULT, oldRestartDefault, restartDefault, !oldRestartDefaultESet));
	}
	...
	public void unsetRestartDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.SEQ_TYPE__RESTART_DEFAULT, oldRestartDefault, RESTART_DEFAULT_EDEFAULT, oldRestartDefaultESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AnimationPackage.SEQ_TYPE__ANIMATION_ELEMENT_GROUP:
				return ((InternalEList<?>)getAnimationElementGroup()).basicRemove(otherEnd, msgs);
			case AnimationPackage.SEQ_TYPE__ANIMATION_ELEMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AnimationPackage.SEQ_TYPE__ACCELERATE:
				return new Double(getAccelerate());
			case AnimationPackage.SEQ_TYPE__AUTO_REVERSE:
				return getAutoReverse();
			case AnimationPackage.SEQ_TYPE__BEGIN:
				return getBegin();
			case AnimationPackage.SEQ_TYPE__DECELERATE:
				return new Double(getDecelerate());
			case AnimationPackage.SEQ_TYPE__DUR:
				return getDur();
			case AnimationPackage.SEQ_TYPE__END:
				return getEnd();
			case AnimationPackage.SEQ_TYPE__ENDSYNC:
				return getEndsync();
			case AnimationPackage.SEQ_TYPE__FILL:
				return getFill();
			case AnimationPackage.SEQ_TYPE__FILL_DEFAULT:
				return getFillDefault();
			case AnimationPackage.SEQ_TYPE__GROUP_ID:
				return getGroupId();
			case AnimationPackage.SEQ_TYPE__ID:
				return getId();
			case AnimationPackage.SEQ_TYPE__MASTER_ELEMENT:
				return getMasterElement();
			case AnimationPackage.SEQ_TYPE__NODE_TYPE:
				return getNodeType();
			case AnimationPackage.SEQ_TYPE__PRESET_CLASS:
				return getPresetClass();
			case AnimationPackage.SEQ_TYPE__PRESET_ID:
				return getPresetId();
			case AnimationPackage.SEQ_TYPE__PRESET_SUB_TYPE:
				return getPresetSubType();
			case AnimationPackage.SEQ_TYPE__REPEAT_COUNT:
				return getRepeatCount();
			case AnimationPackage.SEQ_TYPE__REPEAT_DUR:
				return getRepeatDur();
			case AnimationPackage.SEQ_TYPE__RESTART:
				return getRestart();
			case AnimationPackage.SEQ_TYPE__RESTART_DEFAULT:

...
import es.tid.cim.diagram.edit.commands.LogicalModuleModulePortCreateCommand;
import es.tid.cim.diagram.edit.commands.LogicalModuleModulePortReorientCommand;
 ...
 * @generated
 */
public class LogicalModuleItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.LogicalModuleModulePort_4038 == req
				.getElementType()) {
			return getGEFWrapper(new LogicalModuleModulePortCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case LogicalModuleModulePortEditPart.VISUAL_ID:
			return getGEFWrapper(new LogicalModuleModulePortReorientCommand(req));

 ...
 * @generated
 */
public class BGPClusterReflectorClientServiceViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(BGPClusterReflectorClientServiceEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel101EditPart.VISUAL_ID),

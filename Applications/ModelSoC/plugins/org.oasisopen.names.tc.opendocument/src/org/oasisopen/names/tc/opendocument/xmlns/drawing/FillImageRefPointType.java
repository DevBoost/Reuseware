...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Fill Image Ref Point Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.oasisopen.names.tc.opendocument.xmlns.drawing.DrawingPackage#getFillImageRefPointType()
 * @model extendedMetaData="name='fill-image-ref-point_._type'"
 * @generated
 */
public enum FillImageRefPointType implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	TOP_RIGHT(2, "topRight", "top-right"),
	 ...
	 * @ordered
	 */
	BOTTOM_LEFT(6, "bottomLeft", "bottom-left"),
	 ...
	 * @ordered
	 */
	BOTTOM_RIGHT(8, "bottomRight", "bottom-right");
	...
	/**
	 * An array of all the '<em><b>Fill Image Ref Point Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FillImageRefPointType[] VALUES_ARRAY =
		new FillImageRefPointType[] {
			TOP_LEFT,
			TOP,
			TOP_RIGHT,
			LEFT,
	...
	/**
	 * A public read-only list of all the '<em><b>Fill Image Ref Point Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FillImageRefPointType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Fill Image Ref Point Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static FillImageRefPointType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FillImageRefPointType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Fill Image Ref Point Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static FillImageRefPointType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FillImageRefPointType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Fill Image Ref Point Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static FillImageRefPointType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FillImageRefPointType(int value, String name, String literal) {
		this.value = value;
		this.name = name;

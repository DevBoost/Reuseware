...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Animate Transform Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getAccelerate <em>Accelerate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getAccumulate <em>Accumulate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getAdditive <em>Additive</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getAttributeName <em>Attribute Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getAutoReverse <em>Auto Reverse</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getBy <em>By</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getDecelerate <em>Decelerate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getDur <em>Dur</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getFillDefault <em>Fill Default</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getFormula <em>Formula</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getFrom <em>From</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getRepeatCount <em>Repeat Count</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getRepeatDur <em>Repeat Dur</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getRestart <em>Restart</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getRestartDefault <em>Restart Default</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getSubItem <em>Sub Item</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateTransformTypeImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AnimateTransformTypeImpl extends EObjectImpl implements AnimateTransformType {
	/**
	 ...
	 * @generated
	 */
	protected AnimateTransformTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AnimationPackage.Literals.ANIMATE_TRANSFORM_TYPE;
	}
	...
	public void setAccelerate(double newAccelerate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__ACCELERATE, oldAccelerate, accelerate, !oldAccelerateESet));
	}
	...
	public void unsetAccelerate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__ACCELERATE, oldAccelerate, ACCELERATE_EDEFAULT, oldAccelerateESet));
	}
	...
	public void setAccumulate(AccumulateType newAccumulate) {
		...
		accumulateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__ACCUMULATE, oldAccumulate, accumulate, !oldAccumulateESet));
	}
	...
	public void unsetAccumulate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__ACCUMULATE, oldAccumulate, ACCUMULATE_EDEFAULT, oldAccumulateESet));
	}
	...
	public void setAdditive(AdditiveType newAdditive) {
		...
		additiveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__ADDITIVE, oldAdditive, additive, !oldAdditiveESet));
	}
	...
	public void unsetAdditive() {
		...
		additiveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__ADDITIVE, oldAdditive, ADDITIVE_EDEFAULT, oldAdditiveESet));
	}
	...
	public void setAttributeName(String newAttributeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__ATTRIBUTE_NAME, oldAttributeName, attributeName));
	}
	...
	public void setAutoReverse(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newAutoReverse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__AUTO_REVERSE, oldAutoReverse, autoReverse, !oldAutoReverseESet));
	}
	...
	public void unsetAutoReverse() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__AUTO_REVERSE, oldAutoReverse, AUTO_REVERSE_EDEFAULT, oldAutoReverseESet));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setBy(String newBy) {
		...
		by = newBy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__BY, oldBy, by));
	}
	...
	public void setDecelerate(double newDecelerate) {
		...
		decelerateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__DECELERATE, oldDecelerate, decelerate, !oldDecelerateESet));
	}
	...
	public void unsetDecelerate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__DECELERATE, oldDecelerate, DECELERATE_EDEFAULT, oldDecelerateESet));
	}
	...
	public void setDur(String newDur) {
		...
		dur = newDur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__DUR, oldDur, dur));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__END, oldEnd, end));
	}
	...
	public void setFill(FillType newFill) {
		...
		fillESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__FILL, oldFill, fill, !oldFillESet));
	}
	...
	public void unsetFill() {
		...
		fillESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__FILL, oldFill, FILL_EDEFAULT, oldFillESet));
	}
	...
	public void setFillDefault(FillDefaultType newFillDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__FILL_DEFAULT, oldFillDefault, fillDefault, !oldFillDefaultESet));
	}
	...
	public void unsetFillDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__FILL_DEFAULT, oldFillDefault, FILL_DEFAULT_EDEFAULT, oldFillDefaultESet));
	}
	...
	public void setFormula(String newFormula) {
		...
		formula = newFormula;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__FORMULA, oldFormula, formula));
	}
	...
	public void setFrom(String newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__FROM, oldFrom, from));
	}
	...
	public void setRepeatCount(Object newRepeatCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__REPEAT_COUNT, oldRepeatCount, repeatCount));
	}
	...
	public void setRepeatDur(String newRepeatDur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__REPEAT_DUR, oldRepeatDur, repeatDur));
	}
	...
	public void setRestart(RestartType newRestart) {
		...
		restartESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__RESTART, oldRestart, restart, !oldRestartESet));
	}
	...
	public void unsetRestart() {
		...
		restartESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__RESTART, oldRestart, RESTART_EDEFAULT, oldRestartESet));
	}
	...
	public void setRestartDefault(RestartDefaultType newRestartDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__RESTART_DEFAULT, oldRestartDefault, restartDefault, !oldRestartDefaultESet));
	}
	...
	public void unsetRestartDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__RESTART_DEFAULT, oldRestartDefault, RESTART_DEFAULT_EDEFAULT, oldRestartDefaultESet));
	}
	...
	public void setSubItem(String newSubItem) {
		...
		subItem = newSubItem;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__SUB_ITEM, oldSubItem, subItem));
	}
	...
	public void setTargetElement(String newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public void setTo(String newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__TO, oldTo, to));
	}
	...
	public void setType(TypeType newType) {
		...
		typeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public void setValues(String newValues) {
		...
		values = newValues;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_TRANSFORM_TYPE__VALUES, oldValues, values));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__ACCELERATE:
				return new Double(getAccelerate());
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__ACCUMULATE:
				return getAccumulate();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__ADDITIVE:
				return getAdditive();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__ATTRIBUTE_NAME:
				return getAttributeName();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__AUTO_REVERSE:
				return getAutoReverse();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__BEGIN:
				return getBegin();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__BY:
				return getBy();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__DECELERATE:
				return new Double(getDecelerate());
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__DUR:
				return getDur();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__END:
				return getEnd();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__FILL:
				return getFill();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__FILL_DEFAULT:
				return getFillDefault();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__FORMULA:
				return getFormula();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__FROM:
				return getFrom();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__REPEAT_COUNT:
				return getRepeatCount();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__REPEAT_DUR:
				return getRepeatDur();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__RESTART:
				return getRestart();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__RESTART_DEFAULT:
				return getRestartDefault();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__SUB_ITEM:
				return getSubItem();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__TARGET_ELEMENT:
				return getTargetElement();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__TO:
				return getTo();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__TYPE:
				return getType();
			case AnimationPackage.ANIMATE_TRANSFORM_TYPE__VALUES:
				return getValues();
		}

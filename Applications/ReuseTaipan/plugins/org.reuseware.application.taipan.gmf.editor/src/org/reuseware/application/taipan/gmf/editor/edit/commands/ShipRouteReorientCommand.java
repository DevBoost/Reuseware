...
public class ShipRouteReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof RouteType && newEnd instanceof Ship)) {
			return false;
		}
		return TaiPanBaseItemSemanticEditPolicy.LinkConstraints
				.canExistShipRoute_4004(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		if (!(oldEnd instanceof RouteType && newEnd instanceof RouteType)) {
			return false;
		}
		return TaiPanBaseItemSemanticEditPolicy.LinkConstraints
				.canExistShipRoute_4004(getOldSource(), getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected RouteType getOldTarget() {
		return (RouteType) oldEnd;
	}

	/**
	 * @generated
	 */
	protected RouteType getNewTarget() {
		return (RouteType) newEnd;
	}
}

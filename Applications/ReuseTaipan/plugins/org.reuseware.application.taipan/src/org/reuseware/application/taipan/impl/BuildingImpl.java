 ...
 * <ul>
 *   <li>{@link org.reuseware.application.taipan.impl.BuildingImpl#getInfo <em>Info</em>}</li>
 *   <li>{@link org.reuseware.application.taipan.impl.BuildingImpl#getStreet <em>Street</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BuildingImpl extends EObjectImpl implements Building {
	...
	public void setInfo(String newInfo) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaiPanPackage.BUILDING__INFO, oldInfo, info));
	}
	...
	public void setStreet(String newStreet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaiPanPackage.BUILDING__STREET, oldStreet, street));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case TaiPanPackage.BUILDING__INFO:
			return INFO_EDEFAULT == null ? info != null : !INFO_EDEFAULT
					.equals(info);
		case TaiPanPackage.BUILDING__STREET:

 ...
 * @generated
 */
public class ManagedElementHostedDependencyCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ManagedElementHostedDependencyCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateManagedElementHostedDependency_4022(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHostedDependency().add(getTarget());
		}

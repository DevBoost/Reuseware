...
/**
 * This is the item provider adapter for a {@link org.reuseware.application.taipan.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider extends ItemTypeItemProvider implements
	...
	protected void addArticlePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_Item_article_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Item_article_feature", "_UI_Item_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						TaiPanPackage.Literals.ITEM__ARTICLE, true, false,

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hide Shape Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getSound <em>Sound</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getPathId <em>Path Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getShapeId <em>Shape Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getSpeed <em>Speed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.presentation.impl.HideShapeTypeImpl#getStartScale <em>Start Scale</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HideShapeTypeImpl extends EObjectImpl implements HideShapeType {
	/**
	...
	protected EClass eStaticClass() {
		return PresentationPackage.Literals.HIDE_SHAPE_TYPE;
	}
	...
	public NotificationChain basicSetSound(SoundType newSound, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__SOUND, oldSound, newSound);
	...
	public void setSound(SoundType newSound) {
		if (newSound != sound) {
			...
			if (sound != null)
				msgs = ((InternalEObject)sound).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PresentationPackage.HIDE_SHAPE_TYPE__SOUND, null, msgs);
			if (newSound != null)
				msgs = ((InternalEObject)newSound).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PresentationPackage.HIDE_SHAPE_TYPE__SOUND, null, msgs);
			msgs = basicSetSound(newSound, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__SOUND, newSound, newSound));
	}
	...
	public void setDelay(Duration newDelay) {
		...
		delay = newDelay;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__DELAY, oldDelay, delay));
	}
	...
	public void setDirection(PresentationEffectDirections newDirection) {
		...
		directionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__DIRECTION, oldDirection, direction, !oldDirectionESet));
	}
	...
	public void unsetDirection() {
		...
		directionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PresentationPackage.HIDE_SHAPE_TYPE__DIRECTION, oldDirection, DIRECTION_EDEFAULT, oldDirectionESet));
	}
	...
	public void setEffect(PresentationEffects newEffect) {
		...
		effectESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__EFFECT, oldEffect, effect, !oldEffectESet));
	}
	...
	public void unsetEffect() {
		...
		effectESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PresentationPackage.HIDE_SHAPE_TYPE__EFFECT, oldEffect, EFFECT_EDEFAULT, oldEffectESet));
	}
	...
	public void setPathId(Object newPathId) {
		...
		pathId = newPathId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__PATH_ID, oldPathId, pathId));
	}
	...
	public void setShapeId(String newShapeId) {
		...
		shapeId = newShapeId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__SHAPE_ID, oldShapeId, shapeId));
	}
	...
	public void setSpeed(PresentationSpeeds newSpeed) {
		...
		speedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__SPEED, oldSpeed, speed, !oldSpeedESet));
	}
	...
	public void unsetSpeed() {
		...
		speedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PresentationPackage.HIDE_SHAPE_TYPE__SPEED, oldSpeed, SPEED_EDEFAULT, oldSpeedESet));
	}
	...
	public void setStartScale(String newStartScale) {
		...
		startScaleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PresentationPackage.HIDE_SHAPE_TYPE__START_SCALE, oldStartScale, startScale, !oldStartScaleESet));
	}
	...
	public void unsetStartScale() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, PresentationPackage.HIDE_SHAPE_TYPE__START_SCALE, oldStartScale, START_SCALE_EDEFAULT, oldStartScaleESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PresentationPackage.HIDE_SHAPE_TYPE__SOUND:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PresentationPackage.HIDE_SHAPE_TYPE__SOUND:
				return getSound();
			case PresentationPackage.HIDE_SHAPE_TYPE__DELAY:
				return getDelay();
			case PresentationPackage.HIDE_SHAPE_TYPE__DIRECTION:
				return getDirection();
			case PresentationPackage.HIDE_SHAPE_TYPE__EFFECT:
				return getEffect();
			case PresentationPackage.HIDE_SHAPE_TYPE__PATH_ID:
				return getPathId();
			case PresentationPackage.HIDE_SHAPE_TYPE__SHAPE_ID:
				return getShapeId();
			case PresentationPackage.HIDE_SHAPE_TYPE__SPEED:
				return getSpeed();
			case PresentationPackage.HIDE_SHAPE_TYPE__START_SCALE:

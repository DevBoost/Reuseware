...
/**
 * This is the item provider adapter for a {@link org.reuseware.coconut.reuseextension.RuleContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RuleContextItemProvider
	 ...
	 * @generated
	 */
	public RuleContextItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((RuleContext)object).getIsExpression();
		return label == null || label.length() == 0 ?
			getString("_UI_RuleContext_type") :
			getString("_UI_RuleContext_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RuleContext.class)) {
			case ReuseextensionPackage.RULE_CONTEXT__IS_EXPRESSION:

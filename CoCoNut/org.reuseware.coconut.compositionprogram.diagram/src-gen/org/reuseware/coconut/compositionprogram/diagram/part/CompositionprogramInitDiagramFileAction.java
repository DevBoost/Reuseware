 ...
 * @generated
 */
public class CompositionprogramInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		Wizard wizard = new CompositionprogramNewDiagramFileWizard(
				domainModelURI, diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				CompositionProgramEditPart.MODEL_ID));
		CompositionprogramDiagramEditorUtil.runWizard(getShell(), wizard,

 ...
 * @generated
 */
public class ShipRouteCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ShipRouteCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof RouteType) {
			return false;
		}
		if (getSource() == null) {
		...
		return TaiPanBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateShipRoute_4004(getSource(), getTarget());
	}

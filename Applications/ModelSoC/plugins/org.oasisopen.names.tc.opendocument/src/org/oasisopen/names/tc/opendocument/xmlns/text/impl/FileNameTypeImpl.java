...
import org.oasisopen.names.tc.opendocument.xmlns.text.DisplayType5;
import org.oasisopen.names.tc.opendocument.xmlns.text.FileNameType;
 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.FileNameTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.FileNameTypeImpl#getDisplay <em>Display</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.FileNameTypeImpl#getFixed <em>Fixed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileNameTypeImpl extends EObjectImpl implements FileNameType {
	 ...
	 * @ordered
	 */
	protected static final DisplayType5 DISPLAY_EDEFAULT = DisplayType5.FULL;
	 ...
	 * @ordered
	 */
	protected DisplayType5 display = DISPLAY_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getFileNameType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TextPackage.FILE_NAME_TYPE__MIXED);
		}
		return mixed;
	}
	 ...
	 * @generated
	 */
	public DisplayType5 getDisplay() {
		return display;
	}
	 ...
	 * @generated
	 */
	public void setDisplay(DisplayType5 newDisplay) {
		DisplayType5 oldDisplay = display;
		display = newDisplay == null ? DISPLAY_EDEFAULT : newDisplay;
		boolean oldDisplayESet = displayESet;
		displayESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.FILE_NAME_TYPE__DISPLAY, oldDisplay, display, !oldDisplayESet));
	}
	...
	public void unsetDisplay() {
		...
		displayESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.FILE_NAME_TYPE__DISPLAY, oldDisplay, DISPLAY_EDEFAULT, oldDisplayESet));
	}
	...
	public void setFixed(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newFixed) {
		...
		fixedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.FILE_NAME_TYPE__FIXED, oldFixed, fixed, !oldFixedESet));
	}
	...
	public void unsetFixed() {
		...
		fixedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.FILE_NAME_TYPE__FIXED, oldFixed, FIXED_EDEFAULT, oldFixedESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.FILE_NAME_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.FILE_NAME_TYPE__DISPLAY:
				return getDisplay();
			case TextPackage.FILE_NAME_TYPE__FIXED:
				return getFixed();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case TextPackage.FILE_NAME_TYPE__MIXED:
				...
				return;
			case TextPackage.FILE_NAME_TYPE__DISPLAY:
				setDisplay((DisplayType5)newValue);
				return;
			case TextPackage.FILE_NAME_TYPE__FIXED:

 ...
 * @generated
 */
public class BGPClusterReflectorClientServiceCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public BGPClusterReflectorClientServiceCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateBGPClusterReflectorClientService_4007(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getReflectorClientService().add(getTarget());
		}

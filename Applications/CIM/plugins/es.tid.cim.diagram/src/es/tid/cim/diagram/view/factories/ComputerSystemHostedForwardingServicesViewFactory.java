 ...
 * @generated
 */
public class ComputerSystemHostedForwardingServicesViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ComputerSystemHostedForwardingServicesEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel146EditPart.VISUAL_ID),

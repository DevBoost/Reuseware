 ...
 * @generated
 */
public class PortPortNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				TaiPanVisualIDRegistry
						.getType(org.reuseware.application.taipan.gmf.editor.edit.parts.PortPortNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PortPortNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TaiPanParserProvider.HintAdapter(
					TaiPanElementTypes.PortSlot_2004, getParserElement(),
					parserHint);

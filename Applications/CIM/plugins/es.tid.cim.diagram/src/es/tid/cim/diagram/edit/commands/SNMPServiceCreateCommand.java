 ...
 * @generated
 */
public class SNMPServiceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public SNMPServiceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		SNMPService newElement = CimFactory.eINSTANCE.createSNMPService();

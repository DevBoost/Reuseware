...
public class AsNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.reuseware.air.language.abstractsyntax.resource.as.ui.AsNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public AsNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsUIPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsUIPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.reuseware.air.language.abstractsyntax.resource.as.mopp.AsMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.reuseware.air.language.abstractsyntax.resource.as.mopp.AsMetaInformation().getSyntaxName();
	}

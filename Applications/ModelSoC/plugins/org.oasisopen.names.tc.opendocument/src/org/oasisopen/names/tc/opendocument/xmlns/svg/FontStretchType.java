 ...
 * <!-- end-user-doc -->
 * @see org.oasisopen.names.tc.opendocument.xmlns.svg.SvgPackage#getFontStretchType()
 * @model extendedMetaData="name='font-stretch_._type'"
 * @generated
 */
public enum FontStretchType implements Enumerator {
	 ...
	 * @ordered
	 */
	ULTRA_CONDENSED(1, "ultraCondensed", "ultra-condensed"),
	 ...
	 * @ordered
	 */
	EXTRA_CONDENSED(2, "extraCondensed", "extra-condensed"),
	 ...
	 * @ordered
	 */
	SEMI_CONDENSED(4, "semiCondensed", "semi-condensed"),
	 ...
	 * @ordered
	 */
	SEMI_EXPANDED(5, "semiExpanded", "semi-expanded"),
	 ...
	 * @ordered
	 */
	EXTRA_EXPANDED(7, "extraExpanded", "extra-expanded"),
	 ...
	 * @ordered
	 */
	ULTRA_EXPANDED(8, "ultraExpanded", "ultra-expanded");

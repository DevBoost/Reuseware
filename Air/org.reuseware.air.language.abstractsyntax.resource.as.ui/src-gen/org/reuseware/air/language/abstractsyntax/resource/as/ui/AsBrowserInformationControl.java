 ...
 * @since 3.2
 */
public class AsBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput fInput;
	 ...
	 */
	public AsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public AsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public AsBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput);
		...
		fInput= (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput) input;
		...
		org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput getInput() {
		return fInput;
	}

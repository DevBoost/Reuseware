...
import org.oasisopen.names.tc.opendocument.xmlns.text.PageVariableGetType;
import org.oasisopen.names.tc.opendocument.xmlns.text.TextPackage;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Page Variable Get Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.PageVariableGetTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.PageVariableGetTypeImpl#getNumFormat <em>Num Format</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.PageVariableGetTypeImpl#getNumLetterSync <em>Num Letter Sync</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PageVariableGetTypeImpl extends EObjectImpl implements PageVariableGetType {
	/**
	 ...
	 * @generated
	 */
	protected PageVariableGetTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getPageVariableGetType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TextPackage.PAGE_VARIABLE_GET_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setNumFormat(Object newNumFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.PAGE_VARIABLE_GET_TYPE__NUM_FORMAT, oldNumFormat, numFormat));
	}
	...
	public void setNumLetterSync(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newNumLetterSync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.PAGE_VARIABLE_GET_TYPE__NUM_LETTER_SYNC, oldNumLetterSync, numLetterSync, !oldNumLetterSyncESet));
	}
	...
	public void unsetNumLetterSync() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.PAGE_VARIABLE_GET_TYPE__NUM_LETTER_SYNC, oldNumLetterSync, NUM_LETTER_SYNC_EDEFAULT, oldNumLetterSyncESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.PAGE_VARIABLE_GET_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.PAGE_VARIABLE_GET_TYPE__NUM_FORMAT:
				return getNumFormat();
			case TextPackage.PAGE_VARIABLE_GET_TYPE__NUM_LETTER_SYNC:

 ...
 * @generated
 */
public class ProtocolEndpointIngressConditioningServiceOnEndpointViewFactory
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ProtocolEndpointIngressConditioningServiceOnEndpointEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel149EditPart.VISUAL_ID),

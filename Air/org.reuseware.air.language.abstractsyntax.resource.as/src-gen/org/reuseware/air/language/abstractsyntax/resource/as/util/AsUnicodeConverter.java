 ...
 * to 4 bytes).
 */
public class AsUnicodeConverter extends org.reuseware.air.language.abstractsyntax.resource.as.mopp.AsInputStreamProcessor {
	 ...
	 */
	public AsUnicodeConverter(java.io.InputStream inputStream) {

 ...
 * @generated
 */
public class OperatingSystemOperatingSystemSoftwareFeatureViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(OperatingSystemOperatingSystemSoftwareFeatureEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel96EditPart.VISUAL_ID),

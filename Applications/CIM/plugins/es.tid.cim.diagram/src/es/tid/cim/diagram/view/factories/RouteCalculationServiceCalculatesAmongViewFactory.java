 ...
 * @generated
 */
public class RouteCalculationServiceCalculatesAmongViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(RouteCalculationServiceCalculatesAmongEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel140EditPart.VISUAL_ID),

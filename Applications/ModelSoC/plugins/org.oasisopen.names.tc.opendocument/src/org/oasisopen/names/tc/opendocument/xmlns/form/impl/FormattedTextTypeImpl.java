...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Formatted Text Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getBind <em>Bind</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getControlImplementation <em>Control Implementation</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getConvertEmptyToNull <em>Convert Empty To Null</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getCurrentValue <em>Current Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getDataField <em>Data Field</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getPrintable <em>Printable</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getReadonly <em>Readonly</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getTabIndex <em>Tab Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getTabStop <em>Tab Stop</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getValidation <em>Validation</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.FormattedTextTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FormattedTextTypeImpl extends CommonFormControlContentImpl implements FormattedTextType {
	/**
	 ...
	 * @ordered
	 */
	protected static final org.oasisopen.names.tc.opendocument.xmlns.text.Boolean VALIDATION_EDEFAULT = org.oasisopen.names.tc.opendocument.xmlns.text.Boolean.FALSE;
	 ...
	 * @generated
	 */
	protected FormattedTextTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return FormPackage.eINSTANCE.getFormattedTextType();
	}
	...
	public void setBind(String newBind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__BIND, oldBind, bind));
	}
	...
	public void setControlImplementation(String newControlImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__CONTROL_IMPLEMENTATION, oldControlImplementation, controlImplementation));
	}
	...
	public void setConvertEmptyToNull(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newConvertEmptyToNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__CONVERT_EMPTY_TO_NULL, oldConvertEmptyToNull, convertEmptyToNull, !oldConvertEmptyToNullESet));
	}
	...
	public void unsetConvertEmptyToNull() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FORMATTED_TEXT_TYPE__CONVERT_EMPTY_TO_NULL, oldConvertEmptyToNull, CONVERT_EMPTY_TO_NULL_EDEFAULT, oldConvertEmptyToNullESet));
	}
	...
	public void setCurrentValue(String newCurrentValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__CURRENT_VALUE, oldCurrentValue, currentValue));
	}
	...
	public void setDataField(String newDataField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__DATA_FIELD, oldDataField, dataField));
	}
	...
	public void setDisabled(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newDisabled) {
		...
		disabledESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__DISABLED, oldDisabled, disabled, !oldDisabledESet));
	}
	...
	public void unsetDisabled() {
		...
		disabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FORMATTED_TEXT_TYPE__DISABLED, oldDisabled, DISABLED_EDEFAULT, oldDisabledESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__ID, oldId, id));
	}
	...
	public void setMaxLength(BigInteger newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setMaxValue(String newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__MAX_VALUE, oldMaxValue, maxValue));
	}
	...
	public void setMinValue(String newMinValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__MIN_VALUE, oldMinValue, minValue));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__NAME, oldName, name));
	}
	...
	public void setPrintable(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newPrintable) {
		...
		printableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__PRINTABLE, oldPrintable, printable, !oldPrintableESet));
	}
	...
	public void unsetPrintable() {
		...
		printableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FORMATTED_TEXT_TYPE__PRINTABLE, oldPrintable, PRINTABLE_EDEFAULT, oldPrintableESet));
	}
	...
	public void setReadonly(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newReadonly) {
		...
		readonlyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__READONLY, oldReadonly, readonly, !oldReadonlyESet));
	}
	...
	public void unsetReadonly() {
		...
		readonlyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FORMATTED_TEXT_TYPE__READONLY, oldReadonly, READONLY_EDEFAULT, oldReadonlyESet));
	}
	...
	public void setTabIndex(BigInteger newTabIndex) {
		...
		tabIndexESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__TAB_INDEX, oldTabIndex, tabIndex, !oldTabIndexESet));
	}
	...
	public void unsetTabIndex() {
		...
		tabIndexESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FORMATTED_TEXT_TYPE__TAB_INDEX, oldTabIndex, TAB_INDEX_EDEFAULT, oldTabIndexESet));
	}
	...
	public void setTabStop(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTabStop) {
		...
		tabStopESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__TAB_STOP, oldTabStop, tabStop, !oldTabStopESet));
	}
	...
	public void unsetTabStop() {
		...
		tabStopESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FORMATTED_TEXT_TYPE__TAB_STOP, oldTabStop, TAB_STOP_EDEFAULT, oldTabStopESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setValidation(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newValidation) {
		...
		validationESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__VALIDATION, oldValidation, validation, !oldValidationESet));
	}
	...
	public void unsetValidation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.FORMATTED_TEXT_TYPE__VALIDATION, oldValidation, VALIDATION_EDEFAULT, oldValidationESet));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.FORMATTED_TEXT_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.FORMATTED_TEXT_TYPE__BIND:
				return getBind();
			case FormPackage.FORMATTED_TEXT_TYPE__CONTROL_IMPLEMENTATION:
				return getControlImplementation();
			case FormPackage.FORMATTED_TEXT_TYPE__CONVERT_EMPTY_TO_NULL:
				return getConvertEmptyToNull();
			case FormPackage.FORMATTED_TEXT_TYPE__CURRENT_VALUE:
				return getCurrentValue();
			case FormPackage.FORMATTED_TEXT_TYPE__DATA_FIELD:
				return getDataField();
			case FormPackage.FORMATTED_TEXT_TYPE__DISABLED:
				return getDisabled();
			case FormPackage.FORMATTED_TEXT_TYPE__ID:
				return getId();
			case FormPackage.FORMATTED_TEXT_TYPE__MAX_LENGTH:
				return getMaxLength();
			case FormPackage.FORMATTED_TEXT_TYPE__MAX_VALUE:
				return getMaxValue();
			case FormPackage.FORMATTED_TEXT_TYPE__MIN_VALUE:
				return getMinValue();
			case FormPackage.FORMATTED_TEXT_TYPE__NAME:
				return getName();
			case FormPackage.FORMATTED_TEXT_TYPE__PRINTABLE:
				return getPrintable();
			case FormPackage.FORMATTED_TEXT_TYPE__READONLY:
				return getReadonly();
			case FormPackage.FORMATTED_TEXT_TYPE__TAB_INDEX:
				return getTabIndex();
			case FormPackage.FORMATTED_TEXT_TYPE__TAB_STOP:
				return getTabStop();
			case FormPackage.FORMATTED_TEXT_TYPE__TITLE:
				return getTitle();
			case FormPackage.FORMATTED_TEXT_TYPE__VALIDATION:
				return getValidation();
			case FormPackage.FORMATTED_TEXT_TYPE__VALUE:
				return getValue();
		}

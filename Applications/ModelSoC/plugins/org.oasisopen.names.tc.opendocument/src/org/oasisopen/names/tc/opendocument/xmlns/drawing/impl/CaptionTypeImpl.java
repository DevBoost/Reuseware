 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getEventListeners <em>Event Listeners</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getGluePoint <em>Glue Point</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getP <em>P</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getList <em>List</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getAnchorPageNumber <em>Anchor Page Number</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getAnchorType <em>Anchor Type</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getCaptionId <em>Caption Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getCaptionPointX <em>Caption Point X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getCaptionPointY <em>Caption Point Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getClassNames <em>Class Names</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getClassNames1 <em>Class Names1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getCornerRadius <em>Corner Radius</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getEndCellAddress <em>End Cell Address</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getEndX <em>End X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getEndY <em>End Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getStyleName <em>Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getStyleName1 <em>Style Name1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getTableBackground <em>Table Background</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getTextStyleName <em>Text Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getX <em>X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getY <em>Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CaptionTypeImpl#getZIndex <em>ZIndex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CaptionTypeImpl extends EObjectImpl implements CaptionType {
	/**
	...
	protected EClass eStaticClass() {
		return DrawingPackage.eINSTANCE.getCaptionType();
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__DESC, oldDesc, desc));
	}
	...
	public NotificationChain basicSetEventListeners(EventListenersType newEventListeners, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__EVENT_LISTENERS, oldEventListeners, newEventListeners);
	...
	public void setEventListeners(EventListenersType newEventListeners) {
		if (newEventListeners != eventListeners) {
			...
			if (eventListeners != null)
				msgs = ((InternalEObject)eventListeners).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.CAPTION_TYPE__EVENT_LISTENERS, null, msgs);
			if (newEventListeners != null)
				msgs = ((InternalEObject)newEventListeners).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.CAPTION_TYPE__EVENT_LISTENERS, null, msgs);
			msgs = basicSetEventListeners(newEventListeners, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__EVENT_LISTENERS, newEventListeners, newEventListeners));
	}
	...
	public EList<GluePointType> getGluePoint() {
		if (gluePoint == null) {
			gluePoint = new EObjectContainmentEList<GluePointType>(GluePointType.class, this, DrawingPackage.CAPTION_TYPE__GLUE_POINT);
		}
		return gluePoint;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, DrawingPackage.CAPTION_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<PType> getP() {
		return getGroup().list(DrawingPackage.eINSTANCE.getCaptionType_P());
	}
	...
	public EList<ListType> getList() {
		return getGroup().list(DrawingPackage.eINSTANCE.getCaptionType_List());
	}
	...
	public void setAnchorPageNumber(BigInteger newAnchorPageNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__ANCHOR_PAGE_NUMBER, oldAnchorPageNumber, anchorPageNumber));
	}
	...
	public void setAnchorType(AnchorTypeType newAnchorType) {
		...
		anchorTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__ANCHOR_TYPE, oldAnchorType, anchorType, !oldAnchorTypeESet));
	}
	...
	public void unsetAnchorType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.CAPTION_TYPE__ANCHOR_TYPE, oldAnchorType, ANCHOR_TYPE_EDEFAULT, oldAnchorTypeESet));
	}
	...
	public void setCaptionId(String newCaptionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__CAPTION_ID, oldCaptionId, captionId));
	}
	...
	public void setCaptionPointX(String newCaptionPointX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__CAPTION_POINT_X, oldCaptionPointX, captionPointX));
	}
	...
	public void setCaptionPointY(String newCaptionPointY) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__CAPTION_POINT_Y, oldCaptionPointY, captionPointY));
	}
	...
	public void setClassNames(List<String> newClassNames) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__CLASS_NAMES, oldClassNames, classNames));
	}
	...
	public void setClassNames1(List<String> newClassNames1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__CLASS_NAMES1, oldClassNames1, classNames1));
	}
	...
	public void setCornerRadius(String newCornerRadius) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__CORNER_RADIUS, oldCornerRadius, cornerRadius));
	}
	...
	public void setEndCellAddress(String newEndCellAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__END_CELL_ADDRESS, oldEndCellAddress, endCellAddress));
	}
	...
	public void setEndX(String newEndX) {
		...
		endX = newEndX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__END_X, oldEndX, endX));
	}
	...
	public void setEndY(String newEndY) {
		...
		endY = newEndY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__END_Y, oldEndY, endY));
	}
	...
	public void setHeight(String newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__HEIGHT, oldHeight, height));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__ID, oldId, id));
	}
	...
	public void setLayer(String newLayer) {
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__LAYER, oldLayer, layer));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__NAME, oldName, name));
	}
	...
	public void setStyleName(String newStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__STYLE_NAME, oldStyleName, styleName));
	}
	...
	public void setStyleName1(String newStyleName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__STYLE_NAME1, oldStyleName1, styleName1));
	}
	...
	public void setTableBackground(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTableBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__TABLE_BACKGROUND, oldTableBackground, tableBackground, !oldTableBackgroundESet));
	}
	...
	public void unsetTableBackground() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.CAPTION_TYPE__TABLE_BACKGROUND, oldTableBackground, TABLE_BACKGROUND_EDEFAULT, oldTableBackgroundESet));
	}
	...
	public void setTextStyleName(String newTextStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__TEXT_STYLE_NAME, oldTextStyleName, textStyleName));
	}
	...
	public void setTransform(String newTransform) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__TRANSFORM, oldTransform, transform));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__WIDTH, oldWidth, width));
	}
	...
	public void setX(String newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__X, oldX, x));
	}
	...
	public void setY(String newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__Y, oldY, y));
	}
	...
	public void setZIndex(BigInteger newZIndex) {
		...
		zIndex = newZIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CAPTION_TYPE__ZINDEX, oldZIndex, zIndex));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DrawingPackage.CAPTION_TYPE__EVENT_LISTENERS:
				return basicSetEventListeners(null, msgs);
			case DrawingPackage.CAPTION_TYPE__GLUE_POINT:
				return ((InternalEList<?>)getGluePoint()).basicRemove(otherEnd, msgs);
			case DrawingPackage.CAPTION_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case DrawingPackage.CAPTION_TYPE__P:
				return ((InternalEList<?>)getP()).basicRemove(otherEnd, msgs);
			case DrawingPackage.CAPTION_TYPE__LIST:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DrawingPackage.CAPTION_TYPE__TITLE:
				return getTitle();
			case DrawingPackage.CAPTION_TYPE__DESC:
				return getDesc();
			case DrawingPackage.CAPTION_TYPE__EVENT_LISTENERS:
			...
			case DrawingPackage.CAPTION_TYPE__LIST:
				return getList();
			case DrawingPackage.CAPTION_TYPE__ANCHOR_PAGE_NUMBER:
				return getAnchorPageNumber();
			case DrawingPackage.CAPTION_TYPE__ANCHOR_TYPE:
				return getAnchorType();
			case DrawingPackage.CAPTION_TYPE__CAPTION_ID:
				return getCaptionId();
			case DrawingPackage.CAPTION_TYPE__CAPTION_POINT_X:
				return getCaptionPointX();
			case DrawingPackage.CAPTION_TYPE__CAPTION_POINT_Y:
				return getCaptionPointY();
			case DrawingPackage.CAPTION_TYPE__CLASS_NAMES:
				return getClassNames();
			case DrawingPackage.CAPTION_TYPE__CLASS_NAMES1:
				return getClassNames1();
			case DrawingPackage.CAPTION_TYPE__CORNER_RADIUS:
				return getCornerRadius();
			case DrawingPackage.CAPTION_TYPE__END_CELL_ADDRESS:
				return getEndCellAddress();
			case DrawingPackage.CAPTION_TYPE__END_X:
				return getEndX();
			case DrawingPackage.CAPTION_TYPE__END_Y:
				return getEndY();
			case DrawingPackage.CAPTION_TYPE__HEIGHT:
				return getHeight();
			case DrawingPackage.CAPTION_TYPE__ID:
				return getId();
			case DrawingPackage.CAPTION_TYPE__LAYER:
				return getLayer();
			case DrawingPackage.CAPTION_TYPE__NAME:
				return getName();
			case DrawingPackage.CAPTION_TYPE__STYLE_NAME:
				return getStyleName();
			case DrawingPackage.CAPTION_TYPE__STYLE_NAME1:
				return getStyleName1();
			case DrawingPackage.CAPTION_TYPE__TABLE_BACKGROUND:
				return getTableBackground();
			case DrawingPackage.CAPTION_TYPE__TEXT_STYLE_NAME:
				return getTextStyleName();
			case DrawingPackage.CAPTION_TYPE__TRANSFORM:
				return getTransform();
			case DrawingPackage.CAPTION_TYPE__WIDTH:
				return getWidth();
			case DrawingPackage.CAPTION_TYPE__X:
				return getX();
			case DrawingPackage.CAPTION_TYPE__Y:
				return getY();
			case DrawingPackage.CAPTION_TYPE__ZINDEX:
				return getZIndex();
		}

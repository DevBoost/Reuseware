...
/**
 * This is the item provider adapter for a {@link es.tid.cim.Capabilities} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CapabilitiesItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Capabilities_instanceID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Capabilities_instanceID_feature", "_UI_Capabilities_type"),
				 CimPackage.eINSTANCE.getCapabilities_InstanceID(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Capabilities)object).getElementName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Capabilities.class)) {
			case CimPackage.CAPABILITIES__INSTANCE_ID:

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Outline Level Style Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getListLevelProperties <em>List Level Properties</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getTextProperties <em>Text Properties</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getDisplayLevels <em>Display Levels</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getNumFormat <em>Num Format</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getNumLetterSync <em>Num Letter Sync</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getNumPrefix <em>Num Prefix</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getNumSuffix <em>Num Suffix</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getStartValue <em>Start Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.OutlineLevelStyleTypeImpl#getStyleName <em>Style Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OutlineLevelStyleTypeImpl extends EObjectImpl implements OutlineLevelStyleType {
	/**
	 ...
	 * @generated
	 */
	protected OutlineLevelStyleTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getOutlineLevelStyleType();
	}
	...
	public NotificationChain basicSetListLevelProperties(StyleListLevelPropertiesContent newListLevelProperties, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__LIST_LEVEL_PROPERTIES, oldListLevelProperties, newListLevelProperties);
	...
	public void setListLevelProperties(StyleListLevelPropertiesContent newListLevelProperties) {
		if (newListLevelProperties != listLevelProperties) {
			...
			if (listLevelProperties != null)
				msgs = ((InternalEObject)listLevelProperties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TextPackage.OUTLINE_LEVEL_STYLE_TYPE__LIST_LEVEL_PROPERTIES, null, msgs);
			if (newListLevelProperties != null)
				msgs = ((InternalEObject)newListLevelProperties).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TextPackage.OUTLINE_LEVEL_STYLE_TYPE__LIST_LEVEL_PROPERTIES, null, msgs);
			msgs = basicSetListLevelProperties(newListLevelProperties, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__LIST_LEVEL_PROPERTIES, newListLevelProperties, newListLevelProperties));
	}
	...
	public NotificationChain basicSetTextProperties(StyleTextPropertiesContent newTextProperties, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__TEXT_PROPERTIES, oldTextProperties, newTextProperties);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTextProperties(StyleTextPropertiesContent newTextProperties) {
		if (newTextProperties != textProperties) {
			...
			if (textProperties != null)
				msgs = ((InternalEObject)textProperties).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TextPackage.OUTLINE_LEVEL_STYLE_TYPE__TEXT_PROPERTIES, null, msgs);
			if (newTextProperties != null)
				msgs = ((InternalEObject)newTextProperties).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TextPackage.OUTLINE_LEVEL_STYLE_TYPE__TEXT_PROPERTIES, null, msgs);
			msgs = basicSetTextProperties(newTextProperties, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__TEXT_PROPERTIES, newTextProperties, newTextProperties));
	}
	...
	public void setDisplayLevels(BigInteger newDisplayLevels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__DISPLAY_LEVELS, oldDisplayLevels, displayLevels, !oldDisplayLevelsESet));
	}
	...
	public void unsetDisplayLevels() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__DISPLAY_LEVELS, oldDisplayLevels, DISPLAY_LEVELS_EDEFAULT, oldDisplayLevelsESet));
	}
	...
	public void setLevel(BigInteger newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__LEVEL, oldLevel, level));
	}
	...
	public void setNumFormat(Object newNumFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_FORMAT, oldNumFormat, numFormat));
	}
	...
	public void setNumLetterSync(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newNumLetterSync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_LETTER_SYNC, oldNumLetterSync, numLetterSync, !oldNumLetterSyncESet));
	}
	...
	public void unsetNumLetterSync() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_LETTER_SYNC, oldNumLetterSync, NUM_LETTER_SYNC_EDEFAULT, oldNumLetterSyncESet));
	}
	...
	public void setNumPrefix(String newNumPrefix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_PREFIX, oldNumPrefix, numPrefix));
	}
	...
	public void setNumSuffix(String newNumSuffix) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_SUFFIX, oldNumSuffix, numSuffix));
	}
	...
	public void setStartValue(BigInteger newStartValue) {
		...
		startValueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__START_VALUE, oldStartValue, startValue, !oldStartValueESet));
	}
	...
	public void unsetStartValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__START_VALUE, oldStartValue, START_VALUE_EDEFAULT, oldStartValueESet));
	}
	...
	public void setStyleName(String newStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.OUTLINE_LEVEL_STYLE_TYPE__STYLE_NAME, oldStyleName, styleName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__LIST_LEVEL_PROPERTIES:
				return basicSetListLevelProperties(null, msgs);
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__TEXT_PROPERTIES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__DISPLAY_LEVELS:
				return getDisplayLevels();
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__LEVEL:
				return getLevel();
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_FORMAT:
				return getNumFormat();
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_LETTER_SYNC:
				return getNumLetterSync();
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_PREFIX:
				return getNumPrefix();
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__NUM_SUFFIX:
				return getNumSuffix();
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__START_VALUE:
				return getStartValue();
			case TextPackage.OUTLINE_LEVEL_STYLE_TYPE__STYLE_NAME:
				return getStyleName();
		}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Odd Columns Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.OddColumnsTypeImpl#getParagraphStyleName <em>Paragraph Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.OddColumnsTypeImpl#getStyleName <em>Style Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OddColumnsTypeImpl extends EObjectImpl implements OddColumnsType {
	/**
	...
	protected EClass eStaticClass() {
		return TablePackage.eINSTANCE.getOddColumnsType();
	}
	...
	public void setParagraphStyleName(String newParagraphStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.ODD_COLUMNS_TYPE__PARAGRAPH_STYLE_NAME, oldParagraphStyleName, paragraphStyleName));
	}
	...
	public void setStyleName(String newStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.ODD_COLUMNS_TYPE__STYLE_NAME, oldStyleName, styleName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TablePackage.ODD_COLUMNS_TYPE__PARAGRAPH_STYLE_NAME:
				return getParagraphStyleName();
			case TablePackage.ODD_COLUMNS_TYPE__STYLE_NAME:
				return getStyleName();
		}

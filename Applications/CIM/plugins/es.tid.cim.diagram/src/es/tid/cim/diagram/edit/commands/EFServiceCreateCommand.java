 ...
 * @generated
 */
public class EFServiceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public EFServiceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		EFService newElement = CimFactory.eINSTANCE.createEFService();

 ...
 */
public class AsTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.reuseware.air.language.abstractsyntax.resource.as.IAsHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput infoInput = (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHyperlink hyperlink = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl iControl = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput) {
							org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput input = (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl.isAvailable(parent)) {
				org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl iControl = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public AsTextHover(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsUIMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.reuseware.air.language.abstractsyntax.resource.as.IAsTextResource textResource = editor.getResource();
	 ...
	 */
	private org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHTMLPrinter.insertPageProlog(buffer, 0, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsTextHover.getStyleSheet());
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHTMLPrinter.addPageEpilog(buffer);
			return new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsUIPlugin.PLUGIN_ID);

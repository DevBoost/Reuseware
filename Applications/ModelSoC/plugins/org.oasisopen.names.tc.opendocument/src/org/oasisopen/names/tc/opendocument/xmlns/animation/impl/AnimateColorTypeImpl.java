...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Animate Color Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getAccelerate <em>Accelerate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getAccumulate <em>Accumulate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getAdditive <em>Additive</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getAttributeName <em>Attribute Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getAutoReverse <em>Auto Reverse</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getBegin <em>Begin</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getBy <em>By</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getCalcMode <em>Calc Mode</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getColorInterpolation <em>Color Interpolation</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getColorInterpolationDirection <em>Color Interpolation Direction</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getDecelerate <em>Decelerate</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getDur <em>Dur</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getEnd <em>End</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getFill <em>Fill</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getFillDefault <em>Fill Default</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getFormula <em>Formula</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getFrom <em>From</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getKeySplines <em>Key Splines</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getKeyTimes <em>Key Times</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getRepeatCount <em>Repeat Count</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getRepeatDur <em>Repeat Dur</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getRestart <em>Restart</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getRestartDefault <em>Restart Default</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getSubItem <em>Sub Item</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getTargetElement <em>Target Element</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getTo <em>To</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.animation.impl.AnimateColorTypeImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AnimateColorTypeImpl extends EObjectImpl implements AnimateColorType {
	/**
	 ...
	 * @generated
	 */
	protected AnimateColorTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AnimationPackage.Literals.ANIMATE_COLOR_TYPE;
	}
	...
	public void setAccelerate(double newAccelerate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__ACCELERATE, oldAccelerate, accelerate, !oldAccelerateESet));
	}
	...
	public void unsetAccelerate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__ACCELERATE, oldAccelerate, ACCELERATE_EDEFAULT, oldAccelerateESet));
	}
	...
	public void setAccumulate(AccumulateType newAccumulate) {
		...
		accumulateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__ACCUMULATE, oldAccumulate, accumulate, !oldAccumulateESet));
	}
	...
	public void unsetAccumulate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__ACCUMULATE, oldAccumulate, ACCUMULATE_EDEFAULT, oldAccumulateESet));
	}
	...
	public void setAdditive(AdditiveType newAdditive) {
		...
		additiveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__ADDITIVE, oldAdditive, additive, !oldAdditiveESet));
	}
	...
	public void unsetAdditive() {
		...
		additiveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__ADDITIVE, oldAdditive, ADDITIVE_EDEFAULT, oldAdditiveESet));
	}
	...
	public void setAttributeName(String newAttributeName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__ATTRIBUTE_NAME, oldAttributeName, attributeName));
	}
	...
	public void setAutoReverse(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newAutoReverse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__AUTO_REVERSE, oldAutoReverse, autoReverse, !oldAutoReverseESet));
	}
	...
	public void unsetAutoReverse() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__AUTO_REVERSE, oldAutoReverse, AUTO_REVERSE_EDEFAULT, oldAutoReverseESet));
	}
	...
	public void setBegin(String newBegin) {
		...
		begin = newBegin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__BEGIN, oldBegin, begin));
	}
	...
	public void setBy(String newBy) {
		...
		by = newBy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__BY, oldBy, by));
	}
	...
	public void setCalcMode(CalcModeType newCalcMode) {
		...
		calcModeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__CALC_MODE, oldCalcMode, calcMode, !oldCalcModeESet));
	}
	...
	public void unsetCalcMode() {
		...
		calcModeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__CALC_MODE, oldCalcMode, CALC_MODE_EDEFAULT, oldCalcModeESet));
	}
	...
	public void setColorInterpolation(ColorInterpolationType newColorInterpolation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__COLOR_INTERPOLATION, oldColorInterpolation, colorInterpolation, !oldColorInterpolationESet));
	}
	...
	public void unsetColorInterpolation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__COLOR_INTERPOLATION, oldColorInterpolation, COLOR_INTERPOLATION_EDEFAULT, oldColorInterpolationESet));
	}
	...
	public void setColorInterpolationDirection(ColorInterpolationDirectionType newColorInterpolationDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__COLOR_INTERPOLATION_DIRECTION, oldColorInterpolationDirection, colorInterpolationDirection, !oldColorInterpolationDirectionESet));
	}
	...
	public void unsetColorInterpolationDirection() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__COLOR_INTERPOLATION_DIRECTION, oldColorInterpolationDirection, COLOR_INTERPOLATION_DIRECTION_EDEFAULT, oldColorInterpolationDirectionESet));
	}
	...
	public void setDecelerate(double newDecelerate) {
		...
		decelerateESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__DECELERATE, oldDecelerate, decelerate, !oldDecelerateESet));
	}
	...
	public void unsetDecelerate() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__DECELERATE, oldDecelerate, DECELERATE_EDEFAULT, oldDecelerateESet));
	}
	...
	public void setDur(String newDur) {
		...
		dur = newDur;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__DUR, oldDur, dur));
	}
	...
	public void setEnd(String newEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__END, oldEnd, end));
	}
	...
	public void setFill(FillType newFill) {
		...
		fillESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__FILL, oldFill, fill, !oldFillESet));
	}
	...
	public void unsetFill() {
		...
		fillESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__FILL, oldFill, FILL_EDEFAULT, oldFillESet));
	}
	...
	public void setFillDefault(FillDefaultType newFillDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__FILL_DEFAULT, oldFillDefault, fillDefault, !oldFillDefaultESet));
	}
	...
	public void unsetFillDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__FILL_DEFAULT, oldFillDefault, FILL_DEFAULT_EDEFAULT, oldFillDefaultESet));
	}
	...
	public void setFormula(String newFormula) {
		...
		formula = newFormula;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__FORMULA, oldFormula, formula));
	}
	...
	public void setFrom(String newFrom) {
		...
		from = newFrom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__FROM, oldFrom, from));
	}
	...
	public void setKeySplines(String newKeySplines) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__KEY_SPLINES, oldKeySplines, keySplines));
	}
	...
	public void setKeyTimes(String newKeyTimes) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__KEY_TIMES, oldKeyTimes, keyTimes));
	}
	...
	public void setRepeatCount(Object newRepeatCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__REPEAT_COUNT, oldRepeatCount, repeatCount));
	}
	...
	public void setRepeatDur(String newRepeatDur) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__REPEAT_DUR, oldRepeatDur, repeatDur));
	}
	...
	public void setRestart(RestartType newRestart) {
		...
		restartESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__RESTART, oldRestart, restart, !oldRestartESet));
	}
	...
	public void unsetRestart() {
		...
		restartESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__RESTART, oldRestart, RESTART_EDEFAULT, oldRestartESet));
	}
	...
	public void setRestartDefault(RestartDefaultType newRestartDefault) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__RESTART_DEFAULT, oldRestartDefault, restartDefault, !oldRestartDefaultESet));
	}
	...
	public void unsetRestartDefault() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, AnimationPackage.ANIMATE_COLOR_TYPE__RESTART_DEFAULT, oldRestartDefault, RESTART_DEFAULT_EDEFAULT, oldRestartDefaultESet));
	}
	...
	public void setSubItem(String newSubItem) {
		...
		subItem = newSubItem;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__SUB_ITEM, oldSubItem, subItem));
	}
	...
	public void setTargetElement(String newTargetElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__TARGET_ELEMENT, oldTargetElement, targetElement));
	}
	...
	public void setTo(String newTo) {
		...
		to = newTo;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__TO, oldTo, to));
	}
	...
	public void setValues(String newValues) {
		...
		values = newValues;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnimationPackage.ANIMATE_COLOR_TYPE__VALUES, oldValues, values));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AnimationPackage.ANIMATE_COLOR_TYPE__ACCELERATE:
				return new Double(getAccelerate());
			case AnimationPackage.ANIMATE_COLOR_TYPE__ACCUMULATE:
				return getAccumulate();
			case AnimationPackage.ANIMATE_COLOR_TYPE__ADDITIVE:
				return getAdditive();
			case AnimationPackage.ANIMATE_COLOR_TYPE__ATTRIBUTE_NAME:
				return getAttributeName();
			case AnimationPackage.ANIMATE_COLOR_TYPE__AUTO_REVERSE:
				return getAutoReverse();
			case AnimationPackage.ANIMATE_COLOR_TYPE__BEGIN:
				return getBegin();
			case AnimationPackage.ANIMATE_COLOR_TYPE__BY:
				return getBy();
			case AnimationPackage.ANIMATE_COLOR_TYPE__CALC_MODE:
				return getCalcMode();
			case AnimationPackage.ANIMATE_COLOR_TYPE__COLOR_INTERPOLATION:
				return getColorInterpolation();
			case AnimationPackage.ANIMATE_COLOR_TYPE__COLOR_INTERPOLATION_DIRECTION:
				return getColorInterpolationDirection();
			case AnimationPackage.ANIMATE_COLOR_TYPE__DECELERATE:
				return new Double(getDecelerate());
			case AnimationPackage.ANIMATE_COLOR_TYPE__DUR:
				return getDur();
			case AnimationPackage.ANIMATE_COLOR_TYPE__END:
				return getEnd();
			case AnimationPackage.ANIMATE_COLOR_TYPE__FILL:
				return getFill();
			case AnimationPackage.ANIMATE_COLOR_TYPE__FILL_DEFAULT:
				return getFillDefault();
			case AnimationPackage.ANIMATE_COLOR_TYPE__FORMULA:
				return getFormula();
			case AnimationPackage.ANIMATE_COLOR_TYPE__FROM:
				return getFrom();
			case AnimationPackage.ANIMATE_COLOR_TYPE__KEY_SPLINES:
				return getKeySplines();
			case AnimationPackage.ANIMATE_COLOR_TYPE__KEY_TIMES:
				return getKeyTimes();
			case AnimationPackage.ANIMATE_COLOR_TYPE__REPEAT_COUNT:
				return getRepeatCount();
			case AnimationPackage.ANIMATE_COLOR_TYPE__REPEAT_DUR:
				return getRepeatDur();
			case AnimationPackage.ANIMATE_COLOR_TYPE__RESTART:
				return getRestart();
			case AnimationPackage.ANIMATE_COLOR_TYPE__RESTART_DEFAULT:
				return getRestartDefault();
			case AnimationPackage.ANIMATE_COLOR_TYPE__SUB_ITEM:
				return getSubItem();
			case AnimationPackage.ANIMATE_COLOR_TYPE__TARGET_ELEMENT:
				return getTargetElement();
			case AnimationPackage.ANIMATE_COLOR_TYPE__TO:
				return getTo();
			case AnimationPackage.ANIMATE_COLOR_TYPE__VALUES:
				return getValues();
		}

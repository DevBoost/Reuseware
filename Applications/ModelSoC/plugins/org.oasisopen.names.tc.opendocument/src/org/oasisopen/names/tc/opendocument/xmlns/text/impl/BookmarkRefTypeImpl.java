...
import org.oasisopen.names.tc.opendocument.xmlns.text.BookmarkRefType;
import org.oasisopen.names.tc.opendocument.xmlns.text.ReferenceFormatType1;
import org.oasisopen.names.tc.opendocument.xmlns.text.TextPackage;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bookmark Ref Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.BookmarkRefTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.BookmarkRefTypeImpl#getReferenceFormat <em>Reference Format</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.BookmarkRefTypeImpl#getRefName <em>Ref Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BookmarkRefTypeImpl extends EObjectImpl implements BookmarkRefType {
	/**
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getBookmarkRefType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TextPackage.BOOKMARK_REF_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setReferenceFormat(ReferenceFormatType1 newReferenceFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.BOOKMARK_REF_TYPE__REFERENCE_FORMAT, oldReferenceFormat, referenceFormat, !oldReferenceFormatESet));
	}
	...
	public void unsetReferenceFormat() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.BOOKMARK_REF_TYPE__REFERENCE_FORMAT, oldReferenceFormat, REFERENCE_FORMAT_EDEFAULT, oldReferenceFormatESet));
	}
	...
	public void setRefName(String newRefName) {
		...
		refName = newRefName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.BOOKMARK_REF_TYPE__REF_NAME, oldRefName, refName));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.BOOKMARK_REF_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.BOOKMARK_REF_TYPE__REFERENCE_FORMAT:
				return getReferenceFormat();
			case TextPackage.BOOKMARK_REF_TYPE__REF_NAME:
				return getRefName();
		}

 ...
 * hovers, is a proxy.
 */
public class AsHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public AsHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.reuseware.air.language.abstractsyntax.resource.as.IAsTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);

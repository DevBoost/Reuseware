 ...
 * @generated
 */
public class AutonomousSystemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public AutonomousSystemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		AutonomousSystem newElement = CimFactory.eINSTANCE

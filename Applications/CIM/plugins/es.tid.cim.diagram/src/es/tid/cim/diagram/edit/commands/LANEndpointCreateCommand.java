 ...
 * @generated
 */
public class LANEndpointCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public LANEndpointCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		LANEndpoint newElement = CimFactory.eINSTANCE.createLANEndpoint();

 ...
 * @generated
 */
public class ElementSoftwareIdentityManagedElementViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ElementSoftwareIdentityManagedElementEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel118EditPart.VISUAL_ID),

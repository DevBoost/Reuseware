 ...
 * @generated
 */
public class SystemSystemComponentsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SystemSystemComponentsReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ManagedElement && newEnd instanceof System)) {
			return false;
		}
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSystemSystemComponents_4036(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistSystemSystemComponents_4036(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getSystemComponents().remove(getOldTarget());
		getNewSource().getSystemComponents().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getSystemComponents().remove(getOldTarget());
		getOldSource().getSystemComponents().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

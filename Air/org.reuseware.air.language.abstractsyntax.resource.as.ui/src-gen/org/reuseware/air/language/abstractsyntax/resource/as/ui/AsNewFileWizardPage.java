 ...
 */
public class AsNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public AsNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new as file");

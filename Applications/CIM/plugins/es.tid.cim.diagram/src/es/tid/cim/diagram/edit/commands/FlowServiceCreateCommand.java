 ...
 * @generated
 */
public class FlowServiceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public FlowServiceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		FlowService newElement = CimFactory.eINSTANCE.createFlowService();

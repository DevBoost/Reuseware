 ...
 * @generated
 */
public class AdminDomainCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public AdminDomainCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		AdminDomain newElement = CimFactory.eINSTANCE.createAdminDomain();

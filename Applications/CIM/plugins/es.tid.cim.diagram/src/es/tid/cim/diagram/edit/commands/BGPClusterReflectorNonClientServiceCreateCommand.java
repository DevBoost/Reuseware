 ...
 * @generated
 */
public class BGPClusterReflectorNonClientServiceCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public BGPClusterReflectorNonClientServiceCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateBGPClusterReflectorNonClientService_4008(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getReflectorNonClientService().add(getTarget());
		}

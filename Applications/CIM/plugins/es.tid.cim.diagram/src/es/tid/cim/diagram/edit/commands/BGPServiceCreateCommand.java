 ...
 * @generated
 */
public class BGPServiceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public BGPServiceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		BGPService newElement = CimFactory.eINSTANCE.createBGPService();

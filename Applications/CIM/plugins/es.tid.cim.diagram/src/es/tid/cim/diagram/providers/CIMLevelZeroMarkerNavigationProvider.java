...
import es.tid.cim.diagram.part.CIMLevelZeroDiagramEditorUtil;

/**
 * @generated
 */
public class CIMLevelZeroMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = CIMLevelZeroDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			CIMLevelZeroDiagramEditorUtil.selectElementsInDiagram(editor,

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Source Range Address Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getEndColumn <em>End Column</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getEndRow <em>End Row</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getEndTable <em>End Table</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getRow <em>Row</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getStartColumn <em>Start Column</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getStartRow <em>Start Row</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getStartTable <em>Start Table</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.table.impl.SourceRangeAddressTypeImpl#getTable <em>Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SourceRangeAddressTypeImpl extends EObjectImpl implements SourceRangeAddressType {
	/**
	 ...
	 * @generated
	 */
	protected SourceRangeAddressTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TablePackage.eINSTANCE.getSourceRangeAddressType();
	}
	...
	public void setColumn(BigInteger newColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__COLUMN, oldColumn, column));
	}
	...
	public void setEndColumn(BigInteger newEndColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__END_COLUMN, oldEndColumn, endColumn));
	}
	...
	public void setEndRow(BigInteger newEndRow) {
		...
		endRow = newEndRow;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__END_ROW, oldEndRow, endRow));
	}
	...
	public void setEndTable(BigInteger newEndTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__END_TABLE, oldEndTable, endTable));
	}
	...
	public void setRow(BigInteger newRow) {
		...
		row = newRow;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__ROW, oldRow, row));
	}
	...
	public void setStartColumn(BigInteger newStartColumn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__START_COLUMN, oldStartColumn, startColumn));
	}
	...
	public void setStartRow(BigInteger newStartRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__START_ROW, oldStartRow, startRow));
	}
	...
	public void setStartTable(BigInteger newStartTable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__START_TABLE, oldStartTable, startTable));
	}
	...
	public void setTable(BigInteger newTable) {
		...
		table = newTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.SOURCE_RANGE_ADDRESS_TYPE__TABLE, oldTable, table));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__COLUMN:
				return getColumn();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__END_COLUMN:
				return getEndColumn();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__END_ROW:
				return getEndRow();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__END_TABLE:
				return getEndTable();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__ROW:
				return getRow();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__START_COLUMN:
				return getStartColumn();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__START_ROW:
				return getStartRow();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__START_TABLE:
				return getStartTable();
			case TablePackage.SOURCE_RANGE_ADDRESS_TYPE__TABLE:
				return getTable();
		}

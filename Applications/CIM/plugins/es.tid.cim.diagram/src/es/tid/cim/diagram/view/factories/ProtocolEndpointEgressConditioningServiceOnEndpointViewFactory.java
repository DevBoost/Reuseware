 ...
 * @generated
 */
public class ProtocolEndpointEgressConditioningServiceOnEndpointViewFactory
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ProtocolEndpointEgressConditioningServiceOnEndpointEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel141EditPart.VISUAL_ID),

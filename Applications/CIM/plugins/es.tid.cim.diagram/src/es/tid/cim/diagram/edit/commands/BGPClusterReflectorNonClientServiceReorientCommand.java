 ...
 * @generated
 */
public class BGPClusterReflectorNonClientServiceReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public BGPClusterReflectorNonClientServiceReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBGPClusterReflectorNonClientService_4008(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getReflectorNonClientService().remove(getOldTarget());
		getNewSource().getReflectorNonClientService().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getReflectorNonClientService().remove(getOldTarget());
		getOldSource().getReflectorNonClientService().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

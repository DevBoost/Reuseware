 ...
 * @generated
 */
public class SoftwareIdentityCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public SoftwareIdentityCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		SoftwareIdentity newElement = CimFactory.eINSTANCE

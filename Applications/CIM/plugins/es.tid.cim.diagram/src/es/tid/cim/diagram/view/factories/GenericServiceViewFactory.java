 ...
 * @generated
 */
public class GenericServiceViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(GenericServiceEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel43EditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}

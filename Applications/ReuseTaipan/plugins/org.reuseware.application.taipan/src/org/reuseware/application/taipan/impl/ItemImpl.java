 ...
 * <ul>
 *   <li>{@link org.reuseware.application.taipan.impl.ItemImpl#getArticle <em>Article</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ItemImpl extends ItemTypeImpl implements Item {
	...
	public void setArticle(String newArticle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaiPanPackage.ITEM__ARTICLE, oldArticle, article));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case TaiPanPackage.ITEM__ARTICLE:
			return ARTICLE_EDEFAULT == null ? article != null
					: !ARTICLE_EDEFAULT.equals(article);
		}

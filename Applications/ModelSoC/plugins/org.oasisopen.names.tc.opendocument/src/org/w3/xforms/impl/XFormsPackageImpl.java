 ...
 * @generated
 */
public class XFormsPackageImpl extends EPackageImpl implements XFormsPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.w3.xforms.XFormsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private XFormsPackageImpl() {
		super(eNS_URI, XFormsFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static XFormsPackage init() {
		if (isInited) return (XFormsPackage)EPackage.Registry.INSTANCE.getEPackage(XFormsPackage.eNS_URI);

		// Obtain or create and register package
		XFormsPackageImpl theXFormsPackage = (XFormsPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof XFormsPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new XFormsPackageImpl());
		...
		theXFormsPackage.freeze();

		return theXFormsPackage;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDocumentRoot_Bind() {
	 ...
	 * @generated
	 */
	public XFormsFactory getXFormsFactory() {
		return (XFormsFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(documentRootEClass, DOCUMENT_ROOT__BIND);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getDocumentRoot_Model(), theTextPackage.getAnyAttListOrElements(), null, "model", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getDocumentRoot_Bind(), theTextPackage.getString(), "bind", null, 0, 1, null, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

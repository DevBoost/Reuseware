 ...
 * @generated
 */
public class IPSubnetCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public IPSubnetCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		IPSubnet newElement = CimFactory.eINSTANCE.createIPSubnet();

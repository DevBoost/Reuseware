 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.style.impl.HeaderTypeImpl#getDisplay <em>Display</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HeaderTypeImpl extends HeaderFooterContentImpl implements HeaderType {
	/**
	...
	protected EClass eStaticClass() {
		return StylePackage.eINSTANCE.getHeaderType();
	}
	...
	public void setDisplay(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newDisplay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StylePackage.HEADER_TYPE__DISPLAY, oldDisplay, display, !oldDisplayESet));
	}
	...
	public void unsetDisplay() {
		...
		displayESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, StylePackage.HEADER_TYPE__DISPLAY, oldDisplay, DISPLAY_EDEFAULT, oldDisplayESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StylePackage.HEADER_TYPE__DISPLAY:
				return getDisplay();
		}

 ...
 * @generated
 */
public class ProtocolServiceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public ProtocolServiceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		ProtocolService newElement = CimFactory.eINSTANCE

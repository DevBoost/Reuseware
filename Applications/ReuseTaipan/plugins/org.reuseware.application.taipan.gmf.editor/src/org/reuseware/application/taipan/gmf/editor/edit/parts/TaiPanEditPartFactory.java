	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case PortSlotEditPart.VISUAL_ID:
				return new PortSlotEditPart(view);

			case PortPortNameEditPart.VISUAL_ID:
				return new PortPortNameEditPart(view);

			case RouteSlotEditPart.VISUAL_ID:
				return new RouteSlotEditPart(view);

			case RoutePortNameEditPart.VISUAL_ID:
				return new RoutePortNameEditPart(view);
			...
			case ItemHookEditPart.VISUAL_ID:
				return new ItemHookEditPart(view);

			case CargoExtensionEditPart.VISUAL_ID:
				return new CargoExtensionEditPart(view);

 ...
 * @generated
 */
public class ServiceServiceServiceDependencyCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceServiceServiceDependencyCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateServiceServiceServiceDependency_4032(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getServiceServiceDependency().add(getTarget());
		}

...
import es.tid.cim.diagram.edit.commands.AFServiceAFRelatedServicesCreateCommand;
import es.tid.cim.diagram.edit.commands.AFServiceAFRelatedServicesReorientCommand;
...
import es.tid.cim.diagram.edit.commands.QoSServiceQoSConditioningSubServiceCreateCommand;
import es.tid.cim.diagram.edit.commands.QoSServiceQoSConditioningSubServiceReorientCommand;
import es.tid.cim.diagram.edit.commands.QoSServiceQoSSubServiceCreateCommand;
import es.tid.cim.diagram.edit.commands.QoSServiceQoSSubServiceReorientCommand;
 ...
 * @generated
 */
public class AFServiceItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.AFServiceAFRelatedServices_4039 == req
				.getElementType()) {
			return getGEFWrapper(new AFServiceAFRelatedServicesCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.QoSServiceQoSConditioningSubService_4040 == req
				.getElementType()) {
			return getGEFWrapper(new QoSServiceQoSConditioningSubServiceCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.QoSServiceQoSSubService_4041 == req
				.getElementType()) {
			return getGEFWrapper(new QoSServiceQoSSubServiceCreateCommand(req,
					req.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case AFServiceAFRelatedServicesEditPart.VISUAL_ID:
			return getGEFWrapper(new AFServiceAFRelatedServicesReorientCommand(
					req));
		case QoSServiceQoSConditioningSubServiceEditPart.VISUAL_ID:
			return getGEFWrapper(new QoSServiceQoSConditioningSubServiceReorientCommand(
					req));
		case QoSServiceQoSSubServiceEditPart.VISUAL_ID:
			return getGEFWrapper(new QoSServiceQoSSubServiceReorientCommand(req));

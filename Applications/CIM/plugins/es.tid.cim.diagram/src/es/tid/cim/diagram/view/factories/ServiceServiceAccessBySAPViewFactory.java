 ...
 * @generated
 */
public class ServiceServiceAccessBySAPViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ServiceServiceAccessBySAPEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel124EditPart.VISUAL_ID),

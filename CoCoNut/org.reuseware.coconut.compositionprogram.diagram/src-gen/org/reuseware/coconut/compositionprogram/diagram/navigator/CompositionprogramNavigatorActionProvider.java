 ...
 * @generated
 */
public class CompositionprogramNavigatorActionProvider extends
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof CompositionprogramNavigatorItem) {
					selectedElement = ((CompositionprogramNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, CompositionprogramDiagramEditor.ID);

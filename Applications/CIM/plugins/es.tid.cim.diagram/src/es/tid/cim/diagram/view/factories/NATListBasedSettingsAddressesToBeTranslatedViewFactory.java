 ...
 * @generated
 */
public class NATListBasedSettingsAddressesToBeTranslatedViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(NATListBasedSettingsAddressesToBeTranslatedEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel137EditPart.VISUAL_ID),

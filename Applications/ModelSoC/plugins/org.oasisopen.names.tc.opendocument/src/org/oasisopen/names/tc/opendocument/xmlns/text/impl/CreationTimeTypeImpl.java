...
import org.oasisopen.names.tc.opendocument.xmlns.text.CreationTimeType;
 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.CreationTimeTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.CreationTimeTypeImpl#getDataStyleName <em>Data Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.CreationTimeTypeImpl#getFixed <em>Fixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.CreationTimeTypeImpl#getTimeValue <em>Time Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CreationTimeTypeImpl extends EObjectImpl implements CreationTimeType {
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getCreationTimeType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TextPackage.CREATION_TIME_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setDataStyleName(String newDataStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.CREATION_TIME_TYPE__DATA_STYLE_NAME, oldDataStyleName, dataStyleName));
	}
	...
	public void setFixed(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newFixed) {
		...
		fixedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.CREATION_TIME_TYPE__FIXED, oldFixed, fixed, !oldFixedESet));
	}
	...
	public void unsetFixed() {
		...
		fixedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.CREATION_TIME_TYPE__FIXED, oldFixed, FIXED_EDEFAULT, oldFixedESet));
	}
	...
	public void setTimeValue(XMLGregorianCalendar newTimeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.CREATION_TIME_TYPE__TIME_VALUE, oldTimeValue, timeValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.CREATION_TIME_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.CREATION_TIME_TYPE__DATA_STYLE_NAME:
				return getDataStyleName();
			case TextPackage.CREATION_TIME_TYPE__FIXED:
				return getFixed();
			case TextPackage.CREATION_TIME_TYPE__TIME_VALUE:
				return getTimeValue();
		}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Era Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.datastyle.impl.EraTypeImpl#getCalendar <em>Calendar</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.datastyle.impl.EraTypeImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EraTypeImpl extends EObjectImpl implements EraType {
	/**
	...
	protected EClass eStaticClass() {
		return DatastylePackage.Literals.ERA_TYPE;
	}
	...
	public void setCalendar(Object newCalendar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatastylePackage.ERA_TYPE__CALENDAR, oldCalendar, calendar));
	}
	...
	public void setStyle(StyleType newStyle) {
		...
		styleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatastylePackage.ERA_TYPE__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DatastylePackage.ERA_TYPE__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatastylePackage.ERA_TYPE__CALENDAR:
				return getCalendar();
			case DatastylePackage.ERA_TYPE__STYLE:
				return getStyle();
		}

 ...
 * @generated
 */
public class ForwardingServiceForwardedRoutesCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ForwardingServiceForwardedRoutesCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof IPRoute) {
			return false;
		}
		if (getSource() == null) {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateForwardingServiceForwardedRoutes_4049(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getForwardedRoutes().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected IPRoute getTarget() {
		return (IPRoute) target;
	}
}

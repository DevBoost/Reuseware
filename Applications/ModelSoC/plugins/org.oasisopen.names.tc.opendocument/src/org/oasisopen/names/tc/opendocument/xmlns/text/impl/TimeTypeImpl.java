...
import org.oasisopen.names.tc.opendocument.xmlns.text.TimeType;
 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.TimeTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.TimeTypeImpl#getDataStyleName <em>Data Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.TimeTypeImpl#getFixed <em>Fixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.TimeTypeImpl#getTimeAdjust <em>Time Adjust</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.TimeTypeImpl#getTimeValue <em>Time Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeTypeImpl extends EObjectImpl implements TimeType {
	...
	/**
	 * The default value of the '{@link #getTimeAdjust() <em>Time Adjust</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTimeAdjust()
	 * @generated
	 * @ordered
	 */
	protected static final Duration TIME_ADJUST_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getTimeAdjust() <em>Time Adjust</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTimeAdjust()
	 * @generated
	 * @ordered
	 */
	protected Duration timeAdjust = TIME_ADJUST_EDEFAULT;
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getTimeType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TextPackage.TIME_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setDataStyleName(String newDataStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.TIME_TYPE__DATA_STYLE_NAME, oldDataStyleName, dataStyleName));
	}
	...
	public void setFixed(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newFixed) {
		...
		fixedESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.TIME_TYPE__FIXED, oldFixed, fixed, !oldFixedESet));
	}
	...
	public void unsetFixed() {
		...
		fixedESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.TIME_TYPE__FIXED, oldFixed, FIXED_EDEFAULT, oldFixedESet));
	}
	 ...
	 * @generated
	 */
	public void setTimeAdjust(Duration newTimeAdjust) {
		Duration oldTimeAdjust = timeAdjust;
		timeAdjust = newTimeAdjust;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.TIME_TYPE__TIME_ADJUST, oldTimeAdjust, timeAdjust));
	}
	...
	public void setTimeValue(XMLGregorianCalendar newTimeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.TIME_TYPE__TIME_VALUE, oldTimeValue, timeValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.TIME_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.TIME_TYPE__DATA_STYLE_NAME:
				return getDataStyleName();
			case TextPackage.TIME_TYPE__FIXED:
				return getFixed();
			case TextPackage.TIME_TYPE__TIME_ADJUST:
				return getTimeAdjust();
			case TextPackage.TIME_TYPE__TIME_VALUE:
				return getTimeValue();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TextPackage.TIME_TYPE__FIXED:
				...
				return;
			case TextPackage.TIME_TYPE__TIME_ADJUST:
				setTimeAdjust((Duration)newValue);
				return;
			case TextPackage.TIME_TYPE__TIME_VALUE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case TextPackage.TIME_TYPE__FIXED:
				...
				return;
			case TextPackage.TIME_TYPE__TIME_ADJUST:
				setTimeAdjust(TIME_ADJUST_EDEFAULT);
				return;
			case TextPackage.TIME_TYPE__TIME_VALUE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case TextPackage.TIME_TYPE__FIXED:
				return isSetFixed();
			case TextPackage.TIME_TYPE__TIME_ADJUST:
				return TIME_ADJUST_EDEFAULT == null ? timeAdjust != null : !TIME_ADJUST_EDEFAULT.equals(timeAdjust);
			case TextPackage.TIME_TYPE__TIME_VALUE:

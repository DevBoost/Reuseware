...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rotate Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getClassNames <em>Class Names</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getClassNames1 <em>Class Names1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getD <em>D</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getStyleName <em>Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getStyleName1 <em>Style Name1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getViewBox <em>View Box</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.dr3d.impl.RotateTypeImpl#getZIndex <em>ZIndex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RotateTypeImpl extends EObjectImpl implements RotateType {
	/**
	...
	protected EClass eStaticClass() {
		return Dr3dPackage.Literals.ROTATE_TYPE;
	}
	...
	public void setClassNames(List<String> newClassNames) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__CLASS_NAMES, oldClassNames, classNames));
	}
	...
	public void setClassNames1(List<String> newClassNames1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__CLASS_NAMES1, oldClassNames1, classNames1));
	}
	...
	public void setD(String newD) {
		...
		d = newD;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__D, oldD, d));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__ID, oldId, id));
	}
	...
	public void setLayer(String newLayer) {
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__LAYER, oldLayer, layer));
	}
	...
	public void setStyleName(String newStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__STYLE_NAME, oldStyleName, styleName));
	}
	...
	public void setStyleName1(String newStyleName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__STYLE_NAME1, oldStyleName1, styleName1));
	}
	...
	public void setTransform(Object newTransform) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__TRANSFORM, oldTransform, transform));
	}
	...
	public void setViewBox(List newViewBox) {
		...
		viewBox = newViewBox;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__VIEW_BOX, oldViewBox, viewBox));
	}
	...
	public void setZIndex(BigInteger newZIndex) {
		...
		zIndex = newZIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Dr3dPackage.ROTATE_TYPE__ZINDEX, oldZIndex, zIndex));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Dr3dPackage.ROTATE_TYPE__CLASS_NAMES:
				return getClassNames();
			case Dr3dPackage.ROTATE_TYPE__CLASS_NAMES1:
				return getClassNames1();
			case Dr3dPackage.ROTATE_TYPE__D:
				return getD();
			case Dr3dPackage.ROTATE_TYPE__ID:
				return getId();
			case Dr3dPackage.ROTATE_TYPE__LAYER:
				return getLayer();
			case Dr3dPackage.ROTATE_TYPE__STYLE_NAME:
				return getStyleName();
			case Dr3dPackage.ROTATE_TYPE__STYLE_NAME1:
				return getStyleName1();
			case Dr3dPackage.ROTATE_TYPE__TRANSFORM:
				return getTransform();
			case Dr3dPackage.ROTATE_TYPE__VIEW_BOX:
				return getViewBox();
			case Dr3dPackage.ROTATE_TYPE__ZINDEX:
				return getZIndex();
		}

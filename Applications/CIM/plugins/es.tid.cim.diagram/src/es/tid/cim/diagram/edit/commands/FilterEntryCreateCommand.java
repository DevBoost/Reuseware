 ...
 * @generated
 */
public class FilterEntryCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public FilterEntryCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		FilterEntry newElement = CimFactory.eINSTANCE.createFilterEntry();

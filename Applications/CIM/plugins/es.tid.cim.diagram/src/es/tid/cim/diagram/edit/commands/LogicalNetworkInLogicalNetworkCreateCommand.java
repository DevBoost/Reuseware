 ...
 * @generated
 */
public class LogicalNetworkInLogicalNetworkCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public LogicalNetworkInLogicalNetworkCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof LogicalNetwork) {
			return false;
		}
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateLogicalNetworkInLogicalNetwork_4056(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getInLogicalNetwork().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected LogicalNetwork getSource() {
		return (LogicalNetwork) source;
	}

 ...
 * @generated
 */
public class DirectoryCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public DirectoryCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		Directory newElement = CimFactory.eINSTANCE.createDirectory();

 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getBind <em>Bind</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getControlImplementation <em>Control Implementation</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getConvertEmptyToNull <em>Convert Empty To Null</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getCurrentValue <em>Current Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getDataField <em>Data Field</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getMaxValue <em>Max Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getMinValue <em>Min Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getPrintable <em>Printable</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getReadonly <em>Readonly</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getTabIndex <em>Tab Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getTabStop <em>Tab Stop</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.DateTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DateTypeImpl extends CommonFormControlContentImpl implements DateType {
	/**
	...
	protected EClass eStaticClass() {
		return FormPackage.eINSTANCE.getDateType();
	}
	...
	public void setBind(String newBind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__BIND, oldBind, bind));
	}
	...
	public void setControlImplementation(String newControlImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__CONTROL_IMPLEMENTATION, oldControlImplementation, controlImplementation));
	}
	...
	public void setConvertEmptyToNull(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newConvertEmptyToNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__CONVERT_EMPTY_TO_NULL, oldConvertEmptyToNull, convertEmptyToNull, !oldConvertEmptyToNullESet));
	}
	...
	public void unsetConvertEmptyToNull() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.DATE_TYPE__CONVERT_EMPTY_TO_NULL, oldConvertEmptyToNull, CONVERT_EMPTY_TO_NULL_EDEFAULT, oldConvertEmptyToNullESet));
	}
	...
	public void setCurrentValue(XMLGregorianCalendar newCurrentValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__CURRENT_VALUE, oldCurrentValue, currentValue));
	}
	...
	public void setDataField(String newDataField) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__DATA_FIELD, oldDataField, dataField));
	}
	...
	public void setDisabled(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newDisabled) {
		...
		disabledESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__DISABLED, oldDisabled, disabled, !oldDisabledESet));
	}
	...
	public void unsetDisabled() {
		...
		disabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.DATE_TYPE__DISABLED, oldDisabled, DISABLED_EDEFAULT, oldDisabledESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__ID, oldId, id));
	}
	...
	public void setMaxLength(BigInteger newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setMaxValue(XMLGregorianCalendar newMaxValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__MAX_VALUE, oldMaxValue, maxValue));
	}
	...
	public void setMinValue(XMLGregorianCalendar newMinValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__MIN_VALUE, oldMinValue, minValue));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__NAME, oldName, name));
	}
	...
	public void setPrintable(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newPrintable) {
		...
		printableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__PRINTABLE, oldPrintable, printable, !oldPrintableESet));
	}
	...
	public void unsetPrintable() {
		...
		printableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.DATE_TYPE__PRINTABLE, oldPrintable, PRINTABLE_EDEFAULT, oldPrintableESet));
	}
	...
	public void setReadonly(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newReadonly) {
		...
		readonlyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__READONLY, oldReadonly, readonly, !oldReadonlyESet));
	}
	...
	public void unsetReadonly() {
		...
		readonlyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.DATE_TYPE__READONLY, oldReadonly, READONLY_EDEFAULT, oldReadonlyESet));
	}
	...
	public void setTabIndex(BigInteger newTabIndex) {
		...
		tabIndexESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__TAB_INDEX, oldTabIndex, tabIndex, !oldTabIndexESet));
	}
	...
	public void unsetTabIndex() {
		...
		tabIndexESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.DATE_TYPE__TAB_INDEX, oldTabIndex, TAB_INDEX_EDEFAULT, oldTabIndexESet));
	}
	...
	public void setTabStop(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTabStop) {
		...
		tabStopESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__TAB_STOP, oldTabStop, tabStop, !oldTabStopESet));
	}
	...
	public void unsetTabStop() {
		...
		tabStopESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.DATE_TYPE__TAB_STOP, oldTabStop, TAB_STOP_EDEFAULT, oldTabStopESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.DATE_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.DATE_TYPE__BIND:
				return getBind();
			case FormPackage.DATE_TYPE__CONTROL_IMPLEMENTATION:
				return getControlImplementation();
			case FormPackage.DATE_TYPE__CONVERT_EMPTY_TO_NULL:
				return getConvertEmptyToNull();
			case FormPackage.DATE_TYPE__CURRENT_VALUE:
				return getCurrentValue();
			case FormPackage.DATE_TYPE__DATA_FIELD:
				return getDataField();
			case FormPackage.DATE_TYPE__DISABLED:
				return getDisabled();
			case FormPackage.DATE_TYPE__ID:
				return getId();
			case FormPackage.DATE_TYPE__MAX_LENGTH:
				return getMaxLength();
			case FormPackage.DATE_TYPE__MAX_VALUE:
				return getMaxValue();
			case FormPackage.DATE_TYPE__MIN_VALUE:
				return getMinValue();
			case FormPackage.DATE_TYPE__NAME:
				return getName();
			case FormPackage.DATE_TYPE__PRINTABLE:
				return getPrintable();
			case FormPackage.DATE_TYPE__READONLY:
				return getReadonly();
			case FormPackage.DATE_TYPE__TAB_INDEX:
				return getTabIndex();
			case FormPackage.DATE_TYPE__TAB_STOP:
				return getTabStop();
			case FormPackage.DATE_TYPE__TITLE:
				return getTitle();
			case FormPackage.DATE_TYPE__VALUE:
				return getValue();
		}

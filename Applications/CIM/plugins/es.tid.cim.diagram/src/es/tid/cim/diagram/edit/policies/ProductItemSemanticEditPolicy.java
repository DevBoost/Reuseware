...
import es.tid.cim.diagram.edit.commands.ProductProductProductDependencyCreateCommand;
import es.tid.cim.diagram.edit.commands.ProductProductProductDependencyReorientCommand;
...
public class ProductItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.ProductProductProductDependency_4025 == req
				.getElementType()) {
			return getGEFWrapper(new ProductProductProductDependencyCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case ProductProductProductDependencyEditPart.VISUAL_ID:
			return getGEFWrapper(new ProductProductProductDependencyReorientCommand(
					req));

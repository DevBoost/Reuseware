 ...
 * @generated
 */
public class SystemHostedServicesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SystemHostedServicesCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSystemHostedServices_4023(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHostedServices().add(getTarget());
		}

 ...
 * @generated
 */
public class UDPProtocolEndpointViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(UDPProtocolEndpointEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel79EditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}

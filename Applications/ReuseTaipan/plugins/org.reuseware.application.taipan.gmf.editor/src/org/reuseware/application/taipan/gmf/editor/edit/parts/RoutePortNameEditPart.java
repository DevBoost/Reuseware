 ...
 * @generated
 */
public class RoutePortNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				TaiPanVisualIDRegistry
						.getType(org.reuseware.application.taipan.gmf.editor.edit.parts.RoutePortNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public RoutePortNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TaiPanParserProvider.HintAdapter(
					TaiPanElementTypes.RouteSlot_2005, getParserElement(),
					parserHint);

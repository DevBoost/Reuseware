 ...
 * @generated
 */
public class PortLocationEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				TaiPanVisualIDRegistry
						.getType(org.reuseware.application.taipan.gmf.editor.edit.parts.PortLocationEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PortLocationEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new TaiPanParserProvider.HintAdapter(
					TaiPanElementTypes.Port_2001, getParserElement(),
					parserHint);

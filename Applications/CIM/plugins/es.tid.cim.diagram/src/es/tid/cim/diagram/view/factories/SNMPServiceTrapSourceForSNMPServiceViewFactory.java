 ...
 * @generated
 */
public class SNMPServiceTrapSourceForSNMPServiceViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(SNMPServiceTrapSourceForSNMPServiceEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel164EditPart.VISUAL_ID),

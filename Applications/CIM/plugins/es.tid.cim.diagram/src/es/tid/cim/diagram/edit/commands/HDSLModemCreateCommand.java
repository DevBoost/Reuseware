 ...
 * @generated
 */
public class HDSLModemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public HDSLModemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		HDSLModem newElement = CimFactory.eINSTANCE.createHDSLModem();

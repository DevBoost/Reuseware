 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getBind <em>Bind</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getControlImplementation <em>Control Implementation</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getConvertEmptyToNull <em>Convert Empty To Null</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getDisabled <em>Disabled</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getEchoChar <em>Echo Char</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getPrintable <em>Printable</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getTabIndex <em>Tab Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getTabStop <em>Tab Stop</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.form.impl.PasswordTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PasswordTypeImpl extends CommonFormControlContentImpl implements PasswordType {
	/**
	 ...
	 * @ordered
	 */
	protected static final String ECHO_CHAR_EDEFAULT = "*";
	...
	/**
	 * This is true if the Echo Char attribute has been set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	protected boolean echoCharESet;
	...
	protected EClass eStaticClass() {
		return FormPackage.eINSTANCE.getPasswordType();
	}
	...
	public void setBind(String newBind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__BIND, oldBind, bind));
	}
	...
	public void setControlImplementation(String newControlImplementation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__CONTROL_IMPLEMENTATION, oldControlImplementation, controlImplementation));
	}
	...
	public void setConvertEmptyToNull(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newConvertEmptyToNull) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__CONVERT_EMPTY_TO_NULL, oldConvertEmptyToNull, convertEmptyToNull, !oldConvertEmptyToNullESet));
	}
	...
	public void unsetConvertEmptyToNull() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.PASSWORD_TYPE__CONVERT_EMPTY_TO_NULL, oldConvertEmptyToNull, CONVERT_EMPTY_TO_NULL_EDEFAULT, oldConvertEmptyToNullESet));
	}
	...
	public void setDisabled(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newDisabled) {
		...
		disabledESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__DISABLED, oldDisabled, disabled, !oldDisabledESet));
	}
	...
	public void unsetDisabled() {
		...
		disabledESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.PASSWORD_TYPE__DISABLED, oldDisabled, DISABLED_EDEFAULT, oldDisabledESet));
	}
	...
	public void setEchoChar(String newEchoChar) {
		...
		boolean oldEchoCharESet = echoCharESet;
		echoCharESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__ECHO_CHAR, oldEchoChar, echoChar, !oldEchoCharESet));
	}
	 ...
	 * @generated
	 */
	public void unsetEchoChar() {
		String oldEchoChar = echoChar;
		boolean oldEchoCharESet = echoCharESet;
		echoChar = ECHO_CHAR_EDEFAULT;
		echoCharESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.PASSWORD_TYPE__ECHO_CHAR, oldEchoChar, ECHO_CHAR_EDEFAULT, oldEchoCharESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__ID, oldId, id));
	}
	...
	public void setMaxLength(BigInteger newMaxLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__MAX_LENGTH, oldMaxLength, maxLength));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__NAME, oldName, name));
	}
	...
	public void setPrintable(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newPrintable) {
		...
		printableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__PRINTABLE, oldPrintable, printable, !oldPrintableESet));
	}
	...
	public void unsetPrintable() {
		...
		printableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.PASSWORD_TYPE__PRINTABLE, oldPrintable, PRINTABLE_EDEFAULT, oldPrintableESet));
	}
	...
	public void setTabIndex(BigInteger newTabIndex) {
		...
		tabIndexESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__TAB_INDEX, oldTabIndex, tabIndex, !oldTabIndexESet));
	}
	...
	public void unsetTabIndex() {
		...
		tabIndexESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.PASSWORD_TYPE__TAB_INDEX, oldTabIndex, TAB_INDEX_EDEFAULT, oldTabIndexESet));
	}
	...
	public void setTabStop(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTabStop) {
		...
		tabStopESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__TAB_STOP, oldTabStop, tabStop, !oldTabStopESet));
	}
	...
	public void unsetTabStop() {
		...
		tabStopESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, FormPackage.PASSWORD_TYPE__TAB_STOP, oldTabStop, TAB_STOP_EDEFAULT, oldTabStopESet));
	}
	...
	public void setTitle(Object newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.PASSWORD_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.PASSWORD_TYPE__BIND:
				return getBind();
			case FormPackage.PASSWORD_TYPE__CONTROL_IMPLEMENTATION:
				return getControlImplementation();
			case FormPackage.PASSWORD_TYPE__CONVERT_EMPTY_TO_NULL:
				return getConvertEmptyToNull();
			case FormPackage.PASSWORD_TYPE__DISABLED:
				return getDisabled();
			case FormPackage.PASSWORD_TYPE__ECHO_CHAR:
				return getEchoChar();
			case FormPackage.PASSWORD_TYPE__ID:
				return getId();
			case FormPackage.PASSWORD_TYPE__MAX_LENGTH:
				return getMaxLength();
			case FormPackage.PASSWORD_TYPE__NAME:
				return getName();
			case FormPackage.PASSWORD_TYPE__PRINTABLE:
				return getPrintable();
			case FormPackage.PASSWORD_TYPE__TAB_INDEX:
				return getTabIndex();
			case FormPackage.PASSWORD_TYPE__TAB_STOP:
				return getTabStop();
			case FormPackage.PASSWORD_TYPE__TITLE:
				return getTitle();
			case FormPackage.PASSWORD_TYPE__VALUE:
				return getValue();
		}
	...
	public String toString() {
		...
		if (echoCharESet) result.append(echoChar); else result.append("<unset>");
		result.append(", id: ");
		result.append(id);

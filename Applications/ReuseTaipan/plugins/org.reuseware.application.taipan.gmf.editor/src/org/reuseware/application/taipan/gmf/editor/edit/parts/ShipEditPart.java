...
import org.reuseware.application.taipan.figures.ShipShape;
import org.reuseware.application.taipan.gmf.editor.edit.policies.ShipItemSemanticEditPolicy;
							...
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == TaiPanElementTypes.SmallItems_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(TaiPanVisualIDRegistry
											.getType(ShipSmallCargoEditPart.VISUAL_ID));

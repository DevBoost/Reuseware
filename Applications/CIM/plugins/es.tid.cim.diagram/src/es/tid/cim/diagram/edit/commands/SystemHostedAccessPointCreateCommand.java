 ...
 * @generated
 */
public class SystemHostedAccessPointCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SystemHostedAccessPointCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateSystemHostedAccessPoint_4020(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHostedAccessPoint().add(getTarget());
		}

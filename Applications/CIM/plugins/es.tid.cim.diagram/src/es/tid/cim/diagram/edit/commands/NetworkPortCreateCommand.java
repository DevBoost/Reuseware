 ...
 * @generated
 */
public class NetworkPortCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public NetworkPortCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		NetworkPort newElement = CimFactory.eINSTANCE.createNetworkPort();

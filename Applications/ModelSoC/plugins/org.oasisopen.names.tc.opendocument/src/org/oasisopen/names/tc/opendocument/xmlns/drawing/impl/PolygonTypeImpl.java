 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getEventListeners <em>Event Listeners</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getGluePoint <em>Glue Point</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getP <em>P</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getList <em>List</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getAnchorPageNumber <em>Anchor Page Number</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getAnchorType <em>Anchor Type</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getCaptionId <em>Caption Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getClassNames <em>Class Names</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getClassNames1 <em>Class Names1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getEndCellAddress <em>End Cell Address</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getEndX <em>End X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getEndY <em>End Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getStyleName <em>Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getStyleName1 <em>Style Name1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getTableBackground <em>Table Background</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getTextStyleName <em>Text Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getViewBox <em>View Box</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getX <em>X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getY <em>Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.PolygonTypeImpl#getZIndex <em>ZIndex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PolygonTypeImpl extends EObjectImpl implements PolygonType {
	/**
	...
	protected EClass eStaticClass() {
		return DrawingPackage.eINSTANCE.getPolygonType();
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__DESC, oldDesc, desc));
	}
	...
	public NotificationChain basicSetEventListeners(EventListenersType newEventListeners, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__EVENT_LISTENERS, oldEventListeners, newEventListeners);
	...
	public void setEventListeners(EventListenersType newEventListeners) {
		if (newEventListeners != eventListeners) {
			...
			if (eventListeners != null)
				msgs = ((InternalEObject)eventListeners).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.POLYGON_TYPE__EVENT_LISTENERS, null, msgs);
			if (newEventListeners != null)
				msgs = ((InternalEObject)newEventListeners).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.POLYGON_TYPE__EVENT_LISTENERS, null, msgs);
			msgs = basicSetEventListeners(newEventListeners, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__EVENT_LISTENERS, newEventListeners, newEventListeners));
	}
	...
	public EList<GluePointType> getGluePoint() {
		if (gluePoint == null) {
			gluePoint = new EObjectContainmentEList<GluePointType>(GluePointType.class, this, DrawingPackage.POLYGON_TYPE__GLUE_POINT);
		}
		return gluePoint;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, DrawingPackage.POLYGON_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<PType> getP() {
		return getGroup().list(DrawingPackage.eINSTANCE.getPolygonType_P());
	}
	...
	public EList<ListType> getList() {
		return getGroup().list(DrawingPackage.eINSTANCE.getPolygonType_List());
	}
	...
	public void setAnchorPageNumber(BigInteger newAnchorPageNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__ANCHOR_PAGE_NUMBER, oldAnchorPageNumber, anchorPageNumber));
	}
	...
	public void setAnchorType(AnchorTypeType newAnchorType) {
		...
		anchorTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__ANCHOR_TYPE, oldAnchorType, anchorType, !oldAnchorTypeESet));
	}
	...
	public void unsetAnchorType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.POLYGON_TYPE__ANCHOR_TYPE, oldAnchorType, ANCHOR_TYPE_EDEFAULT, oldAnchorTypeESet));
	}
	...
	public void setCaptionId(String newCaptionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__CAPTION_ID, oldCaptionId, captionId));
	}
	...
	public void setClassNames(List<String> newClassNames) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__CLASS_NAMES, oldClassNames, classNames));
	}
	...
	public void setClassNames1(List<String> newClassNames1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__CLASS_NAMES1, oldClassNames1, classNames1));
	}
	...
	public void setEndCellAddress(String newEndCellAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__END_CELL_ADDRESS, oldEndCellAddress, endCellAddress));
	}
	...
	public void setEndX(String newEndX) {
		...
		endX = newEndX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__END_X, oldEndX, endX));
	}
	...
	public void setEndY(String newEndY) {
		...
		endY = newEndY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__END_Y, oldEndY, endY));
	}
	...
	public void setHeight(String newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__HEIGHT, oldHeight, height));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__ID, oldId, id));
	}
	...
	public void setLayer(String newLayer) {
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__LAYER, oldLayer, layer));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__NAME, oldName, name));
	}
	...
	public void setPoints(String newPoints) {
		...
		points = newPoints;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__POINTS, oldPoints, points));
	}
	...
	public void setStyleName(String newStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__STYLE_NAME, oldStyleName, styleName));
	}
	...
	public void setStyleName1(String newStyleName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__STYLE_NAME1, oldStyleName1, styleName1));
	}
	...
	public void setTableBackground(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTableBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__TABLE_BACKGROUND, oldTableBackground, tableBackground, !oldTableBackgroundESet));
	}
	...
	public void unsetTableBackground() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.POLYGON_TYPE__TABLE_BACKGROUND, oldTableBackground, TABLE_BACKGROUND_EDEFAULT, oldTableBackgroundESet));
	}
	...
	public void setTextStyleName(String newTextStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__TEXT_STYLE_NAME, oldTextStyleName, textStyleName));
	}
	...
	public void setTransform(String newTransform) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__TRANSFORM, oldTransform, transform));
	}
	...
	public void setViewBox(List newViewBox) {
		...
		viewBox = newViewBox;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__VIEW_BOX, oldViewBox, viewBox));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__WIDTH, oldWidth, width));
	}
	...
	public void setX(String newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__X, oldX, x));
	}
	...
	public void setY(String newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__Y, oldY, y));
	}
	...
	public void setZIndex(BigInteger newZIndex) {
		...
		zIndex = newZIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.POLYGON_TYPE__ZINDEX, oldZIndex, zIndex));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DrawingPackage.POLYGON_TYPE__EVENT_LISTENERS:
				return basicSetEventListeners(null, msgs);
			case DrawingPackage.POLYGON_TYPE__GLUE_POINT:
				return ((InternalEList<?>)getGluePoint()).basicRemove(otherEnd, msgs);
			case DrawingPackage.POLYGON_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case DrawingPackage.POLYGON_TYPE__P:
				return ((InternalEList<?>)getP()).basicRemove(otherEnd, msgs);
			case DrawingPackage.POLYGON_TYPE__LIST:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DrawingPackage.POLYGON_TYPE__TITLE:
				return getTitle();
			case DrawingPackage.POLYGON_TYPE__DESC:
				return getDesc();
			case DrawingPackage.POLYGON_TYPE__EVENT_LISTENERS:
			...
			case DrawingPackage.POLYGON_TYPE__LIST:
				return getList();
			case DrawingPackage.POLYGON_TYPE__ANCHOR_PAGE_NUMBER:
				return getAnchorPageNumber();
			case DrawingPackage.POLYGON_TYPE__ANCHOR_TYPE:
				return getAnchorType();
			case DrawingPackage.POLYGON_TYPE__CAPTION_ID:
				return getCaptionId();
			case DrawingPackage.POLYGON_TYPE__CLASS_NAMES:
				return getClassNames();
			case DrawingPackage.POLYGON_TYPE__CLASS_NAMES1:
				return getClassNames1();
			case DrawingPackage.POLYGON_TYPE__END_CELL_ADDRESS:
				return getEndCellAddress();
			case DrawingPackage.POLYGON_TYPE__END_X:
				return getEndX();
			case DrawingPackage.POLYGON_TYPE__END_Y:
				return getEndY();
			case DrawingPackage.POLYGON_TYPE__HEIGHT:
				return getHeight();
			case DrawingPackage.POLYGON_TYPE__ID:
				return getId();
			case DrawingPackage.POLYGON_TYPE__LAYER:
				return getLayer();
			case DrawingPackage.POLYGON_TYPE__NAME:
				return getName();
			case DrawingPackage.POLYGON_TYPE__POINTS:
				return getPoints();
			case DrawingPackage.POLYGON_TYPE__STYLE_NAME:
				return getStyleName();
			case DrawingPackage.POLYGON_TYPE__STYLE_NAME1:
				return getStyleName1();
			case DrawingPackage.POLYGON_TYPE__TABLE_BACKGROUND:
				return getTableBackground();
			case DrawingPackage.POLYGON_TYPE__TEXT_STYLE_NAME:
				return getTextStyleName();
			case DrawingPackage.POLYGON_TYPE__TRANSFORM:
				return getTransform();
			case DrawingPackage.POLYGON_TYPE__VIEW_BOX:
				return getViewBox();
			case DrawingPackage.POLYGON_TYPE__WIDTH:
				return getWidth();
			case DrawingPackage.POLYGON_TYPE__X:
				return getX();
			case DrawingPackage.POLYGON_TYPE__Y:
				return getY();
			case DrawingPackage.POLYGON_TYPE__ZINDEX:
				return getZIndex();
		}

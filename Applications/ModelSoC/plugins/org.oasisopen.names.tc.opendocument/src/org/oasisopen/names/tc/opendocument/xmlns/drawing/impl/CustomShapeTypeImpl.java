...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Custom Shape Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getEventListeners <em>Event Listeners</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getGluePoint <em>Glue Point</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getP <em>P</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getList <em>List</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getEnhancedGeometry <em>Enhanced Geometry</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getAnchorPageNumber <em>Anchor Page Number</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getAnchorType <em>Anchor Type</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getCaptionId <em>Caption Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getClassNames <em>Class Names</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getClassNames1 <em>Class Names1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getData <em>Data</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getEndCellAddress <em>End Cell Address</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getEndX <em>End X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getEndY <em>End Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getEngine <em>Engine</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getStyleName <em>Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getStyleName1 <em>Style Name1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getTableBackground <em>Table Background</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getTextStyleName <em>Text Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getX <em>X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getY <em>Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.CustomShapeTypeImpl#getZIndex <em>ZIndex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CustomShapeTypeImpl extends EObjectImpl implements CustomShapeType {
	/**
	...
	/**
	 * The cached value of the '{@link #getEnhancedGeometry() <em>Enhanced Geometry</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected EnhancedGeometryType enhancedGeometry;
	...
	protected EClass eStaticClass() {
		return DrawingPackage.eINSTANCE.getCustomShapeType();
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__DESC, oldDesc, desc));
	}
	...
	public NotificationChain basicSetEventListeners(EventListenersType newEventListeners, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__EVENT_LISTENERS, oldEventListeners, newEventListeners);
	...
	public void setEventListeners(EventListenersType newEventListeners) {
		if (newEventListeners != eventListeners) {
			...
			if (eventListeners != null)
				msgs = ((InternalEObject)eventListeners).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.CUSTOM_SHAPE_TYPE__EVENT_LISTENERS, null, msgs);
			if (newEventListeners != null)
				msgs = ((InternalEObject)newEventListeners).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.CUSTOM_SHAPE_TYPE__EVENT_LISTENERS, null, msgs);
			msgs = basicSetEventListeners(newEventListeners, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__EVENT_LISTENERS, newEventListeners, newEventListeners));
	}
	...
	public EList<GluePointType> getGluePoint() {
		if (gluePoint == null) {
			gluePoint = new EObjectContainmentEList<GluePointType>(GluePointType.class, this, DrawingPackage.CUSTOM_SHAPE_TYPE__GLUE_POINT);
		}
		return gluePoint;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, DrawingPackage.CUSTOM_SHAPE_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<PType> getP() {
		return getGroup().list(DrawingPackage.eINSTANCE.getCustomShapeType_P());
	}
	...
	public EList<ListType> getList() {
		return getGroup().list(DrawingPackage.eINSTANCE.getCustomShapeType_List());
	}
	...
	public NotificationChain basicSetEnhancedGeometry(EnhancedGeometryType newEnhancedGeometry, NotificationChain msgs) {
		EnhancedGeometryType oldEnhancedGeometry = enhancedGeometry;
		enhancedGeometry = newEnhancedGeometry;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__ENHANCED_GEOMETRY, oldEnhancedGeometry, newEnhancedGeometry);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setEnhancedGeometry(EnhancedGeometryType newEnhancedGeometry) {
		if (newEnhancedGeometry != enhancedGeometry) {
			NotificationChain msgs = null;
			if (enhancedGeometry != null)
				msgs = ((InternalEObject)enhancedGeometry).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.CUSTOM_SHAPE_TYPE__ENHANCED_GEOMETRY, null, msgs);
			if (newEnhancedGeometry != null)
				msgs = ((InternalEObject)newEnhancedGeometry).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DrawingPackage.CUSTOM_SHAPE_TYPE__ENHANCED_GEOMETRY, null, msgs);
			msgs = basicSetEnhancedGeometry(newEnhancedGeometry, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__ENHANCED_GEOMETRY, newEnhancedGeometry, newEnhancedGeometry));
	}
	...
	public void setAnchorPageNumber(BigInteger newAnchorPageNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__ANCHOR_PAGE_NUMBER, oldAnchorPageNumber, anchorPageNumber));
	}
	...
	public void setAnchorType(AnchorTypeType newAnchorType) {
		...
		anchorTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__ANCHOR_TYPE, oldAnchorType, anchorType, !oldAnchorTypeESet));
	}
	...
	public void unsetAnchorType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.CUSTOM_SHAPE_TYPE__ANCHOR_TYPE, oldAnchorType, ANCHOR_TYPE_EDEFAULT, oldAnchorTypeESet));
	}
	...
	public void setCaptionId(String newCaptionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__CAPTION_ID, oldCaptionId, captionId));
	}
	...
	public void setClassNames(List<String> newClassNames) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__CLASS_NAMES, oldClassNames, classNames));
	}
	...
	public void setClassNames1(List<String> newClassNames1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__CLASS_NAMES1, oldClassNames1, classNames1));
	}
	...
	public void setData(String newData) {
		...
		data = newData;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__DATA, oldData, data));
	}
	...
	public void setEndCellAddress(String newEndCellAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__END_CELL_ADDRESS, oldEndCellAddress, endCellAddress));
	}
	...
	public void setEndX(String newEndX) {
		...
		endX = newEndX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__END_X, oldEndX, endX));
	}
	...
	public void setEndY(String newEndY) {
		...
		endY = newEndY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__END_Y, oldEndY, endY));
	}
	...
	public void setEngine(String newEngine) {
		...
		engine = newEngine;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__ENGINE, oldEngine, engine));
	}
	...
	public void setHeight(String newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__HEIGHT, oldHeight, height));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__ID, oldId, id));
	}
	...
	public void setLayer(String newLayer) {
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__LAYER, oldLayer, layer));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__NAME, oldName, name));
	}
	...
	public void setStyleName(String newStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__STYLE_NAME, oldStyleName, styleName));
	}
	...
	public void setStyleName1(String newStyleName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__STYLE_NAME1, oldStyleName1, styleName1));
	}
	...
	public void setTableBackground(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTableBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__TABLE_BACKGROUND, oldTableBackground, tableBackground, !oldTableBackgroundESet));
	}
	...
	public void unsetTableBackground() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.CUSTOM_SHAPE_TYPE__TABLE_BACKGROUND, oldTableBackground, TABLE_BACKGROUND_EDEFAULT, oldTableBackgroundESet));
	}
	...
	public void setTextStyleName(String newTextStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__TEXT_STYLE_NAME, oldTextStyleName, textStyleName));
	}
	...
	public void setTransform(String newTransform) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__TRANSFORM, oldTransform, transform));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__WIDTH, oldWidth, width));
	}
	...
	public void setX(String newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__X, oldX, x));
	}
	...
	public void setY(String newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__Y, oldY, y));
	}
	...
	public void setZIndex(BigInteger newZIndex) {
		...
		zIndex = newZIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CUSTOM_SHAPE_TYPE__ZINDEX, oldZIndex, zIndex));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DrawingPackage.CUSTOM_SHAPE_TYPE__EVENT_LISTENERS:
				return basicSetEventListeners(null, msgs);
			case DrawingPackage.CUSTOM_SHAPE_TYPE__GLUE_POINT:
				return ((InternalEList<?>)getGluePoint()).basicRemove(otherEnd, msgs);
			case DrawingPackage.CUSTOM_SHAPE_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case DrawingPackage.CUSTOM_SHAPE_TYPE__P:
				return ((InternalEList<?>)getP()).basicRemove(otherEnd, msgs);
			case DrawingPackage.CUSTOM_SHAPE_TYPE__LIST:
				return ((InternalEList<?>)getList()).basicRemove(otherEnd, msgs);
			case DrawingPackage.CUSTOM_SHAPE_TYPE__ENHANCED_GEOMETRY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DrawingPackage.CUSTOM_SHAPE_TYPE__TITLE:
				return getTitle();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__DESC:
				return getDesc();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__EVENT_LISTENERS:
			...
			case DrawingPackage.CUSTOM_SHAPE_TYPE__ANCHOR_PAGE_NUMBER:
				return getAnchorPageNumber();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__ANCHOR_TYPE:
				return getAnchorType();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__CAPTION_ID:
				return getCaptionId();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__CLASS_NAMES:
				return getClassNames();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__CLASS_NAMES1:
				return getClassNames1();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__DATA:
				return getData();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__END_CELL_ADDRESS:
				return getEndCellAddress();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__END_X:
				return getEndX();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__END_Y:
				return getEndY();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__ENGINE:
				return getEngine();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__HEIGHT:
				return getHeight();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__ID:
				return getId();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__LAYER:
				return getLayer();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__NAME:
				return getName();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__STYLE_NAME:
				return getStyleName();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__STYLE_NAME1:
				return getStyleName1();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__TABLE_BACKGROUND:
				return getTableBackground();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__TEXT_STYLE_NAME:
				return getTextStyleName();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__TRANSFORM:
				return getTransform();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__WIDTH:
				return getWidth();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__X:
				return getX();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__Y:
				return getY();
			case DrawingPackage.CUSTOM_SHAPE_TYPE__ZINDEX:
				return getZIndex();
		}

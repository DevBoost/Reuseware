...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>User Field Decl Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getCurrency <em>Currency</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getDateValue <em>Date Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getFormula <em>Formula</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getTimeValue <em>Time Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.UserFieldDeclTypeImpl#getValueType <em>Value Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UserFieldDeclTypeImpl extends EObjectImpl implements UserFieldDeclType {
	/**
	 ...
	 * @generated
	 */
	protected UserFieldDeclTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getUserFieldDeclType();
	}
	...
	public void setBooleanValue(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newBooleanValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__BOOLEAN_VALUE, oldBooleanValue, booleanValue, !oldBooleanValueESet));
	}
	...
	public void unsetBooleanValue() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.USER_FIELD_DECL_TYPE__BOOLEAN_VALUE, oldBooleanValue, BOOLEAN_VALUE_EDEFAULT, oldBooleanValueESet));
	}
	...
	public void setCurrency(String newCurrency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__CURRENCY, oldCurrency, currency));
	}
	...
	public void setDateValue(XMLGregorianCalendar newDateValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__DATE_VALUE, oldDateValue, dateValue));
	}
	...
	public void setFormula(String newFormula) {
		...
		formula = newFormula;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__FORMULA, oldFormula, formula));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__NAME, oldName, name));
	}
	...
	public void setStringValue(String newStringValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__STRING_VALUE, oldStringValue, stringValue));
	}
	...
	public void setTimeValue(Duration newTimeValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__TIME_VALUE, oldTimeValue, timeValue));
	}
	...
	public void setValue(double newValue) {
		...
		valueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.USER_FIELD_DECL_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setValueType(ValueTypeType1 newValueType) {
		...
		valueTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.USER_FIELD_DECL_TYPE__VALUE_TYPE, oldValueType, valueType, !oldValueTypeESet));
	}
	...
	public void unsetValueType() {
		...
		valueTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.USER_FIELD_DECL_TYPE__VALUE_TYPE, oldValueType, VALUE_TYPE_EDEFAULT, oldValueTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TextPackage.USER_FIELD_DECL_TYPE__BOOLEAN_VALUE:
				return getBooleanValue();
			case TextPackage.USER_FIELD_DECL_TYPE__CURRENCY:
				return getCurrency();
			case TextPackage.USER_FIELD_DECL_TYPE__DATE_VALUE:
				return getDateValue();
			case TextPackage.USER_FIELD_DECL_TYPE__FORMULA:
				return getFormula();
			case TextPackage.USER_FIELD_DECL_TYPE__NAME:
				return getName();
			case TextPackage.USER_FIELD_DECL_TYPE__STRING_VALUE:
				return getStringValue();
			case TextPackage.USER_FIELD_DECL_TYPE__TIME_VALUE:
				return getTimeValue();
			case TextPackage.USER_FIELD_DECL_TYPE__VALUE:
				return new Double(getValue());
			case TextPackage.USER_FIELD_DECL_TYPE__VALUE_TYPE:
				return getValueType();
		}

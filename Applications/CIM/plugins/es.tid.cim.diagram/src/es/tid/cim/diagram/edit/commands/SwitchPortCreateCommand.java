 ...
 * @generated
 */
public class SwitchPortCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public SwitchPortCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		SwitchPort newElement = CimFactory.eINSTANCE.createSwitchPort();

 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getDesc <em>Desc</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getGluePoint <em>Glue Point</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getAnchorPageNumber <em>Anchor Page Number</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getAnchorType <em>Anchor Type</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getCaptionId <em>Caption Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getClassNames <em>Class Names</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getClassNames1 <em>Class Names1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getControl <em>Control</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getEndCellAddress <em>End Cell Address</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getEndX <em>End X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getEndY <em>End Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getLayer <em>Layer</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getStyleName <em>Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getStyleName1 <em>Style Name1</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getTableBackground <em>Table Background</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getTextStyleName <em>Text Style Name</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getTransform <em>Transform</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getX <em>X</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getY <em>Y</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ControlTypeImpl#getZIndex <em>ZIndex</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ControlTypeImpl extends EObjectImpl implements ControlType {
	/**
	...
	protected EClass eStaticClass() {
		return DrawingPackage.eINSTANCE.getControlType();
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setDesc(String newDesc) {
		...
		desc = newDesc;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__DESC, oldDesc, desc));
	}
	...
	public EList<GluePointType> getGluePoint() {
		if (gluePoint == null) {
			gluePoint = new EObjectContainmentEList<GluePointType>(GluePointType.class, this, DrawingPackage.CONTROL_TYPE__GLUE_POINT);
		}
		return gluePoint;
	}
	...
	public void setAnchorPageNumber(BigInteger newAnchorPageNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__ANCHOR_PAGE_NUMBER, oldAnchorPageNumber, anchorPageNumber));
	}
	...
	public void setAnchorType(AnchorTypeType newAnchorType) {
		...
		anchorTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__ANCHOR_TYPE, oldAnchorType, anchorType, !oldAnchorTypeESet));
	}
	...
	public void unsetAnchorType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.CONTROL_TYPE__ANCHOR_TYPE, oldAnchorType, ANCHOR_TYPE_EDEFAULT, oldAnchorTypeESet));
	}
	...
	public void setCaptionId(String newCaptionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__CAPTION_ID, oldCaptionId, captionId));
	}
	...
	public void setClassNames(List<String> newClassNames) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__CLASS_NAMES, oldClassNames, classNames));
	}
	...
	public void setClassNames1(List<String> newClassNames1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__CLASS_NAMES1, oldClassNames1, classNames1));
	}
	...
	public void setControl(String newControl) {
		...
		control = newControl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__CONTROL, oldControl, control));
	}
	...
	public void setEndCellAddress(String newEndCellAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__END_CELL_ADDRESS, oldEndCellAddress, endCellAddress));
	}
	...
	public void setEndX(String newEndX) {
		...
		endX = newEndX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__END_X, oldEndX, endX));
	}
	...
	public void setEndY(String newEndY) {
		...
		endY = newEndY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__END_Y, oldEndY, endY));
	}
	...
	public void setHeight(String newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__HEIGHT, oldHeight, height));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__ID, oldId, id));
	}
	...
	public void setLayer(String newLayer) {
		...
		layer = newLayer;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__LAYER, oldLayer, layer));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__NAME, oldName, name));
	}
	...
	public void setStyleName(String newStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__STYLE_NAME, oldStyleName, styleName));
	}
	...
	public void setStyleName1(String newStyleName1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__STYLE_NAME1, oldStyleName1, styleName1));
	}
	...
	public void setTableBackground(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newTableBackground) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__TABLE_BACKGROUND, oldTableBackground, tableBackground, !oldTableBackgroundESet));
	}
	...
	public void unsetTableBackground() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.CONTROL_TYPE__TABLE_BACKGROUND, oldTableBackground, TABLE_BACKGROUND_EDEFAULT, oldTableBackgroundESet));
	}
	...
	public void setTextStyleName(String newTextStyleName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__TEXT_STYLE_NAME, oldTextStyleName, textStyleName));
	}
	...
	public void setTransform(String newTransform) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__TRANSFORM, oldTransform, transform));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__WIDTH, oldWidth, width));
	}
	...
	public void setX(String newX) {
		...
		x = newX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__X, oldX, x));
	}
	...
	public void setY(String newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__Y, oldY, y));
	}
	...
	public void setZIndex(BigInteger newZIndex) {
		...
		zIndex = newZIndex;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTROL_TYPE__ZINDEX, oldZIndex, zIndex));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DrawingPackage.CONTROL_TYPE__GLUE_POINT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DrawingPackage.CONTROL_TYPE__TITLE:
				return getTitle();
			case DrawingPackage.CONTROL_TYPE__DESC:
				return getDesc();
			case DrawingPackage.CONTROL_TYPE__GLUE_POINT:
				return getGluePoint();
			case DrawingPackage.CONTROL_TYPE__ANCHOR_PAGE_NUMBER:
				return getAnchorPageNumber();
			case DrawingPackage.CONTROL_TYPE__ANCHOR_TYPE:
				return getAnchorType();
			case DrawingPackage.CONTROL_TYPE__CAPTION_ID:
				return getCaptionId();
			case DrawingPackage.CONTROL_TYPE__CLASS_NAMES:
				return getClassNames();
			case DrawingPackage.CONTROL_TYPE__CLASS_NAMES1:
				return getClassNames1();
			case DrawingPackage.CONTROL_TYPE__CONTROL:
				return getControl();
			case DrawingPackage.CONTROL_TYPE__END_CELL_ADDRESS:
				return getEndCellAddress();
			case DrawingPackage.CONTROL_TYPE__END_X:
				return getEndX();
			case DrawingPackage.CONTROL_TYPE__END_Y:
				return getEndY();
			case DrawingPackage.CONTROL_TYPE__HEIGHT:
				return getHeight();
			case DrawingPackage.CONTROL_TYPE__ID:
				return getId();
			case DrawingPackage.CONTROL_TYPE__LAYER:
				return getLayer();
			case DrawingPackage.CONTROL_TYPE__NAME:
				return getName();
			case DrawingPackage.CONTROL_TYPE__STYLE_NAME:
				return getStyleName();
			case DrawingPackage.CONTROL_TYPE__STYLE_NAME1:
				return getStyleName1();
			case DrawingPackage.CONTROL_TYPE__TABLE_BACKGROUND:
				return getTableBackground();
			case DrawingPackage.CONTROL_TYPE__TEXT_STYLE_NAME:
				return getTextStyleName();
			case DrawingPackage.CONTROL_TYPE__TRANSFORM:
				return getTransform();
			case DrawingPackage.CONTROL_TYPE__WIDTH:
				return getWidth();
			case DrawingPackage.CONTROL_TYPE__X:
				return getX();
			case DrawingPackage.CONTROL_TYPE__Y:
				return getY();
			case DrawingPackage.CONTROL_TYPE__ZINDEX:
				return getZIndex();
		}

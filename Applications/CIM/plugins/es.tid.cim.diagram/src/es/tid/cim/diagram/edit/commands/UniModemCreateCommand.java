 ...
 * @generated
 */
public class UniModemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public UniModemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		UniModem newElement = CimFactory.eINSTANCE.createUniModem();

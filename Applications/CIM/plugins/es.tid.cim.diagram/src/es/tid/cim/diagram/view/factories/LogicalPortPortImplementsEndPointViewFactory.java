 ...
 * @generated
 */
public class LogicalPortPortImplementsEndPointViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(LogicalPortPortImplementsEndPointEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel154EditPart.VISUAL_ID),

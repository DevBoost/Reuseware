...
/**
 * This is the item provider adapter for a {@link org.reuseware.application.taipan.LargeItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LargeItemItemProvider extends ItemItemProvider implements
	...
	protected void addWeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_LargeItem_weight_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_LargeItem_weight_feature", "_UI_LargeItem_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						TaiPanPackage.Literals.LARGE_ITEM__WEIGHT, true, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/LargeItem")); //$NON-NLS-1$
	}

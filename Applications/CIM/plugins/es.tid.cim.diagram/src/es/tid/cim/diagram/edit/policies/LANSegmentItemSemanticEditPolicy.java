...
import es.tid.cim.diagram.edit.commands.LANSegmentInSegmentCreateCommand;
import es.tid.cim.diagram.edit.commands.LANSegmentInSegmentReorientCommand;
 ...
 * @generated
 */
public class LANSegmentItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.LANSegmentInSegment_4057 == req
				.getElementType()) {
			return getGEFWrapper(new LANSegmentInSegmentCreateCommand(req, req
					.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case LANSegmentInSegmentEditPart.VISUAL_ID:
			return getGEFWrapper(new LANSegmentInSegmentReorientCommand(req));

 ...
 * @generated
 */
public class NetworkCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public NetworkCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		Network newElement = CimFactory.eINSTANCE.createNetwork();

 ...
 * <!-- end-user-doc -->
 * @see org.oasisopen.names.tc.opendocument.xmlns.table.TablePackage#getModeType()
...
public enum ModeType implements Enumerator {
	 ...
	 * @ordered
	 */
	COPY_ALL(0, "copyAll", "copy-all"),

	/**
	 * The '<em><b>Copy Results Only</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #COPY_RESULTS_ONLY_VALUE
	 * @generated
	 * @ordered
	 */
	COPY_RESULTS_ONLY(1, "copyResultsOnly", "copy-results-only");

	/**
	 * The '<em><b>Copy All</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Copy All</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #COPY_ALL
	 * @model name="copyAll" literal="copy-all"
	 * @generated
	 * @ordered
	 */
	public static final int COPY_ALL_VALUE = 0;

	/**
	 * The '<em><b>Copy Results Only</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Copy Results Only</b></em>' literal object isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @see #COPY_RESULTS_ONLY
	 * @model name="copyResultsOnly" literal="copy-results-only"
	 * @generated
	 * @ordered
	 */
	public static final int COPY_RESULTS_ONLY_VALUE = 1;
	...
	public static ModeType get(int value) {
		switch (value) {
			...
			case COPY_RESULTS_ONLY_VALUE: return COPY_RESULTS_ONLY;
		}
		return null;
	}

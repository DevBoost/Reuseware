 ...
 * @generated
 */
public class NATServiceNATServiceRunningOnEndpointViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(NATServiceNATServiceRunningOnEndpointEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel152EditPart.VISUAL_ID),

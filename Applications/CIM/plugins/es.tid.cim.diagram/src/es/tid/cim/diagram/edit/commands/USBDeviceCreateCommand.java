 ...
 * @generated
 */
public class USBDeviceCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public USBDeviceCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		USBDevice newElement = CimFactory.eINSTANCE.createUSBDevice();

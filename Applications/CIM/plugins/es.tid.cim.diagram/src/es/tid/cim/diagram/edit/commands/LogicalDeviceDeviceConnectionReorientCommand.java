 ...
 * @generated
 */
public class LogicalDeviceDeviceConnectionReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public LogicalDeviceDeviceConnectionReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLogicalDeviceDeviceConnection_4014(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLogicalDeviceDeviceConnection_4014(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getDeviceConnection().remove(getOldTarget());
		getNewSource().getDeviceConnection().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getDeviceConnection().remove(getOldTarget());
		getOldSource().getDeviceConnection().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

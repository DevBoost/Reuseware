...
import es.tid.cim.diagram.edit.commands.SoftwareIdentityElementSoftwareIdentityCreateCommand;
import es.tid.cim.diagram.edit.commands.SoftwareIdentityElementSoftwareIdentityReorientCommand;
 ...
 * @generated
 */
public class SoftwareIdentityItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.SoftwareIdentityElementSoftwareIdentity_4019 == req
				.getElementType()) {
			return getGEFWrapper(new SoftwareIdentityElementSoftwareIdentityCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case SoftwareIdentityElementSoftwareIdentityEditPart.VISUAL_ID:
			return getGEFWrapper(new SoftwareIdentityElementSoftwareIdentityReorientCommand(
					req));

 ...
 * @generated
 */
public class ProductProductServiceComponentCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ProductProductServiceComponentCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateProductProductServiceComponent_4026(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getProductServiceComponent().add(getTarget());
		}

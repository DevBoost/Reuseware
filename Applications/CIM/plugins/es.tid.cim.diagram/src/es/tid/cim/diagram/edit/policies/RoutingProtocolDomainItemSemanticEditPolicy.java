...
import es.tid.cim.diagram.edit.commands.AutonomousSystemRoutingProtocolDomainInASCreateCommand;
import es.tid.cim.diagram.edit.commands.AutonomousSystemRoutingProtocolDomainInASReorientCommand;
 ...
 * @generated
 */
public class RoutingProtocolDomainItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.AdminDomainContainedDomain_4012 == req
				.getElementType()) {
			return getGEFWrapper(new AdminDomainContainedDomainCreateCommand(
		...
		if (CIMLevelZeroElementTypes.AdminDomainNetworksInAdminDomain_4059 == req
				.getElementType()) {
			return getGEFWrapper(new AdminDomainNetworksInAdminDomainCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.AutonomousSystemRoutingProtocolDomainInAS_4066 == req
				.getElementType()) {
			return null;
		}
		return null;
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.AutonomousSystemRoutingProtocolDomainInAS_4066 == req
				.getElementType()) {
			return getGEFWrapper(new AutonomousSystemRoutingProtocolDomainInASCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case AdminDomainContainedDomainEditPart.VISUAL_ID:
			return getGEFWrapper(new AdminDomainContainedDomainReorientCommand(
					req));
		...
		case AdminDomainNetworksInAdminDomainEditPart.VISUAL_ID:
			return getGEFWrapper(new AdminDomainNetworksInAdminDomainReorientCommand(
					req));
		case AutonomousSystemRoutingProtocolDomainInASEditPart.VISUAL_ID:
			return getGEFWrapper(new AutonomousSystemRoutingProtocolDomainInASReorientCommand(
					req));
		}

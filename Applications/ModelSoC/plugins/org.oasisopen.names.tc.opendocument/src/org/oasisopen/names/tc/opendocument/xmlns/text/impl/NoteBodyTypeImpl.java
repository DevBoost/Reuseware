...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Note Body Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getTextContent <em>Text Content</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getH <em>H</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getP <em>P</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getList <em>List</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getNumberedParagraph <em>Numbered Paragraph</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getTable <em>Table</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getA <em>A</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getSection <em>Section</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getSoftPageBreak <em>Soft Page Break</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getTableOfContent <em>Table Of Content</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getIllustrationIndex <em>Illustration Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getTableIndex <em>Table Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getObjectIndex <em>Object Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getUserIndex <em>User Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getAlphabeticalIndex <em>Alphabetical Index</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getBibliography <em>Bibliography</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getRect <em>Rect</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getLine <em>Line</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getPolyline <em>Polyline</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getPolygon <em>Polygon</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getRegularPolygon <em>Regular Polygon</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getPath <em>Path</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getCircle <em>Circle</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getEllipse <em>Ellipse</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getG <em>G</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getPageThumbnail <em>Page Thumbnail</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getFrame <em>Frame</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getMeasure <em>Measure</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getCaption <em>Caption</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getConnector <em>Connector</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getControl <em>Control</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getScene <em>Scene</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getCustomShape <em>Custom Shape</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getChangeMarksGroup <em>Change Marks Group</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.NoteBodyTypeImpl#getChangeMarks <em>Change Marks</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NoteBodyTypeImpl extends EObjectImpl implements NoteBodyType {
	/**
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getNoteBodyType();
	}
	...
	public FeatureMap getTextContent() {
		if (textContent == null) {
			textContent = new BasicFeatureMap(this, TextPackage.NOTE_BODY_TYPE__TEXT_CONTENT);
		}
		return textContent;
	}
	...
	public EList<HType> getH() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_H());
	}
	...
	public EList<PType> getP() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_P());
	}
	...
	public EList<ListType> getList() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_List());
	}
	...
	public EList<NumberedParagraphType> getNumberedParagraph() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_NumberedParagraph());
	}
	...
	public EList<TableType> getTable() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Table());
	}
	...
	public EList<AType> getA() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_A());
	}
	...
	public EList<SectionType> getSection() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Section());
	}
	...
	public EList<SoftPageBreakType> getSoftPageBreak() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_SoftPageBreak());
	}
	...
	public EList<TableOfContentType> getTableOfContent() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_TableOfContent());
	}
	...
	public EList<IllustrationIndexType> getIllustrationIndex() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_IllustrationIndex());
	}
	...
	public EList<TableIndexType> getTableIndex() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_TableIndex());
	}
	...
	public EList<ObjectIndexType> getObjectIndex() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_ObjectIndex());
	}
	...
	public EList<UserIndexType> getUserIndex() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_UserIndex());
	}
	...
	public EList<AlphabeticalIndexType> getAlphabeticalIndex() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_AlphabeticalIndex());
	}
	...
	public EList<BibliographyType> getBibliography() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Bibliography());
	}
	...
	public EList<RectType> getRect() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Rect());
	}
	...
	public EList<LineType> getLine() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Line());
	}
	...
	public EList<PolylineType> getPolyline() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Polyline());
	}
	...
	public EList<PolygonType> getPolygon() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Polygon());
	}
	...
	public EList<RegularPolygonType> getRegularPolygon() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_RegularPolygon());
	}
	...
	public EList<PathType> getPath() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Path());
	}
	...
	public EList<CircleType> getCircle() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Circle());
	}
	...
	public EList<EllipseType> getEllipse() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Ellipse());
	}
	...
	public EList<GType> getG() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_G());
	}
	...
	public EList<PageThumbnailType> getPageThumbnail() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_PageThumbnail());
	}
	...
	public EList<FrameType> getFrame() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Frame());
	}
	...
	public EList<MeasureType> getMeasure() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Measure());
	}
	...
	public EList<CaptionType> getCaption() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Caption());
	}
	...
	public EList<ConnectorType> getConnector() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Connector());
	}
	...
	public EList<ControlType> getControl() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Control());
	}
	...
	public EList<SceneType> getScene() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_Scene());
	}
	...
	public EList<CustomShapeType> getCustomShape() {
		return getTextContent().list(TextPackage.eINSTANCE.getNoteBodyType_CustomShape());
	}
	...
	public FeatureMap getChangeMarksGroup() {
		return (FeatureMap)getTextContent().<FeatureMap.Entry>list(TextPackage.eINSTANCE.getNoteBodyType_ChangeMarksGroup());
	}
	...
	public EList<ChangeMarksType> getChangeMarks() {
		return getChangeMarksGroup().list(TextPackage.eINSTANCE.getNoteBodyType_ChangeMarks());
	}

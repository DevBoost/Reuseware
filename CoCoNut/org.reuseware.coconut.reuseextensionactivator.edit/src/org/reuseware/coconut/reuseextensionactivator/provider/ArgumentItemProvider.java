...
/**
 * This is the item provider adapter for a {@link org.reuseware.coconut.reuseextensionactivator.Argument} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArgumentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReuseextensionactivatorPackage.Literals.ARGUMENT__PARAMETER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ReuseextensionactivatorPackage.Literals.ARGUMENT__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Argument)object).getParameter();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Argument.class)) {
			case ReuseextensionactivatorPackage.ARGUMENT__PARAMETER:
			case ReuseextensionactivatorPackage.ARGUMENT__VALUE:

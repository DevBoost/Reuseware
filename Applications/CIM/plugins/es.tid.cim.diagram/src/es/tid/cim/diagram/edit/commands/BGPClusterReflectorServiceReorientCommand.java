 ...
 * @generated
 */
public class BGPClusterReflectorServiceReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public BGPClusterReflectorServiceReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBGPClusterReflectorService_4009(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistBGPClusterReflectorService_4009(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getReflectorService().remove(getOldTarget());
		getNewSource().getReflectorService().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getReflectorService().remove(getOldTarget());
		getOldSource().getReflectorService().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

 ...
 * <ul>
 *   <li>{@link org.reuseware.sokan.ui.model.sokanui.impl.IdentifiableElementImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class IdentifiableElementImpl extends EObjectImpl implements IdentifiableElement {
	...
	public EList<String> getId() {
		if (id == null) {
			id = new EDataTypeEList<String>(String.class, this, SokanuiPackage.IDENTIFIABLE_ELEMENT__ID);
		}
		return id;
	}

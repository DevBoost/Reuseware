 ...
 * @generated
 */
public class LANSegmentCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public LANSegmentCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		LANSegment newElement = CimFactory.eINSTANCE.createLANSegment();

 ...
 * <ul>
 *   <li>{@link org.reuseware.application.taipan.impl.PortImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link org.reuseware.application.taipan.impl.PortImpl#getBuildings <em>Buildings</em>}</li>
 *   <li>{@link org.reuseware.application.taipan.impl.PortImpl#getRegister <em>Register</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PortImpl extends DestinationTypeImpl implements Port {
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaiPanPackage.PORT__LOCATION, oldLocation, location));
	}
	...
	public EList<Building> getBuildings() {
		if (buildings == null) {
			buildings = new EObjectContainmentEList<Building>(Building.class,
					this, TaiPanPackage.PORT__BUILDINGS);
		}
		return buildings;
	}
	...
	public EList<Ship> getRegister() {
		if (register == null) {
			register = new EObjectResolvingEList<Ship>(Ship.class, this,
					TaiPanPackage.PORT__REGISTER);
		}
		return register;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TaiPanPackage.PORT__BUILDINGS:
			return ((InternalEList<?>) getBuildings()).basicRemove(otherEnd,
					msgs);
		}

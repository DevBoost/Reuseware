 ...
 * @generated
 */
public class UnreliableRouteViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = TaiPanVisualIDRegistry
					.getType(UnreliableRouteEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				view,
				TaiPanVisualIDRegistry
						.getType(UnreliableRouteRelbEditPart.VISUAL_ID),
				ViewUtil.APPEND, true, getPreferencesHint());
	}
}

 ...
 * <ul>
 *   <li>{@link org.reuseware.application.taipan.impl.BesiegePortOrderImpl#getPort <em>Port</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BesiegePortOrderImpl extends EObjectImpl implements
		BesiegePortOrder {
	...
	public PortType getPort() {
		if (port != null && port.eIsProxy()) {
			...
			port = (PortType) eResolveProxy(oldPort);
			if (port != oldPort) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TaiPanPackage.BESIEGE_PORT_ORDER__PORT, oldPort,
							port));
			}
		}
		return port;
	...
	public void setPort(PortType newPort) {
		PortType oldPort = port;
		port = newPort;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaiPanPackage.BESIEGE_PORT_ORDER__PORT, oldPort, port));
	}

 ...
 */
public class AsHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public AsHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor) {
					org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor emftEditor = (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor) editorPart;

 ...
 * @generated
 */
public class IPXNetworkCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public IPXNetworkCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		IPXNetwork newElement = CimFactory.eINSTANCE.createIPXNetwork();

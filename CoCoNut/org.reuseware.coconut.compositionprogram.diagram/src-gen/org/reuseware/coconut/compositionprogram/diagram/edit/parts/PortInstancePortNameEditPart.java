 ...
 * @generated
 */
public class PortInstancePortNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				CompositionprogramVisualIDRegistry
						.getType(org.reuseware.coconut.compositionprogram.diagram.edit.parts.PortInstancePortNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public PortInstancePortNameEditPart(View view) {
		super(view);
	}
	...
	/**
	 * Removes 'Default' in case of default interface
	 * 
	 * @generated NOT
	 */
	protected String getLabelText() {
		...
		if (text.startsWith("Default.")) {
			text = text.substring("Default.".length());
		}
		//!END MODIFICATION
		return text;
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CompositionprogramParserProvider
					.getParser(
							CompositionprogramElementTypes.PortInstance_3001,
							getParserElement(),
							CompositionprogramVisualIDRegistry
									.getType(org.reuseware.coconut.compositionprogram.diagram.edit.parts.PortInstancePortNameEditPart.VISUAL_ID));
		}
	...
	static final Font THIS_FONT = new Font(Display.getCurrent(), Display
			.getDefault().getSystemFont().getFontData()[0].getName(), 12,
			SWT.NORMAL);

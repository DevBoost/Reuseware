 ...
 * @generated
 */
public class FileSpecificationCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public FileSpecificationCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		FileSpecification newElement = CimFactory.eINSTANCE

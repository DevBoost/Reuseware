...
public class OSPFProtocolEndpointEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OSPFProtocolEndpointItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OSPFProtocolEndpointCanonicalEditPolicy());
	...
	protected IFigure createNodeShape() {
		OSPFProtocolEndpointBaseFigure figure = new OSPFProtocolEndpointBaseFigure();
	...
	public OSPFProtocolEndpointBaseFigure getPrimaryShape() {
		return (OSPFProtocolEndpointBaseFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OSPFProtocolEndpointElementNameEditPart) {
			((OSPFProtocolEndpointElementNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOSPFProtocolEndpointBaseElementNameFigure());
			return true;
		}
		if (childEditPart instanceof WrappingLabel60EditPart) {
			((WrappingLabel60EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureOSPFProtocolEndpointBaseNameFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(CIMLevelZeroVisualIDRegistry
				.getType(OSPFProtocolEndpointElementNameEditPart.VISUAL_ID));
	}
	...
	public class OSPFProtocolEndpointBaseFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureOSPFProtocolEndpointBaseNameFigure = new WrappingLabel();
			fFigureOSPFProtocolEndpointBaseNameFigure
					.setText("< OSPFProtocolEndpointBase >");

			this.add(fFigureOSPFProtocolEndpointBaseNameFigure);

			fFigureOSPFProtocolEndpointBaseElementNameFigure = new WrappingLabel();
			fFigureOSPFProtocolEndpointBaseElementNameFigure.setText("");

			this.add(fFigureOSPFProtocolEndpointBaseElementNameFigure);
		...
		public WrappingLabel getFigureOSPFProtocolEndpointBaseNameFigure() {
			return fFigureOSPFProtocolEndpointBaseNameFigure;
		}
		...
		public WrappingLabel getFigureOSPFProtocolEndpointBaseElementNameFigure() {
			return fFigureOSPFProtocolEndpointBaseElementNameFigure;
		}

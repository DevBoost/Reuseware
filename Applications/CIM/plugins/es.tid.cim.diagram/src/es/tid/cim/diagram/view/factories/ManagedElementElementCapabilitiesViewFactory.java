 ...
 * @generated
 */
public class ManagedElementElementCapabilitiesViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ManagedElementElementCapabilitiesEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel111EditPart.VISUAL_ID),

...
import org.oasisopen.names.tc.opendocument.xmlns.text.ImageCountType;
import org.oasisopen.names.tc.opendocument.xmlns.text.TextPackage;

/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Image Count Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.ImageCountTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.ImageCountTypeImpl#getNumFormat <em>Num Format</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.text.impl.ImageCountTypeImpl#getNumLetterSync <em>Num Letter Sync</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ImageCountTypeImpl extends EObjectImpl implements ImageCountType {
	/**
	...
	protected EClass eStaticClass() {
		return TextPackage.eINSTANCE.getImageCountType();
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, TextPackage.IMAGE_COUNT_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public void setNumFormat(Object newNumFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.IMAGE_COUNT_TYPE__NUM_FORMAT, oldNumFormat, numFormat));
	}
	...
	public void setNumLetterSync(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newNumLetterSync) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TextPackage.IMAGE_COUNT_TYPE__NUM_LETTER_SYNC, oldNumLetterSync, numLetterSync, !oldNumLetterSyncESet));
	}
	...
	public void unsetNumLetterSync() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, TextPackage.IMAGE_COUNT_TYPE__NUM_LETTER_SYNC, oldNumLetterSync, NUM_LETTER_SYNC_EDEFAULT, oldNumLetterSyncESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.IMAGE_COUNT_TYPE__MIXED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TextPackage.IMAGE_COUNT_TYPE__NUM_FORMAT:
				return getNumFormat();
			case TextPackage.IMAGE_COUNT_TYPE__NUM_LETTER_SYNC:

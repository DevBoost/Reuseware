 ...
 * @generated
 */
public class ServiceAccessPointBindsToLANEndpointReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceAccessPointBindsToLANEndpointReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof LANEndpoint && newEnd instanceof ServiceAccessPoint)) {
			return false;
		}
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistServiceAccessPointBindsToLANEndpoint_4045(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getBindsToLANEndpoint().remove(getOldTarget());
		getNewSource().getBindsToLANEndpoint().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getBindsToLANEndpoint().remove(getOldTarget());
		getOldSource().getBindsToLANEndpoint().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

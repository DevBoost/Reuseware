 ...
 * @generated
 */
public class ShipDestinationMarkerEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				TaiPanVisualIDRegistry
						.getType(org.reuseware.application.taipan.gmf.editor.edit.parts.ShipDestinationMarkerEditPart.VISUAL_ID),
				new Point(0, 40));
	}

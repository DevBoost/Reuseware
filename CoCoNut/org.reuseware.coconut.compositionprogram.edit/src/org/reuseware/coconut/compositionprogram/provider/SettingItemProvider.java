...
/**
 * This is the item provider adapter for a {@link org.reuseware.coconut.compositionprogram.Setting} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SettingItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Setting_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Setting_property_feature", "_UI_Setting_type"),
				 CompositionprogramPackage.Literals.SETTING__PROPERTY,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Setting_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Setting_value_feature", "_UI_Setting_type"),
	...
	public String getText(Object object) {
		...
		if (setting != null && !setting.eIsProxy()) {
			return setting.getProperty() + " = " + setting.getValue();
		}
		return "? = ?";
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Setting.class)) {
			case CompositionprogramPackage.SETTING__PROPERTY:
			case CompositionprogramPackage.SETTING__VALUE:

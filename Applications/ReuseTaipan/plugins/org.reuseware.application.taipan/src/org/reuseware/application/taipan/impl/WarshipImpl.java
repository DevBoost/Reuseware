 ...
 * <ul>
 *   <li>{@link org.reuseware.application.taipan.impl.WarshipImpl#getEscortOrder <em>Escort Order</em>}</li>
 *   <li>{@link org.reuseware.application.taipan.impl.WarshipImpl#getAttackOrders <em>Attack Orders</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WarshipImpl extends ShipImpl implements Warship {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetEscortOrder(
			EscortShipsOrder newEscortOrder, NotificationChain msgs) {
		EscortShipsOrder oldEscortOrder = escortOrder;
		escortOrder = newEscortOrder;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, TaiPanPackage.WARSHIP__ESCORT_ORDER,
					oldEscortOrder, newEscortOrder);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setEscortOrder(EscortShipsOrder newEscortOrder) {
		if (newEscortOrder != escortOrder) {
			...
			if (escortOrder != null)
				msgs = ((InternalEObject) escortOrder).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- TaiPanPackage.WARSHIP__ESCORT_ORDER, null,
						msgs);
			if (newEscortOrder != null)
				msgs = ((InternalEObject) newEscortOrder).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- TaiPanPackage.WARSHIP__ESCORT_ORDER, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaiPanPackage.WARSHIP__ESCORT_ORDER, newEscortOrder,
					newEscortOrder));
	}
	...
	public EList<BesiegePortOrder> getAttackOrders() {
		if (attackOrders == null) {
			attackOrders = new EObjectContainmentEList<BesiegePortOrder>(
					BesiegePortOrder.class, this,
					TaiPanPackage.WARSHIP__ATTACK_ORDERS);
		}
		return attackOrders;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TaiPanPackage.WARSHIP__ATTACK_ORDERS:
			return ((InternalEList<?>) getAttackOrders()).basicRemove(otherEnd,
					msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TaiPanPackage.WARSHIP__ATTACK_ORDERS:
			...
			getAttackOrders().addAll(
					(Collection<? extends BesiegePortOrder>) newValue);
			return;
		}

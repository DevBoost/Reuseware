 ...
 */
public class AsCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.reuseware.air.language.abstractsyntax.resource.as.IAsBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor) {
				org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor = (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor) workbenchPart;
	...
	protected org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor;
	 ...
	 */
	public AsCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor textEditor) {
	...
	private void addCloseListener(final org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.reuseware.air.language.abstractsyntax.resource.as.IAsTextResource textResource = (org.reuseware.air.language.abstractsyntax.resource.as.IAsTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();

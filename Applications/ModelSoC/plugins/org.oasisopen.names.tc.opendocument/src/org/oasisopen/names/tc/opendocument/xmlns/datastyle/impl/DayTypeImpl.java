 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.datastyle.impl.DayTypeImpl#getCalendar <em>Calendar</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.datastyle.impl.DayTypeImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DayTypeImpl extends EObjectImpl implements DayType {
	/**
	...
	protected EClass eStaticClass() {
		return DatastylePackage.Literals.DAY_TYPE;
	}
	...
	public void setCalendar(Object newCalendar) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatastylePackage.DAY_TYPE__CALENDAR, oldCalendar, calendar));
	}
	...
	public void setStyle(StyleType newStyle) {
		...
		styleESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatastylePackage.DAY_TYPE__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DatastylePackage.DAY_TYPE__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatastylePackage.DAY_TYPE__CALENDAR:
				return getCalendar();
			case DatastylePackage.DAY_TYPE__STYLE:
				return getStyle();
		}

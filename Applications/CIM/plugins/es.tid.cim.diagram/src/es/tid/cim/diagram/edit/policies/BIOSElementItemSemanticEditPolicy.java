...
import es.tid.cim.diagram.edit.commands.InstalledProductSoftwareElementsCreateCommand;
import es.tid.cim.diagram.edit.commands.InstalledProductSoftwareElementsReorientCommand;
...
import es.tid.cim.diagram.edit.commands.SoftwareElementSoftwareElementActionsCreateCommand;
import es.tid.cim.diagram.edit.commands.SoftwareElementSoftwareElementActionsReorientCommand;
import es.tid.cim.diagram.edit.commands.SoftwareElementSoftwareElementChecksCreateCommand;
import es.tid.cim.diagram.edit.commands.SoftwareElementSoftwareElementChecksReorientCommand;
 ...
 * @generated
 */
public class BIOSElementItemSemanticEditPolicy extends
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.SoftwareElementSoftwareElementActions_4003 == req
				.getElementType()) {
			return getGEFWrapper(new SoftwareElementSoftwareElementActionsCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.SoftwareElementSoftwareElementChecks_4004 == req
				.getElementType()) {
			return getGEFWrapper(new SoftwareElementSoftwareElementChecksCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.InstalledProductSoftwareElements_4005 == req
				.getElementType()) {
			return null;
		}
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (CIMLevelZeroElementTypes.InstalledProductSoftwareElements_4005 == req
				.getElementType()) {
			return getGEFWrapper(new InstalledProductSoftwareElementsCreateCommand(
					req, req.getSource(), req.getTarget()));
		}
		if (CIMLevelZeroElementTypes.ManagedElementComponents_4011 == req
				.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case SoftwareElementSoftwareElementActionsEditPart.VISUAL_ID:
			return getGEFWrapper(new SoftwareElementSoftwareElementActionsReorientCommand(
					req));
		case SoftwareElementSoftwareElementChecksEditPart.VISUAL_ID:
			return getGEFWrapper(new SoftwareElementSoftwareElementChecksReorientCommand(
					req));
		case InstalledProductSoftwareElementsEditPart.VISUAL_ID:
			return getGEFWrapper(new InstalledProductSoftwareElementsReorientCommand(
					req));

 ...
 * @generated
 */
public class QoSServiceQoSConditioningSubServiceViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(QoSServiceQoSConditioningSubServiceEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel134EditPart.VISUAL_ID),

 ...
 * @generated
 */
public class ServiceAccessPointBindsToLANEndpointViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ServiceAccessPointBindsToLANEndpointEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel139EditPart.VISUAL_ID),

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Contour Polygon Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ContourPolygonTypeImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ContourPolygonTypeImpl#getPoints <em>Points</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ContourPolygonTypeImpl#getRecreateOnEdit <em>Recreate On Edit</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ContourPolygonTypeImpl#getViewBox <em>View Box</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.drawing.impl.ContourPolygonTypeImpl#getWidth <em>Width</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ContourPolygonTypeImpl extends EObjectImpl implements ContourPolygonType {
	/**
	 ...
	 * @generated
	 */
	protected ContourPolygonTypeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DrawingPackage.eINSTANCE.getContourPolygonType();
	}
	...
	public void setHeight(String newHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTOUR_POLYGON_TYPE__HEIGHT, oldHeight, height));
	}
	...
	public void setPoints(String newPoints) {
		...
		points = newPoints;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTOUR_POLYGON_TYPE__POINTS, oldPoints, points));
	}
	...
	public void setRecreateOnEdit(org.oasisopen.names.tc.opendocument.xmlns.text.Boolean newRecreateOnEdit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTOUR_POLYGON_TYPE__RECREATE_ON_EDIT, oldRecreateOnEdit, recreateOnEdit, !oldRecreateOnEditESet));
	}
	...
	public void unsetRecreateOnEdit() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DrawingPackage.CONTOUR_POLYGON_TYPE__RECREATE_ON_EDIT, oldRecreateOnEdit, RECREATE_ON_EDIT_EDEFAULT, oldRecreateOnEditESet));
	}
	...
	public void setViewBox(List newViewBox) {
		...
		viewBox = newViewBox;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTOUR_POLYGON_TYPE__VIEW_BOX, oldViewBox, viewBox));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DrawingPackage.CONTOUR_POLYGON_TYPE__WIDTH, oldWidth, width));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DrawingPackage.CONTOUR_POLYGON_TYPE__HEIGHT:
				return getHeight();
			case DrawingPackage.CONTOUR_POLYGON_TYPE__POINTS:
				return getPoints();
			case DrawingPackage.CONTOUR_POLYGON_TYPE__RECREATE_ON_EDIT:
				return getRecreateOnEdit();
			case DrawingPackage.CONTOUR_POLYGON_TYPE__VIEW_BOX:
				return getViewBox();
			case DrawingPackage.CONTOUR_POLYGON_TYPE__WIDTH:
				return getWidth();
		}

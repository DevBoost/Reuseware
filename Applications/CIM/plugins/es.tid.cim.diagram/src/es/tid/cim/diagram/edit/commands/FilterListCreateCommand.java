 ...
 * @generated
 */
public class FilterListCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public FilterListCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		FilterList newElement = CimFactory.eINSTANCE.createFilterList();

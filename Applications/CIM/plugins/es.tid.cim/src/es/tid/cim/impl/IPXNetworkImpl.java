...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>IPX Network</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link es.tid.cim.impl.IPXNetworkImpl#getNetworkNumber <em>Network Number</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IPXNetworkImpl extends LogicalNetworkImpl implements IPXNetwork {
	...
	public void setNetworkNumber(String newNetworkNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CimPackage.IPX_NETWORK__NETWORK_NUMBER, oldNetworkNumber, networkNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CimPackage.IPX_NETWORK__NETWORK_NUMBER:

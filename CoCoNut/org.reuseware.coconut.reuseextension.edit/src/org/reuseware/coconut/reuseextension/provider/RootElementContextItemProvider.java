...
/**
 * This is the item provider adapter for a {@link org.reuseware.coconut.reuseextension.RootElementContext} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RootElementContextItemProvider
	 ...
	 * @generated
	 */
	public RootElementContextItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns RootElementContext.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RootElementContext"));
	}
	...
	public String getText(Object object) {
		EClass eClass = ((RootElementContext)object).getEBoundClass();
		if (eClass != null && !eClass.eIsProxy()) {
			EPackage ePackage = eClass.getEPackage();
			if (ePackage != null && !ePackage.eIsProxy()) {
				return ePackage.getNsPrefix() + "::" + eClass.getName();
			}
		}
		return "<undefined>";
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RootElementContext.class)) {
			case ReuseextensionPackage.ROOT_ELEMENT_CONTEXT__IS_EXPRESSION:

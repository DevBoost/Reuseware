 ...
 * @generated
 */
public class LogicalDeviceDeviceIdentityReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public LogicalDeviceDeviceIdentityReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLogicalDeviceDeviceIdentity_4015(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistLogicalDeviceDeviceIdentity_4015(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setDeviceIdentity(null);
		getNewSource().setDeviceIdentity(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setDeviceIdentity(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

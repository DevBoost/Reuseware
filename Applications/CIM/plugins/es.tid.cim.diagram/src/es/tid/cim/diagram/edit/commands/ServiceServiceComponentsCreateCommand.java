 ...
 * @generated
 */
public class ServiceServiceComponentsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceServiceComponentsCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateServiceServiceComponents_4031(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getServiceComponents().add(getTarget());
		}

 ...
 * @generated
 */
public class SoftwareElementSoftwareElementActionsViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(SoftwareElementSoftwareElementActionsEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel97EditPart.VISUAL_ID),

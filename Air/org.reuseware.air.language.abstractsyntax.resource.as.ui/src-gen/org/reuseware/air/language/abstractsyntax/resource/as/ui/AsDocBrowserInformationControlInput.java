 ...
 * olInput</code>.
 */
public class AsDocBrowserInformationControlInput {
	
	private final AsDocBrowserInformationControlInput fPrevious;
	private AsDocBrowserInformationControlInput fNext;
	 ...
	 */
	public AsDocBrowserInformationControlInput(AsDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public AsDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public AsDocBrowserInformationControlInput getNext() {
		return fNext;
	}

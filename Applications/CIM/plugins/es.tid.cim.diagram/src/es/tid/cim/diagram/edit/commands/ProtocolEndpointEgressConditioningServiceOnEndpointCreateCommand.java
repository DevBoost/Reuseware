 ...
 * @generated
 */
public class ProtocolEndpointEgressConditioningServiceOnEndpointCreateCommand
	 ...
	 * @generated
	 */
	public ProtocolEndpointEgressConditioningServiceOnEndpointCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateProtocolEndpointEgressConditioningServiceOnEndpoint_4047(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getEgressConditioningServiceOnEndpoint().add(
					getTarget());
		}

 ...
 * @generated
 */
public class ServiceSoftwareFeatureServiceImplementationViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ServiceSoftwareFeatureServiceImplementationEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel162EditPart.VISUAL_ID),

 ...
 * @generated
 */
public class NATListBasedSettingsTranslationPoolForNATViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(NATListBasedSettingsTranslationPoolForNATEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel163EditPart.VISUAL_ID),

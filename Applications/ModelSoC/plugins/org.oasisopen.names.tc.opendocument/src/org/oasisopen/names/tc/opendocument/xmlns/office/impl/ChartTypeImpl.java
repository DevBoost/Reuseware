 ...
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getVariableDecls <em>Variable Decls</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getSequenceDecls <em>Sequence Decls</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getUserFieldDecls <em>User Field Decls</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getDdeConnectionDecls <em>Dde Connection Decls</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getAlphabeticalIndexAutoMarkFile <em>Alphabetical Index Auto Mark File</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getCalculationSettings <em>Calculation Settings</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getContentValidations <em>Content Validations</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getLabelRanges <em>Label Ranges</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getOfficeChartContentMainGroup <em>Office Chart Content Main Group</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getOfficeChartContentMain <em>Office Chart Content Main</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getNamedExpressions <em>Named Expressions</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getDatabaseRanges <em>Database Ranges</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getDataPilotTables <em>Data Pilot Tables</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getConsolidation <em>Consolidation</em>}</li>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.office.impl.ChartTypeImpl#getDdeLinks <em>Dde Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ChartTypeImpl extends EObjectImpl implements ChartType {
	/**
	...
	/**
	 * The cached value of the '{@link #getOfficeChartContentMainGroup() <em>Office Chart Content Main Group</em>}' attribute list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOfficeChartContentMainGroup()
	 * @generated
	 * @ordered
	 */
	protected FeatureMap officeChartContentMainGroup;
	...
	protected EClass eStaticClass() {
		return OfficePackage.Literals.CHART_TYPE;
	}
	...
	public NotificationChain basicSetVariableDecls(VariableDeclsType newVariableDecls, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__VARIABLE_DECLS, oldVariableDecls, newVariableDecls);
	...
	public void setVariableDecls(VariableDeclsType newVariableDecls) {
		if (newVariableDecls != variableDecls) {
			...
			if (variableDecls != null)
				msgs = ((InternalEObject)variableDecls).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__VARIABLE_DECLS, null, msgs);
			if (newVariableDecls != null)
				msgs = ((InternalEObject)newVariableDecls).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__VARIABLE_DECLS, null, msgs);
			msgs = basicSetVariableDecls(newVariableDecls, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__VARIABLE_DECLS, newVariableDecls, newVariableDecls));
	}
	...
	public NotificationChain basicSetSequenceDecls(SequenceDeclsType newSequenceDecls, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__SEQUENCE_DECLS, oldSequenceDecls, newSequenceDecls);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSequenceDecls(SequenceDeclsType newSequenceDecls) {
		if (newSequenceDecls != sequenceDecls) {
			...
			if (sequenceDecls != null)
				msgs = ((InternalEObject)sequenceDecls).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__SEQUENCE_DECLS, null, msgs);
			if (newSequenceDecls != null)
				msgs = ((InternalEObject)newSequenceDecls).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__SEQUENCE_DECLS, null, msgs);
			msgs = basicSetSequenceDecls(newSequenceDecls, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__SEQUENCE_DECLS, newSequenceDecls, newSequenceDecls));
	}
	...
	public NotificationChain basicSetUserFieldDecls(UserFieldDeclsType newUserFieldDecls, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__USER_FIELD_DECLS, oldUserFieldDecls, newUserFieldDecls);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setUserFieldDecls(UserFieldDeclsType newUserFieldDecls) {
		if (newUserFieldDecls != userFieldDecls) {
			...
			if (userFieldDecls != null)
				msgs = ((InternalEObject)userFieldDecls).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__USER_FIELD_DECLS, null, msgs);
			if (newUserFieldDecls != null)
				msgs = ((InternalEObject)newUserFieldDecls).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__USER_FIELD_DECLS, null, msgs);
			msgs = basicSetUserFieldDecls(newUserFieldDecls, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__USER_FIELD_DECLS, newUserFieldDecls, newUserFieldDecls));
	}
	...
	public NotificationChain basicSetDdeConnectionDecls(DdeConnectionDeclsType newDdeConnectionDecls, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DDE_CONNECTION_DECLS, oldDdeConnectionDecls, newDdeConnectionDecls);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDdeConnectionDecls(DdeConnectionDeclsType newDdeConnectionDecls) {
		if (newDdeConnectionDecls != ddeConnectionDecls) {
			...
			if (ddeConnectionDecls != null)
				msgs = ((InternalEObject)ddeConnectionDecls).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DDE_CONNECTION_DECLS, null, msgs);
			if (newDdeConnectionDecls != null)
				msgs = ((InternalEObject)newDdeConnectionDecls).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DDE_CONNECTION_DECLS, null, msgs);
			msgs = basicSetDdeConnectionDecls(newDdeConnectionDecls, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DDE_CONNECTION_DECLS, newDdeConnectionDecls, newDdeConnectionDecls));
	}
	...
	public NotificationChain basicSetAlphabeticalIndexAutoMarkFile(AlphabeticalIndexAutoMarkFileType newAlphabeticalIndexAutoMarkFile, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__ALPHABETICAL_INDEX_AUTO_MARK_FILE, oldAlphabeticalIndexAutoMarkFile, newAlphabeticalIndexAutoMarkFile);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAlphabeticalIndexAutoMarkFile(AlphabeticalIndexAutoMarkFileType newAlphabeticalIndexAutoMarkFile) {
		if (newAlphabeticalIndexAutoMarkFile != alphabeticalIndexAutoMarkFile) {
			...
			if (alphabeticalIndexAutoMarkFile != null)
				msgs = ((InternalEObject)alphabeticalIndexAutoMarkFile).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__ALPHABETICAL_INDEX_AUTO_MARK_FILE, null, msgs);
			if (newAlphabeticalIndexAutoMarkFile != null)
				msgs = ((InternalEObject)newAlphabeticalIndexAutoMarkFile).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__ALPHABETICAL_INDEX_AUTO_MARK_FILE, null, msgs);
			msgs = basicSetAlphabeticalIndexAutoMarkFile(newAlphabeticalIndexAutoMarkFile, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__ALPHABETICAL_INDEX_AUTO_MARK_FILE, newAlphabeticalIndexAutoMarkFile, newAlphabeticalIndexAutoMarkFile));
	}
	...
	public NotificationChain basicSetCalculationSettings(CalculationSettingsType newCalculationSettings, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__CALCULATION_SETTINGS, oldCalculationSettings, newCalculationSettings);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCalculationSettings(CalculationSettingsType newCalculationSettings) {
		if (newCalculationSettings != calculationSettings) {
			...
			if (calculationSettings != null)
				msgs = ((InternalEObject)calculationSettings).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__CALCULATION_SETTINGS, null, msgs);
			if (newCalculationSettings != null)
				msgs = ((InternalEObject)newCalculationSettings).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__CALCULATION_SETTINGS, null, msgs);
			msgs = basicSetCalculationSettings(newCalculationSettings, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__CALCULATION_SETTINGS, newCalculationSettings, newCalculationSettings));
	}
	...
	public NotificationChain basicSetContentValidations(ContentValidationsType newContentValidations, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__CONTENT_VALIDATIONS, oldContentValidations, newContentValidations);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setContentValidations(ContentValidationsType newContentValidations) {
		if (newContentValidations != contentValidations) {
			...
			if (contentValidations != null)
				msgs = ((InternalEObject)contentValidations).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__CONTENT_VALIDATIONS, null, msgs);
			if (newContentValidations != null)
				msgs = ((InternalEObject)newContentValidations).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__CONTENT_VALIDATIONS, null, msgs);
			msgs = basicSetContentValidations(newContentValidations, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__CONTENT_VALIDATIONS, newContentValidations, newContentValidations));
	}
	...
	public NotificationChain basicSetLabelRanges(LabelRangesType newLabelRanges, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__LABEL_RANGES, oldLabelRanges, newLabelRanges);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLabelRanges(LabelRangesType newLabelRanges) {
		if (newLabelRanges != labelRanges) {
			NotificationChain msgs = null;
			if (labelRanges != null)
				msgs = ((InternalEObject)labelRanges).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__LABEL_RANGES, null, msgs);
			if (newLabelRanges != null)
				msgs = ((InternalEObject)newLabelRanges).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__LABEL_RANGES, null, msgs);
			msgs = basicSetLabelRanges(newLabelRanges, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__LABEL_RANGES, newLabelRanges, newLabelRanges));
	}
	 ...
	 * @generated
	 */
	public FeatureMap getOfficeChartContentMainGroup() {
		if (officeChartContentMainGroup == null) {
			officeChartContentMainGroup = new BasicFeatureMap(this, OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN_GROUP);
		}
		return officeChartContentMainGroup;
	}
	...
	public OfficeChartContentMainType getOfficeChartContentMain() {
		return (OfficeChartContentMainType)getOfficeChartContentMainGroup().get(OfficePackage.Literals.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN, true);
	}
	...
	public NotificationChain basicSetOfficeChartContentMain(OfficeChartContentMainType newOfficeChartContentMain, NotificationChain msgs) {
		return ((FeatureMap.Internal)getOfficeChartContentMainGroup()).basicAdd(OfficePackage.Literals.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN, newOfficeChartContentMain, msgs);
	}
	...
	public NotificationChain basicSetNamedExpressions(NamedExpressionsType newNamedExpressions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__NAMED_EXPRESSIONS, oldNamedExpressions, newNamedExpressions);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setNamedExpressions(NamedExpressionsType newNamedExpressions) {
		if (newNamedExpressions != namedExpressions) {
			...
			if (namedExpressions != null)
				msgs = ((InternalEObject)namedExpressions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__NAMED_EXPRESSIONS, null, msgs);
			if (newNamedExpressions != null)
				msgs = ((InternalEObject)newNamedExpressions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__NAMED_EXPRESSIONS, null, msgs);
			msgs = basicSetNamedExpressions(newNamedExpressions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__NAMED_EXPRESSIONS, newNamedExpressions, newNamedExpressions));
	}
	...
	public NotificationChain basicSetDatabaseRanges(DatabaseRangesType newDatabaseRanges, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DATABASE_RANGES, oldDatabaseRanges, newDatabaseRanges);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDatabaseRanges(DatabaseRangesType newDatabaseRanges) {
		if (newDatabaseRanges != databaseRanges) {
			...
			if (databaseRanges != null)
				msgs = ((InternalEObject)databaseRanges).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DATABASE_RANGES, null, msgs);
			if (newDatabaseRanges != null)
				msgs = ((InternalEObject)newDatabaseRanges).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DATABASE_RANGES, null, msgs);
			msgs = basicSetDatabaseRanges(newDatabaseRanges, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DATABASE_RANGES, newDatabaseRanges, newDatabaseRanges));
	}
	...
	public NotificationChain basicSetDataPilotTables(DataPilotTablesType newDataPilotTables, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DATA_PILOT_TABLES, oldDataPilotTables, newDataPilotTables);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDataPilotTables(DataPilotTablesType newDataPilotTables) {
		if (newDataPilotTables != dataPilotTables) {
			...
			if (dataPilotTables != null)
				msgs = ((InternalEObject)dataPilotTables).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DATA_PILOT_TABLES, null, msgs);
			if (newDataPilotTables != null)
				msgs = ((InternalEObject)newDataPilotTables).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DATA_PILOT_TABLES, null, msgs);
			msgs = basicSetDataPilotTables(newDataPilotTables, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DATA_PILOT_TABLES, newDataPilotTables, newDataPilotTables));
	}
	...
	public NotificationChain basicSetConsolidation(ConsolidationType newConsolidation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__CONSOLIDATION, oldConsolidation, newConsolidation);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setConsolidation(ConsolidationType newConsolidation) {
		if (newConsolidation != consolidation) {
			...
			if (consolidation != null)
				msgs = ((InternalEObject)consolidation).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__CONSOLIDATION, null, msgs);
			if (newConsolidation != null)
				msgs = ((InternalEObject)newConsolidation).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__CONSOLIDATION, null, msgs);
			msgs = basicSetConsolidation(newConsolidation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__CONSOLIDATION, newConsolidation, newConsolidation));
	}
	...
	public NotificationChain basicSetDdeLinks(DdeLinksType newDdeLinks, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DDE_LINKS, oldDdeLinks, newDdeLinks);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDdeLinks(DdeLinksType newDdeLinks) {
		if (newDdeLinks != ddeLinks) {
			NotificationChain msgs = null;
			if (ddeLinks != null)
				msgs = ((InternalEObject)ddeLinks).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DDE_LINKS, null, msgs);
			if (newDdeLinks != null)
				msgs = ((InternalEObject)newDdeLinks).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OfficePackage.CHART_TYPE__DDE_LINKS, null, msgs);
			msgs = basicSetDdeLinks(newDdeLinks, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OfficePackage.CHART_TYPE__DDE_LINKS, newDdeLinks, newDdeLinks));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OfficePackage.CHART_TYPE__VARIABLE_DECLS:
				return basicSetVariableDecls(null, msgs);
			case OfficePackage.CHART_TYPE__SEQUENCE_DECLS:
				return basicSetSequenceDecls(null, msgs);
			case OfficePackage.CHART_TYPE__USER_FIELD_DECLS:
				return basicSetUserFieldDecls(null, msgs);
			case OfficePackage.CHART_TYPE__DDE_CONNECTION_DECLS:
				return basicSetDdeConnectionDecls(null, msgs);
			case OfficePackage.CHART_TYPE__ALPHABETICAL_INDEX_AUTO_MARK_FILE:
				return basicSetAlphabeticalIndexAutoMarkFile(null, msgs);
			case OfficePackage.CHART_TYPE__CALCULATION_SETTINGS:
				return basicSetCalculationSettings(null, msgs);
			case OfficePackage.CHART_TYPE__CONTENT_VALIDATIONS:
				return basicSetContentValidations(null, msgs);
			case OfficePackage.CHART_TYPE__LABEL_RANGES:
				return basicSetLabelRanges(null, msgs);
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN_GROUP:
				return ((InternalEList<?>)getOfficeChartContentMainGroup()).basicRemove(otherEnd, msgs);
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN:
				return basicSetOfficeChartContentMain(null, msgs);
			case OfficePackage.CHART_TYPE__NAMED_EXPRESSIONS:
				return basicSetNamedExpressions(null, msgs);
			case OfficePackage.CHART_TYPE__DATABASE_RANGES:
				return basicSetDatabaseRanges(null, msgs);
			case OfficePackage.CHART_TYPE__DATA_PILOT_TABLES:
				return basicSetDataPilotTables(null, msgs);
			case OfficePackage.CHART_TYPE__CONSOLIDATION:
				return basicSetConsolidation(null, msgs);
			case OfficePackage.CHART_TYPE__DDE_LINKS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN_GROUP:
				if (coreType) return getOfficeChartContentMainGroup();
				return ((FeatureMap.Internal)getOfficeChartContentMainGroup()).getWrapper();
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case OfficePackage.CHART_TYPE__LABEL_RANGES:
				...
				return;
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN_GROUP:
				((FeatureMap.Internal)getOfficeChartContentMainGroup()).set(newValue);
				return;
			case OfficePackage.CHART_TYPE__NAMED_EXPRESSIONS:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case OfficePackage.CHART_TYPE__LABEL_RANGES:
				...
				return;
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN_GROUP:
				getOfficeChartContentMainGroup().clear();
				return;
			case OfficePackage.CHART_TYPE__NAMED_EXPRESSIONS:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN_GROUP:
				return officeChartContentMainGroup != null && !officeChartContentMainGroup.isEmpty();
			case OfficePackage.CHART_TYPE__OFFICE_CHART_CONTENT_MAIN:
	...
	public String toString() {
		...
		result.append(" (officeChartContentMainGroup: ");
		result.append(officeChartContentMainGroup);
		result.append(')');

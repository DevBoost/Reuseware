 ...
 * @generated
 */
public class ISDNModemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public ISDNModemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		ISDNModem newElement = CimFactory.eINSTANCE.createISDNModem();

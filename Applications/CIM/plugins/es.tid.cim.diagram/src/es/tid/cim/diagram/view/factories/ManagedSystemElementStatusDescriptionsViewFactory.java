 ...
 * @generated
 */
public class ManagedSystemElementStatusDescriptionsViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ManagedSystemElementStatusDescriptionsEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel129EditPart.VISUAL_ID),

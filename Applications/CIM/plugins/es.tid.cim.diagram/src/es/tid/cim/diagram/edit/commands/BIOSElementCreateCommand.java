 ...
 * @generated
 */
public class BIOSElementCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public BIOSElementCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		BIOSElement newElement = CimFactory.eINSTANCE.createBIOSElement();

 ...
 * @generated
 */
public class ServiceServiceAccessBySAPCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceServiceAccessBySAPCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateServiceServiceAccessBySAP_4030(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getServiceAccessBySAP().add(getTarget());
		}

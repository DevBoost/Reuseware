 ...
 * @generated
 */
public class BGPClusterCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public BGPClusterCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		BGPCluster newElement = CimFactory.eINSTANCE.createBGPCluster();

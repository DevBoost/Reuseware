 ...
 * @generated
 */
public class USBPortCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public USBPortCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		USBPort newElement = CimFactory.eINSTANCE.createUSBPort();

 ...
 * <ul>
 *   <li>{@link org.reuseware.application.taipan.impl.EscortShipsOrderImpl#getShips <em>Ships</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EscortShipsOrderImpl extends EObjectImpl implements
		EscortShipsOrder {
	...
	public EList<Ship> getShips() {
		if (ships == null) {
			ships = new EObjectResolvingEList<Ship>(Ship.class, this,
					TaiPanPackage.ESCORT_SHIPS_ORDER__SHIPS);
		}
		return ships;
	}

 ...
 * @generated
 */
public class AutonomousSystemRoutingProtocolDomainInASViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(AutonomousSystemRoutingProtocolDomainInASEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel160EditPart.VISUAL_ID),

 ...
 * @generated
 */
public class ServiceAccessPointSAPSAPDependencyViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ServiceAccessPointSAPSAPDependencyEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel123EditPart.VISUAL_ID),

 ...
 * @generated
 */
public class BufferPoolCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public BufferPoolCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		BufferPool newElement = CimFactory.eINSTANCE.createBufferPool();

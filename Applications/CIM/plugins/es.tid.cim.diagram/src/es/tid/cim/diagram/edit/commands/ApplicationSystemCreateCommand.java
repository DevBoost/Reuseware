 ...
 * @generated
 */
public class ApplicationSystemCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public ApplicationSystemCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		ApplicationSystem newElement = CimFactory.eINSTANCE

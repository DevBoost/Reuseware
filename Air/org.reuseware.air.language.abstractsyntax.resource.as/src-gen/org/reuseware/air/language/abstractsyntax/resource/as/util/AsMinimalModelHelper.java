 ...
 */
public class AsMinimalModelHelper {
	
	private final static org.reuseware.air.language.abstractsyntax.resource.as.util.AsEClassUtil eClassUtil = new org.reuseware.air.language.abstractsyntax.resource.as.util.AsEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.reuseware.air.language.abstractsyntax.resource.as.util.AsStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.reuseware.air.language.abstractsyntax.resource.as.util.AsListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if(attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.reuseware.air.language.abstractsyntax.resource.as.util.AsStringUtil.capitalize(attribute.getName());
					}
					java.lang.Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.reuseware.air.language.abstractsyntax.resource.as.util.AsListUtil.castListUnchecked(value);

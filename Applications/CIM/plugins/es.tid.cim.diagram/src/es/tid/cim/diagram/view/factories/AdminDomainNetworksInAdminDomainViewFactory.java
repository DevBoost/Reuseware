 ...
 * @generated
 */
public class AdminDomainNetworksInAdminDomainViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(AdminDomainNetworksInAdminDomainEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel153EditPart.VISUAL_ID),

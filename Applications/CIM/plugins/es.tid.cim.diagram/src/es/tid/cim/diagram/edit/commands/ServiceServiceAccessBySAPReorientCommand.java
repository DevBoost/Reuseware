 ...
 * @generated
 */
public class ServiceServiceAccessBySAPReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ServiceServiceAccessBySAPReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ServiceAccessPoint && newEnd instanceof Service)) {
			return false;
		}
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistServiceServiceAccessBySAP_4030(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canExistServiceServiceAccessBySAP_4030(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getServiceAccessBySAP().remove(getOldTarget());
		getNewSource().getServiceAccessBySAP().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getServiceAccessBySAP().remove(getOldTarget());
		getOldSource().getServiceAccessBySAP().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}

 ...
 * @generated
 */
public class ManagedElementComponentsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ManagedElementComponentsCreateCommand(
	...
	public boolean canExecute() {
		...
		return CIMLevelZeroBaseItemSemanticEditPolicy.LinkConstraints
				.canCreateManagedElementComponents_4011(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getComponents().add(getTarget());
		}

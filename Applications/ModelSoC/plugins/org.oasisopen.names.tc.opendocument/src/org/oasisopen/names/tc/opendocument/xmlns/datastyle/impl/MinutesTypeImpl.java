...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Minutes Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.oasisopen.names.tc.opendocument.xmlns.datastyle.impl.MinutesTypeImpl#getStyle <em>Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MinutesTypeImpl extends EObjectImpl implements MinutesType {
	/**
	...
	protected EClass eStaticClass() {
		return DatastylePackage.Literals.MINUTES_TYPE;
	}
	...
	public void setStyle(StyleType newStyle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DatastylePackage.MINUTES_TYPE__STYLE, oldStyle, style, !oldStyleESet));
	}
	...
	public void unsetStyle() {
		...
		styleESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, DatastylePackage.MINUTES_TYPE__STYLE, oldStyle, STYLE_EDEFAULT, oldStyleESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DatastylePackage.MINUTES_TYPE__STYLE:
				return getStyle();
		}

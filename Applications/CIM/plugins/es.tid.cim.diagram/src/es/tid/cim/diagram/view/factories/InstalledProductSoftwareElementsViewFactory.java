 ...
 * @generated
 */
public class InstalledProductSoftwareElementsViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(InstalledProductSoftwareElementsEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel99EditPart.VISUAL_ID),

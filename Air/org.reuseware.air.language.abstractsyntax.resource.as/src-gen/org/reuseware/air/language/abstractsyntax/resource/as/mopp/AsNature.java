...
public class AsNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.reuseware.air.language.abstractsyntax.resource.as.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.reuseware.air.language.abstractsyntax.resource.as.mopp.AsBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.reuseware.air.language.abstractsyntax.resource.as.mopp.AsBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

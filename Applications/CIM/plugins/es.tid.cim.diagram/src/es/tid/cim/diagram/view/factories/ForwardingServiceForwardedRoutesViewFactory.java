 ...
 * @generated
 */
public class ForwardingServiceForwardedRoutesViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = CIMLevelZeroVisualIDRegistry
					.getType(ForwardingServiceForwardedRoutesEditPart.VISUAL_ID);
		...
		getViewService().createNode(
				...
				CIMLevelZeroVisualIDRegistry
						.getType(WrappingLabel143EditPart.VISUAL_ID),

 ...
 */
public class AsSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.reuseware.air.language.abstractsyntax.resource.as.ui.AsSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPixelConverter pixelConverter = new org.reuseware.air.language.abstractsyntax.resource.as.ui.AsPixelConverter(composite);
	...
	public AsSyntaxColoringPreferencePage() {
		super();
		
		org.reuseware.air.language.abstractsyntax.resource.as.IAsMetaInformation syntaxPlugin = new org.reuseware.air.language.abstractsyntax.resource.as.mopp.AsMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor) {
			org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor emfTextEditor = (org.reuseware.air.language.abstractsyntax.resource.as.ui.AsEditor) editor;
